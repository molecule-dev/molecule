/**
 * Browser guard — @molecule/api-ai-document-extraction is SERVER-ONLY.
 *
...
if (g.window !== undefined && g.document !== undefined && !g.process?.versions?.node) {
  throw new Error(
    '@molecule/api-ai-document-extraction is SERVER-ONLY: it was bundled into browser/client code. Import it only ' +
