...
Generated: 2026-09-24T12:19:56.912Z
-->
...
if (decision.action === 'block')
  console.log('Rejected:', decision.matched_category) // 'spam'
else if (decision.action === 'flag')
  console.log('Held for review') // also the default on classifier failure
