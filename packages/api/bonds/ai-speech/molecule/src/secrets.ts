/**
 * molecule.dev hosted speech secret definitions — self-registered at
...
export const aiSpeechMoleculeSecretDefinitions: SecretDefinition[] = [
  {
...
registerSecrets(aiSpeechMoleculeSecretDefinitions)
