/**
 * molecule.dev hosted moderation secret definitions — self-registered at
...
export const contentModerationMoleculeSecretDefinitions: SecretDefinition[] = [
  {
...
registerSecrets(contentModerationMoleculeSecretDefinitions)
