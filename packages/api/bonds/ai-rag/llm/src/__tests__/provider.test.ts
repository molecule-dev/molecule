 ...
 *
 * @param answer - The text the fake provider streams back.
 * @param name - The provider name (used for named-bond selection tests).
 * @returns A fake `AIProvider` suitable for bonding in tests.
 */
