/**
 * Amadeus hotels secret definitions — self-registered at import time so
 ...
 * (AMADEUS_CLIENT_ID/AMADEUS_CLIENT_SECRET with the flights and travel
...
export const hotelsAmadeusSecretDefinitions: SecretDefinition[] = [
  {
...
registerSecrets(hotelsAmadeusSecretDefinitions)
