/**
 * Browser guard — @molecule/api-uploads-filesystem is SERVER-ONLY.
 *
...
if (g.window !== undefined && g.document !== undefined && !g.process?.versions?.node) {
  throw new Error(
    '@molecule/api-uploads-filesystem is SERVER-ONLY: it was bundled into browser/client code. Import it only ' +
