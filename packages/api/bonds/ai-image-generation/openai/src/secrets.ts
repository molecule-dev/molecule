/**
 * OpenAI image generation secret definitions — self-registered at import time
...
export const aiImageGenerationOpenaiSecretDefinitions: SecretDefinition[] = [
  {
    key: 'OPENAI_API_KEY',
...
registerSecrets(aiImageGenerationOpenaiSecretDefinitions)
