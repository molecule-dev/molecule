/**
 * Browser guard — @molecule/api-monitoring-default is SERVER-ONLY.
 *
...
if (g.window !== undefined && g.document !== undefined && !g.process?.versions?.node) {
  throw new Error(
    '@molecule/api-monitoring-default is SERVER-ONLY: it was bundled into browser/client code. Import it only ' +
