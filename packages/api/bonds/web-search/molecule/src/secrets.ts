/**
 * molecule.dev hosted web search secret definitions — self-registered at
...
export const webSearchMoleculeSecretDefinitions: SecretDefinition[] = [
  {
...
registerSecrets(webSearchMoleculeSecretDefinitions)
