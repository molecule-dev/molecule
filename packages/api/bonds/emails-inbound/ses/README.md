...
Generated: 2026-09-24T12:17:27.278Z
-->
...
2. PIN THE PUBLISHER (fail-closed): accept the notification only when
   ...
   that _some_ AWS account published the message (the cert-hostname
...
proves that _some_ AWS account published the message — the
