/**
 * Amadeus flights secret definitions — self-registered at import time so
 ...
 * formula, so packages sharing a key
 * (AMADEUS_CLIENT_ID/AMADEUS_CLIENT_SECRET with the hotels and travel
 * bonds) register byte-identical definitions and registration order never
 * matters.
 *
 * @module
 */
...
export const flightsAmadeusSecretDefinitions: SecretDefinition[] = [
  {
...
registerSecrets(flightsAmadeusSecretDefinitions)
