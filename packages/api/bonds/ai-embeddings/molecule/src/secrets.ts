/**
 * molecule.dev hosted embeddings secret definitions — self-registered at
...
export const aiEmbeddingsMoleculeSecretDefinitions: SecretDefinition[] = [
  {
...
registerSecrets(aiEmbeddingsMoleculeSecretDefinitions)
