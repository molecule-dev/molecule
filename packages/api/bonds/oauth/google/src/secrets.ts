/**
 * Google OAuth secret definitions — self-registered at import time so the
 ...
 * (OAUTH_GOOGLE_CLIENT_ID/OAUTH_GOOGLE_CLIENT_SECRET with the Google
 * calendar bond) register byte-identical definitions and registration
 * order never matters.
 *
 * @module
 */
...
export const oauthGoogleSecretDefinitions: SecretDefinition[] = [
  {
...
registerSecrets(oauthGoogleSecretDefinitions)
