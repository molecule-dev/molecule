/**
 * Browser guard — @molecule/api-media-streaming is SERVER-ONLY.
 *
...
if (g.window !== undefined && g.document !== undefined && !g.process?.versions?.node) {
  throw new Error(
    '@molecule/api-media-streaming is SERVER-ONLY: it was bundled into browser/client code. Import it only ' +
