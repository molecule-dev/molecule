 ...
 * Quick Start) works exactly as written — the ws bond attached to a real HTTP
 * server, driven by real `ws` clients speaking the join protocol (no mocks).
 *
 * @module
 */
...
import { broadcast, close, onJoinRequest, onMessage, setProvider } from '../index.js'
