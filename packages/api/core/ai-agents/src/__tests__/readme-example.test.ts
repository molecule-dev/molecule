 ...
 * Quick Start) works exactly as written, through the LLM agent bond over the
 * Anthropic chat bond. Only the network is mocked: `fetch` returns real
 * Messages-API SSE streams (a tool call, then a final answer).
 *
 * @module
 */
