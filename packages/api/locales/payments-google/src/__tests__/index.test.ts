...
const reference = locales.en as PaymentsGoogleTranslations
const REQUIRED_KEYS = Object.keys(reference) as (keyof PaymentsGoogleTranslations)[]

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, PaymentsGoogleTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('payments-google locale bond', () => {
