# @molecule/api-locales-secrets

Translations for @molecule/api-secrets in 79 languages

## Purpose

Provides translations for the `@molecule/api-secrets` package which has 2 translation keys.
...
```typescript
import { af, am, ar } from '@molecule/api-locales-secrets'
import type { SecretsTranslationKey, SecretsTranslations } from '@molecule/api-locales-secrets'
```
...
import * as locales from '@molecule/api-locales-secrets'
...
- **Category:** i18n
- **Stack:** api
- **Translates:** `@molecule/api-secrets`
