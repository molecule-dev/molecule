# @molecule/api-locales-emails

Translations for molecule emails in 79 languages

## Purpose

Provides translations for the `@molecule/api-emails` package which has 1 translation key.
...
```typescript
import { af, am, ar } from '@molecule/api-locales-emails'
import type { EmailsTranslationKey, EmailsTranslations } from '@molecule/api-locales-emails'
```
...
import * as locales from '@molecule/api-locales-emails'
...
- **Category:** i18n
- **Stack:** api
- **Translates:** `@molecule/api-emails`
