# @molecule/api-locales-analytics

Translations for molecule analytics package in 79 languages

## Purpose

Provides translations for the `@molecule/api-analytics` package which has 2 translation keys.
...
import * as locales from '@molecule/api-locales-analytics'
...
- **Category:** i18n
- **Stack:** api
- **Translates:** `@molecule/api-analytics`
