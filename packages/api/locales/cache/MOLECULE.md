# @molecule/api-locales-cache

Translations for molecule cache package in 79 languages

## Purpose

Provides translations for the `@molecule/api-cache` package which has 1 translation key.
...
```typescript
import { af, am, ar } from '@molecule/api-locales-cache'
import type { CacheTranslationKey, CacheTranslations } from '@molecule/api-locales-cache'
```
...
import * as locales from '@molecule/api-locales-cache'
