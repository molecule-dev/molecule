# @molecule/api-locales-queue

Translations for molecule queue package in 79 languages

## Purpose

Provides translations for the `@molecule/api-queue` package which has 1 translation key.
...
```typescript
import { af, am, ar } from '@molecule/api-locales-queue'
import type { QueueTranslationKey, QueueTranslations } from '@molecule/api-locales-queue'
```
...
import * as locales from '@molecule/api-locales-queue'
