...
/** Code Sandbox Docker translations for Danish. */
export const da: CodeSandboxDockerTranslations = {
  'codeSandbox.docker.error.readFailed': 'Kunne ikke læse {{path}}: {{error}}',
  'codeSandbox.docker.error.readDirFailed': 'Kunne ikke vise indholdet af {{path}}: {{error}}',
