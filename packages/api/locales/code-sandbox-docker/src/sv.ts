...
/** Code Sandbox Docker translations for Swedish. */
export const sv: CodeSandboxDockerTranslations = {
  'codeSandbox.docker.error.readFailed': 'Misslyckades med att läsa {{path}}: {{error}}',
  'codeSandbox.docker.error.readDirFailed': 'Kunde inte lista {{path}}: {{error}}',
