# @molecule/api-locales-ai-anthropic

Translations for @molecule/api-bond-ai-anthropic in 79 languages

## Purpose

Provides translations for the `@molecule/api-ai-anthropic` package which has 2 translation keys.
...
- **Category:** i18n
- **Stack:** api
- **Translates:** `@molecule/api-ai-anthropic`
