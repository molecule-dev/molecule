...
import type { AiAnthropicTranslations } from '../types.js'

const reference = locales.en as AiAnthropicTranslations
const REQUIRED_KEYS = Object.keys(reference) as (keyof AiAnthropicTranslations)[]

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, AiAnthropicTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('ai-anthropic locale bond', () => {
