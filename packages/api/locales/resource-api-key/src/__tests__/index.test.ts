...
const reference = locales.en as ResourceApiKeyTranslations
const REQUIRED_KEYS = Object.keys(reference) as (keyof ResourceApiKeyTranslations)[]

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, ResourceApiKeyTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('resource-api-key locale bond', () => {
