...
const reference = locales.en as GradeTranslations
const REQUIRED_KEYS = Object.keys(reference) as (keyof GradeTranslations)[]

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, GradeTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('resource-grade locale bond', () => {
