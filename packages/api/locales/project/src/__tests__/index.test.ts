...
const reference = locales.en as ProjectTranslations
const REQUIRED_KEYS = Object.keys(reference) as (keyof ProjectTranslations)[]

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, ProjectTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('project locale bond', () => {
