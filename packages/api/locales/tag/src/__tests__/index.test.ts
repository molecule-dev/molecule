...
const reference = locales.en as TagTranslations
const REQUIRED_KEYS = Object.keys(reference) as (keyof TagTranslations)[]

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, TagTranslations] => entry[1] !== null && typeof entry[1] === 'object',
)

describe('tag locale bond', () => {
