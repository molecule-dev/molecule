/**
 * User resource secret definitions — self-registered at import time so the
...
export const resourceUserSecretDefinitions: SecretDefinition[] = [
  {
    key: 'JWT_PRIVATE_KEY',
    description:
...
registerSecrets(resourceUserSecretDefinitions)
