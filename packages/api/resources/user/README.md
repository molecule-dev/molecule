...
Generated: 2026-08-15T19:34:04.935Z
-->
...
- `authorization.VerifyMiddlewareOptions` — interface: Options for {@link verifyMiddleware}.
...
- `handlers.billingPortal` — function: Opens the bonded provider's hosted billing portal for the user, so they can
