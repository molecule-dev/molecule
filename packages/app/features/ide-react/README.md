...
Generated: 2026-09-15T16:40:36.676Z
-->
...
```typescript
type TestWorkspace = 'app' | 'api' | 'root'
```
...
- `state` — The current state.
- `message` — What to show in the bar.
...
- `path` — The path that changed (absolute or workspace-relative).
