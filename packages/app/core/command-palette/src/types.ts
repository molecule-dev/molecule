/**
 * Command palette provider interface and related types.
 *
 * Defines framework-agnostic contracts for Cmd+K / Ctrl+K command palette
 * widgets with support for hierarchical command groups, keyboard navigation,
 * search filtering, and nested pages.
 *
 * @module
 */
