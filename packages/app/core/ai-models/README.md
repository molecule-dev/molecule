...
Generated: 2026-08-12T21:44:08.383Z
-->
...
```typescript
function isSelectableModel(model: Pick<AppModelDefinition, 'disabled' | 'supersededBy'>): boolean
```

- `model` — Model to check (only the two flags are read).
