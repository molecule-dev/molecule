# @molecule/app-locales-barcode-scanner
...
```typescript
import * as barcode_scanner_react from '@molecule/app-locales-barcode-scanner'
import type { BarcodeScannerTranslationKey, BarcodeScannerTranslations } from '@molecule/app-locales-barcode-scanner'
```
