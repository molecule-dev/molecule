...
Translations for @molecule/app-moderation-queue-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-moderation-queue-react` package which has 30 translation keys.
...
```typescript
import { af, am, ar } from '@molecule/app-locales-moderation-queue-react'
import type { ModerationQueueTranslationKey, ModerationQueueTranslations } from '@molecule/app-locales-moderation-queue-react'
```
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-moderation-queue-react`
