# @molecule/app-locales-keyboard

Translations for @molecule/app-keyboard in 79 languages

## Purpose

Provides translations for the `@molecule/app-keyboard` package which has 1 translation key.
...
```typescript
import { af, am, ar } from '@molecule/app-locales-keyboard'
import type { KeyboardTranslationKey, KeyboardTranslations } from '@molecule/app-locales-keyboard'
```
...
import * as locales from '@molecule/app-locales-keyboard'
...
| Key | English |
|-----|---------|
| `keyboard.error.noProvider` | @molecule/app-keyboard: No provider set. Call setProvider() with a KeyboardProvider implementation (e.g., from @molecule/app-keyboard-capacitor). |
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-keyboard`
