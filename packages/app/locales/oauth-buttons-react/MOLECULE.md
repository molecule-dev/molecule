# @molecule/app-locales-oauth-buttons-react
...
```typescript
import { af, am, ar } from '@molecule/app-locales-oauth-buttons-react'
import type { OAuthButtonsTranslationKey, OAuthButtonsTranslations } from '@molecule/app-locales-oauth-buttons-react'
```
