...
Translations for @molecule/app-subscription-plan-card-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-subscription-plan-card-react` package which has 1 translation key.
...
import * as locales from '@molecule/app-locales-subscription-plan-card'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-subscription-plan-card-react`
