# @molecule/app-locales-feature-barcode-scanner-react
...
```typescript
import { af, am, ar } from '@molecule/app-locales-feature-barcode-scanner-react'
import type { BarcodeScannerTranslationKey, BarcodeScannerTranslations } from '@molecule/app-locales-feature-barcode-scanner-react'
```
