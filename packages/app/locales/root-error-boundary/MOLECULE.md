...
Translations for @molecule/app-root-error-boundary-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-root-error-boundary-react` package which has 1 translation key.
...
import * as locales from '@molecule/app-locales-root-error-boundary'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-root-error-boundary-react`
