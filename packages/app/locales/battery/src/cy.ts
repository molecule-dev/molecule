...
/** Battery translations for cy. */
export const cy: Partial<BatteryTranslations> = {
  'battery.charging': 'Yn Gwefru',
  'battery.discharging': 'Ar Fatri',
  'battery.not-charging': 'Ddim yn Gwefru',
  'battery.unknown': 'Anhysbys',
