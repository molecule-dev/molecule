...
import type { BatteryTranslationKey, BatteryTranslations } from '../types.js'

const REQUIRED_KEYS: BatteryTranslationKey[] = [
  'battery.charging',
  'battery.discharging',
  'battery.full',
...
const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, BatteryTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('battery locale bond', () => {
