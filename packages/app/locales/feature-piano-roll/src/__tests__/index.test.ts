...
const reference = locales.en as PianoRollTranslations
const REQUIRED_KEYS = Object.keys(reference) as (keyof PianoRollTranslations)[]

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, PianoRollTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('feature-piano-roll-react locale bond', () => {
