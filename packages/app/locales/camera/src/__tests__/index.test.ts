...
import type { CameraTranslationKey, CameraTranslations } from '../types.js'

const REQUIRED_KEYS: CameraTranslationKey[] = [
...
const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, CameraTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('camera locale bond', () => {
