# @molecule/app-locales-now-playing-bar

Translations for @molecule/app-now-playing-bar-react in 79 languages
...
import * as locales from '@molecule/app-locales-now-playing-bar'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-now-playing-bar-react`
