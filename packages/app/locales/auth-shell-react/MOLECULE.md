# @molecule/app-locales-auth-shell-react
...
```typescript
import * as auth_shell_react from '@molecule/app-locales-auth-shell-react'
import type { AuthShellTranslationKey, AuthShellTranslations } from '@molecule/app-locales-auth-shell-react'
```
