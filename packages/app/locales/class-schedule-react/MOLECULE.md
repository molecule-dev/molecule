# @molecule/app-locales-class-schedule-react
...
```typescript
import { af, am, ar } from '@molecule/app-locales-class-schedule-react'
import type { ClassScheduleTranslationKey, ClassScheduleTranslations } from '@molecule/app-locales-class-schedule-react'
```
