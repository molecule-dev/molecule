# @molecule/app-locales-medication-row-react
...
```typescript
import * as medication_row_react from '@molecule/app-locales-medication-row-react'
import type { MedicationRowTranslationKey, MedicationRowTranslations } from '@molecule/app-locales-medication-row-react'
```
