...
Translations for @molecule/app-code-block-react in 79 languages
...
import * as locales from '@molecule/app-locales-code-block'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-code-block-react`
