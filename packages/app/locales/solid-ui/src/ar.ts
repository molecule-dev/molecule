...
/** SolidUi translations for ar. */
export const ar: Partial<SolidUiTranslations> = {
  ...
  'solid.error.useAccordionOutsideProvider': 'يجب استخدام مكونات الأكورديون داخل الأكورديون',
