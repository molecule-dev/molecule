...
/** SolidUi translations for gu. */
export const gu: Partial<SolidUiTranslations> = {
  'solid.error.useAccordionOutsideProvider': 'એકોર્ડિયન ઘટકોનો ઉપયોગ એકોર્ડિયનમાં જ થવો જોઈએ.',
  ...
  'solid.error.useToastOutsideProvider': 'useToast નો ઉપયોગ ToastProvider માં થવો જોઈએ.',
}
