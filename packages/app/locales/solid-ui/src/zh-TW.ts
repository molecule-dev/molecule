...
/** SolidUi translations for zh-TW. */
export const zhTW: Partial<SolidUiTranslations> = {
  'solid.error.useAccordionOutsideProvider': '手風琴組件必須在手風琴內部使用。',
  'ui.alert.dismiss': '解僱',
  'ui.avatar.alt': '阿凡達',
  'ui.input.clear': '清除',
  'ui.modal.close': '關閉',
  ...
  'ui.table.empty': '暫無數據',
  'ui.toast.close': '關閉',
  'solid.error.useToastOutsideProvider': 'useToast 必須在 ToastProvider 中使用。',
}
