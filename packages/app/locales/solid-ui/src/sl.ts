...
/** SolidUi translations for sl. */
export const sl: Partial<SolidUiTranslations> = {
  ...
  'solid.error.useToastOutsideProvider': 'useToast se mora uporabljati znotraj ToastProviderja.',
}
