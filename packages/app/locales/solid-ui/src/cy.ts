...
export const cy: Partial<SolidUiTranslations> = {
  'solid.error.useAccordionOutsideProvider': "Rhaid defnyddio cydrannau'r acordion o fewn acordion",
  ...
  'ui.toast.close': 'Cau',
  'solid.error.useToastOutsideProvider': 'Rhaid defnyddio useToast o fewn Darparwr Toast',
}
