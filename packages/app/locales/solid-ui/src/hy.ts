...
/** SolidUi translations for hy. */
export const hy: Partial<SolidUiTranslations> = {
  ...
  'solid.error.useToastOutsideProvider': 'useToast-ը պետք է օգտագործվի ToastProvider-ի ներսում',
}
