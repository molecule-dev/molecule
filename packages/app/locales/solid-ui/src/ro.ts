...
/** SolidUi translations for ro. */
export const ro: Partial<SolidUiTranslations> = {
  ...
  'solid.error.useToastOutsideProvider': 'useToast trebuie utilizat în cadrul unui ToastProvider',
}
