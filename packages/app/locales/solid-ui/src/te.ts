...
/** SolidUi translations for te. */
export const te: Partial<SolidUiTranslations> = {
  'solid.error.useAccordionOutsideProvider': 'అకార్డియన్ భాగాలను అకార్డియన్ లోపల ఉపయోగించాలి',
  ...
  'solid.error.useToastOutsideProvider': 'useToast ను తప్పనిసరిగా ToastProvider లోపల ఉపయోగించాలి',
}
