...
/** SolidUi translations for sr. */
export const sr: Partial<SolidUiTranslations> = {
  ...
  'solid.error.useToastOutsideProvider': 'useToast мора да се користи унутар ToastProvider-а',
}
