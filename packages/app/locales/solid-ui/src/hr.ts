...
/** SolidUi translations for hr. */
export const hr: Partial<SolidUiTranslations> = {
  ...
  'solid.error.useToastOutsideProvider': 'useToast se mora koristiti unutar ToastProvidera',
}
