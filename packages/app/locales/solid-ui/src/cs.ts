...
/** SolidUi translations for cs. */
export const cs: Partial<SolidUiTranslations> = {
  'ui.alert.dismiss': 'Zavřít',
  'ui.input.clear': 'Vymazat',
  'ui.modal.close': 'Zavřít',
  'ui.progress.label': 'Průběh',
  'ui.toast.close': 'Zavřít',
  ...
  'solid.error.useToastOutsideProvider': 'useToast musí být použit v rámci ToastProvider.',
}
