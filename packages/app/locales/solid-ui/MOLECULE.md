...
Translations for @molecule/app-ui-solid in 79 languages
...
```typescript
import { af, am, ar } from '@molecule/app-locales-solid-ui'
...
import * as locales from '@molecule/app-locales-solid-ui'
