# @molecule/app-locales-audio-effects-rack
...
```typescript
import * as audio_effects_rack_react from '@molecule/app-locales-audio-effects-rack'
import type { AudioEffectsRackTranslationKey, AudioEffectsRackTranslations } from '@molecule/app-locales-audio-effects-rack'
```
