# @molecule/app-locales-cookie-banner-react
...
```typescript
import * as cookie_banner_react from '@molecule/app-locales-cookie-banner-react'
import type { CookieBannerTranslationKey, CookieBannerTranslations } from '@molecule/app-locales-cookie-banner-react'
```
