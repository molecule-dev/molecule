...
const reference = locales.en as ChapterListTranslations
const REQUIRED_KEYS = Object.keys(reference) as (keyof ChapterListTranslations)[]

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, ChapterListTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('feature-chapter-list-react locale bond', () => {
