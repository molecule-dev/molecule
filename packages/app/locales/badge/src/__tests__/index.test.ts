...
import type { BadgeTranslationKey, BadgeTranslations } from '../types.js'

const REQUIRED_KEYS: BadgeTranslationKey[] = ['badge.error.noProvider']

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, BadgeTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('badge locale bond', () => {
