...
Translations for @molecule/app-time-slot-picker-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-time-slot-picker-react` package which has 1 translation key.
...
import * as locales from '@molecule/app-locales-time-slot-picker'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-time-slot-picker-react`
