...
Translations for @molecule/app-file-dropzone-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-file-dropzone-react` package which has 1 translation key.
...
import * as locales from '@molecule/app-locales-file-dropzone'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-file-dropzone-react`
