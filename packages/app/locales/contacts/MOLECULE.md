# @molecule/app-locales-contacts

Translations for molecule contacts components in 79 languages

## Purpose

Provides translations for the `@molecule/app-contacts` package which has 1 translation key.
...
```typescript
import { af, am, ar } from '@molecule/app-locales-contacts'
import type { ContactsTranslationKey, ContactsTranslations } from '@molecule/app-locales-contacts'
```
...
import * as locales from '@molecule/app-locales-contacts'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-contacts`
