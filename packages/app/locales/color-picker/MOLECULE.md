# @molecule/app-locales-color-picker

Translations for @molecule/app-color-picker in 79 languages

## Purpose

Provides translations for the `@molecule/app-color-picker` package which has 5 translation keys.
...
import * as locales from '@molecule/app-locales-color-picker'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-color-picker`
