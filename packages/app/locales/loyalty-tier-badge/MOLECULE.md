...
Translations for @molecule/app-loyalty-tier-badge-react in 79 languages
...
import * as locales from '@molecule/app-locales-loyalty-tier-badge'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-loyalty-tier-badge-react`
