# @molecule/app-locales-contact-form-react
...
```typescript
import * as contact_form_react from '@molecule/app-locales-contact-form-react'
import type { ContactFormTranslationKey, ContactFormTranslations } from '@molecule/app-locales-contact-form-react'
```
