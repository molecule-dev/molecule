...
Translations for @molecule/app-auth-shell-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-auth-shell-react` package which has 1 translation key.
...
import * as locales from '@molecule/app-locales-auth-shell'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-auth-shell-react`
