...
Translations for @molecule/app-message-bubble-react in 79 languages
...
import * as locales from '@molecule/app-locales-message-bubble'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-message-bubble-react`
