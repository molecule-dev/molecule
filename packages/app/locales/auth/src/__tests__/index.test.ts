...
import type { AuthTranslationKey, AuthTranslations } from '../types.js'

const REQUIRED_KEYS: AuthTranslationKey[] = [
...
const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, AuthTranslations] => entry[1] !== null && typeof entry[1] === 'object',
)

describe('auth locale bond', () => {
