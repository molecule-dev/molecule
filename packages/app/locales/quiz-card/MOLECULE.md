# @molecule/app-locales-quiz-card

Translations for @molecule/app-quiz-card-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-quiz-card-react` package which has 1 translation key.
...
```typescript
import { af, am, ar } from '@molecule/app-locales-quiz-card'
import type { QuizCardTranslationKey, QuizCardTranslations } from '@molecule/app-locales-quiz-card'
```
...
import * as locales from '@molecule/app-locales-quiz-card'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-quiz-card-react`
