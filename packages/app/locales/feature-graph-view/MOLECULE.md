# @molecule/app-locales-feature-graph-view

Translations for @molecule/app-feature-graph-view-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-feature-graph-view-react` package which has 3 translation keys.
...
import * as locales from '@molecule/app-locales-feature-graph-view'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-feature-graph-view-react`
