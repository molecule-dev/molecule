...
Translations for @molecule/app-share-link-card-react in 79 languages
...
import * as locales from '@molecule/app-locales-share-link-card'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-share-link-card-react`
