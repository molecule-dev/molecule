...
Translations for @molecule/app-habit-streak-card-react in 79 languages
...
import * as locales from '@molecule/app-locales-habit-streak-card'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-habit-streak-card-react`
