...
Translations for @molecule/app-sort-picker-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-sort-picker-react` package which has 1 translation key.
...
import * as locales from '@molecule/app-locales-sort-picker'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-sort-picker-react`
