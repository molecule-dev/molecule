# @molecule/app-locales-brightness

Translations for @molecule/app-brightness in 79 languages

## Purpose

Provides translations for the `@molecule/app-brightness` package which has 1 translation key.
...
import * as locales from '@molecule/app-locales-brightness'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-brightness`
