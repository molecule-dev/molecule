...
import type { BluetoothTranslationKey, BluetoothTranslations } from '../types.js'

const REQUIRED_KEYS: BluetoothTranslationKey[] = ['bluetooth.error.noProvider']

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, BluetoothTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('bluetooth locale bond', () => {
