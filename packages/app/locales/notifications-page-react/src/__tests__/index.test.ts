...
const reference = locales.en as NotificationsPageTranslations
const REQUIRED_KEYS = Object.keys(reference) as (keyof NotificationsPageTranslations)[]

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, NotificationsPageTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('notifications-page-react locale bond', () => {
