# @molecule/app-locales-danger-zone-react
...
```typescript
import * as danger_zone_react from '@molecule/app-locales-danger-zone-react'
import type { DangerZoneTranslationKey, DangerZoneTranslations } from '@molecule/app-locales-danger-zone-react'
```
