# @molecule/app-locales-three-viewer-react
...
```typescript
import * as three_viewer_react from '@molecule/app-locales-three-viewer-react'
import type { ThreeViewerTranslationKey, ThreeViewerTranslations } from '@molecule/app-locales-three-viewer-react'
```
