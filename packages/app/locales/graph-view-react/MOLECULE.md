# @molecule/app-locales-graph-view-react
...
```typescript
import * as graph_view_react from '@molecule/app-locales-graph-view-react'
import type { GraphViewTranslationKey, GraphViewTranslations } from '@molecule/app-locales-graph-view-react'
```
