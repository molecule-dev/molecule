# @molecule/app-locales-rule-builder-react

Translations for @molecule/app-rule-builder-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-rule-builder-react` package which has 20 translation keys.
...
```typescript
import { af, am, ar } from '@molecule/app-locales-rule-builder-react'
import type { RuleBuilderTranslationKey, RuleBuilderTranslations } from '@molecule/app-locales-rule-builder-react'
```
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-rule-builder-react`
