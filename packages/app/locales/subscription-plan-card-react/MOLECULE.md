# @molecule/app-locales-subscription-plan-card-react
...
```typescript
import * as subscription_plan_card_react from '@molecule/app-locales-subscription-plan-card-react'
import type { SubscriptionPlanCardTranslationKey, SubscriptionPlanCardTranslations } from '@molecule/app-locales-subscription-plan-card-react'
```
