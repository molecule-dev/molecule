# @molecule/app-locales-pricing-page-react
...
```typescript
import { af, am, ar } from '@molecule/app-locales-pricing-page-react'
import type { PricingPageTranslationKey, PricingPageTranslations } from '@molecule/app-locales-pricing-page-react'
```
