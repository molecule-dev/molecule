...
const reference = locales.en as IconsTranslations
const REQUIRED_KEYS = Object.keys(reference) as (keyof IconsTranslations)[]

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, IconsTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('icons locale bond', () => {
