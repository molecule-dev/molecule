# @molecule/app-locales-nfc

Translations for @molecule/app-nfc in 79 languages

## Purpose

Provides translations for the `@molecule/app-nfc` package which has 1 translation key.
...
```typescript
import { af, am, ar } from '@molecule/app-locales-nfc'
import type { NfcTranslationKey, NfcTranslations } from '@molecule/app-locales-nfc'
```
...
import * as locales from '@molecule/app-locales-nfc'
