...
export const ja: Partial<FileCardTranslations> = {
  ...
  'file-card.aria.size': 'サイズ{{size}}',
  'file-card.aria.modified': '修正済み{{when}}',
  'file-card.modified.minute-one': '1分前',
  'file-card.modified.hour-one': '1時間前',
  'file-card.modified.hour-other': '{{count}} 1時間前',
  'file-card.modified.day-one': '昨日',
  'file-card.modified.day-other': '{{count}}数日前',
  'file-card.modified.week-one': '1週間前',
  'file-card.modified.week-other': '{{count}} 1週間前',
  'file-card.modified.month-one': '1ヶ月前',
  'file-card.modified.month-other': '{{count}}もっと前',
}
