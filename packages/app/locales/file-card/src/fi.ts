...
export const fi: Partial<FileCardTranslations> = {
  ...
  'file-card.aria.size': 'Koko {{size}}',
  'file-card.aria.modified': 'Muokattu {{when}}',
  'file-card.modified.minute-one': '1 minuutti sitten',
  'file-card.modified.hour-one': '1 tunti sitten',
  'file-card.modified.hour-other': '{{count}} tunti sitten',
  'file-card.modified.day-one': 'eilen',
  'file-card.modified.day-other': '{{count}} päivää sitten',
  'file-card.modified.week-one': '1 viikko sitten',
  'file-card.modified.week-other': '{{count}} viikko sitten',
  'file-card.modified.month-one': '1 kk sitten',
  'file-card.modified.month-other': '{{count}} kuukausi sitten',
}
