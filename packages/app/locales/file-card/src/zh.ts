...
export const zh: Partial<FileCardTranslations> = {
  ...
  'file-card.modified.hour-other': '{{count}}一小时前',
  'file-card.modified.day-one': '昨天',
  'file-card.modified.day-other': '{{count}}几天前',
  'file-card.modified.week-one': '一周前',
  'file-card.modified.week-other': '{{count}}一周前',
  'file-card.modified.month-one': '1个月前',
  'file-card.modified.month-other': '{{count}}一个月前',
}
