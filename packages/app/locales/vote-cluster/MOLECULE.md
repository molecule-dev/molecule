# @molecule/app-locales-vote-cluster

Translations for @molecule/app-vote-cluster-react in 79 languages
...
import * as locales from '@molecule/app-locales-vote-cluster'
