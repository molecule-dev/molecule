# @molecule/app-locales-carousel

Translations for @molecule/app-carousel-react in 79 languages
...
```typescript
import { af, am, ar } from '@molecule/app-locales-carousel'
import type { CarouselTranslationKey, CarouselTranslations } from '@molecule/app-locales-carousel'
```
...
import * as locales from '@molecule/app-locales-carousel'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-carousel-react`
