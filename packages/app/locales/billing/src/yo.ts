...
export const yo: Partial<BillingTranslations> = {
  ...
  'billing.pricing.error': 'Kò le gbé iye owó sókè. Gbìyànjú lẹ́ẹ̀kan síi nígbà tó bá yá.',
  'billing.pricing.checkoutError': 'Kò le bẹ̀rẹ̀ sí í san owó. Jọ̀wọ́ gbìyànjú lẹ́ẹ̀kan sí i.',
  'billing.pricing.reassurance': 'Fagilé nígbàkúgbà · Kò sí káàdì kirẹ́díìtì tí a nílò láti bẹ̀rẹ̀',
