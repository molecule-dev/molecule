...
export const ur: Partial<BillingTranslations> = {
  ...
  'billing.pricing.error': 'قیمتوں کو لوڈ نہیں کیا جا سکا۔ بعد میں دوبارہ کوشش کریں۔',
  'billing.pricing.checkoutError': 'چیک آؤٹ شروع نہیں کیا جا سکا۔ براہ کرم دوبارہ کوشش کریں۔',
  'billing.pricing.reassurance':
    'کسی بھی وقت منسوخ کریں · شروع کرنے کے لیے کسی کریڈٹ کارڈ کی ضرورت نہیں ہے۔',
