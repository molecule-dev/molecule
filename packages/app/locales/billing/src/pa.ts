...
export const pa: Partial<BillingTranslations> = {
  ...
  'billing.pricing.error': 'ਕੀਮਤ ਲੋਡ ਨਹੀਂ ਕੀਤੀ ਜਾ ਸਕੀ। ਬਾਅਦ ਵਿੱਚ ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ।',
  'billing.pricing.checkoutError':
    'ਚੈੱਕਆਉਟ ਸ਼ੁਰੂ ਨਹੀਂ ਕੀਤਾ ਜਾ ਸਕਿਆ। ਕਿਰਪਾ ਕਰਕੇ ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ।',
  'billing.pricing.reassurance':
    'ਕਿਸੇ ਵੀ ਸਮੇਂ ਰੱਦ ਕਰੋ · ਸ਼ੁਰੂ ਕਰਨ ਲਈ ਕਿਸੇ ਕ੍ਰੈਡਿਟ ਕਾਰਡ ਦੀ ਲੋੜ ਨਹੀਂ ਹੈ',
