...
export const ml: Partial<BillingTranslations> = {
  ...
  'billing.pricing.error': 'വിലനിർണ്ണയം ലോഡ് ചെയ്യാൻ കഴിഞ്ഞില്ല. പിന്നീട് വീണ്ടും ശ്രമിക്കുക.',
  'billing.pricing.checkoutError': 'ചെക്ക്ഔട്ട് ആരംഭിക്കാൻ കഴിഞ്ഞില്ല. വീണ്ടും ശ്രമിക്കുക.',
  'billing.pricing.reassurance':
    'എപ്പോൾ വേണമെങ്കിലും റദ്ദാക്കാം · ആരംഭിക്കാൻ ക്രെഡിറ്റ് കാർഡ് ആവശ്യമില്ല.',
