...
export const gu: Partial<BillingTranslations> = {
  ...
  'billing.pricing.error': 'કિંમત લોડ કરી શકાઈ નથી. પછીથી ફરી પ્રયાસ કરો.',
  'billing.pricing.checkoutError': 'ચેકઆઉટ શરૂ કરી શકાયું નથી. કૃપા કરીને ફરી પ્રયાસ કરો.',
  'billing.pricing.reassurance': 'ગમે ત્યારે રદ કરો · શરૂ કરવા માટે કોઈ ક્રેડિટ કાર્ડની જરૂર નથી',
