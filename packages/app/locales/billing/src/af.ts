...
export const af: Partial<BillingTranslations> = {
  ...
  'billing.pricing.error': 'Kon nie pryse laai nie. Probeer later weer.',
  'billing.pricing.checkoutError': 'Kon nie met afhandeling begin nie. Probeer asseblief weer.',
  'billing.pricing.reassurance': 'Kanselleer enige tyd · Geen kredietkaart nodig om te begin nie',
