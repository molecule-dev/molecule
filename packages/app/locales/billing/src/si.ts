...
export const si: Partial<BillingTranslations> = {
  ...
  'billing.pricing.error': 'මිල ගණන් පූරණය කළ නොහැකි විය. පසුව නැවත උත්සාහ කරන්න.',
  'billing.pricing.checkoutError': 'පිටවීම ආරම්භ කළ නොහැකි විය. කරුණාකර නැවත උත්සාහ කරන්න.',
  'billing.pricing.reassurance':
    'ඕනෑම වේලාවක අවලංගු කරන්න · ආරම්භ කිරීමට ක්‍රෙඩිට් කාඩ්පතක් අවශ්‍ය නොවේ.',
