...
import type { AdjustmentSliderTranslationKey, AdjustmentSliderTranslations } from '../types.js'

const REQUIRED_KEYS: AdjustmentSliderTranslationKey[] = [
  'adjustmentSlider.aria',
  'adjustmentSlider.reset.aria',
]

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, AdjustmentSliderTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('adjustment-slider locale bond', () => {
