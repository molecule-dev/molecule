# @molecule/app-locales-message-bubble-react
...
```typescript
import * as message_bubble_react from '@molecule/app-locales-message-bubble-react'
import type { MessageBubbleTranslationKey, MessageBubbleTranslations } from '@molecule/app-locales-message-bubble-react'
```
