...
Translations for @molecule/app-plan-updated-page-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-plan-updated-page-react` package which has 1 translation key.
...
import * as locales from '@molecule/app-locales-plan-updated-page'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-plan-updated-page-react`
