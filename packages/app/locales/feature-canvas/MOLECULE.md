# @molecule/app-locales-feature-canvas

Translations for @molecule/app-feature-canvas-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-feature-canvas-react` package which has 4 translation keys.
...
```typescript
import { af, am, ar } from '@molecule/app-locales-feature-canvas'
import type { CanvasTranslationKey, CanvasTranslations } from '@molecule/app-locales-feature-canvas'
```
...
import * as locales from '@molecule/app-locales-feature-canvas'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-feature-canvas-react`
