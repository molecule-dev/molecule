# @molecule/app-locales-biometrics

Translations for @molecule/app-biometrics in 79 languages

## Purpose

Provides translations for the `@molecule/app-biometrics` package which has 11 translation keys.
...
import * as locales from '@molecule/app-locales-biometrics'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-biometrics`
