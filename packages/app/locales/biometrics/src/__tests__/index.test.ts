...
import type { BiometricsTranslationKey, BiometricsTranslations } from '../types.js'

const REQUIRED_KEYS: BiometricsTranslationKey[] = [
...
const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, BiometricsTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('biometrics locale bond', () => {
