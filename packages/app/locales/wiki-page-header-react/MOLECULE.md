# @molecule/app-locales-wiki-page-header-react
...
```typescript
import * as wiki_page_header_react from '@molecule/app-locales-wiki-page-header-react'
import type { WikiPageHeaderTranslationKey, WikiPageHeaderTranslations } from '@molecule/app-locales-wiki-page-header-react'
```
