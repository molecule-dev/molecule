...
Translations for @molecule/app-stage-timeline-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-stage-timeline-react` package which has 1 translation key.
...
import * as locales from '@molecule/app-locales-stage-timeline'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-stage-timeline-react`
