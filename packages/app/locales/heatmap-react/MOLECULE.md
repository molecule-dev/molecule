# @molecule/app-locales-heatmap-react
...
```typescript
import { af, am, ar } from '@molecule/app-locales-heatmap-react'
import type { HeatmapTranslationKey, HeatmapTranslations } from '@molecule/app-locales-heatmap-react'
```
