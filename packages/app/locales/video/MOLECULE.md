# @molecule/app-locales-video

Translations for @molecule/app-video in 79 languages

## Purpose

Provides translations for the `@molecule/app-video` package which has 1 translation key.
...
```typescript
import { af, am, ar } from '@molecule/app-locales-video'
import type { VideoTranslationKey, VideoTranslations } from '@molecule/app-locales-video'
```
...
import * as locales from '@molecule/app-locales-video'
