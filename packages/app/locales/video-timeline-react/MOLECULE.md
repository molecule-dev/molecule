# @molecule/app-locales-video-timeline-react
...
```typescript
import * as video_timeline_react from '@molecule/app-locales-video-timeline-react'
import type { VideoTimelineTranslationKey, VideoTimelineTranslations } from '@molecule/app-locales-video-timeline-react'
```
