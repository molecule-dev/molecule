...
Translations for @molecule/app-onboarding-modal-react in 79 languages
...
import * as locales from '@molecule/app-locales-onboarding-modal'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-onboarding-modal-react`
