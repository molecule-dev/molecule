# @molecule/app-locales-code-editor

Translations for @molecule/app-code-editor in 79 languages

## Purpose

Provides translations for the `@molecule/app-code-editor` package which has 1 translation key.
...
import * as locales from '@molecule/app-locales-code-editor'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-code-editor`
