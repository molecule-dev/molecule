...
const reference = locales.en as VideoScrubberTranslations
const REQUIRED_KEYS = Object.keys(reference) as (keyof VideoScrubberTranslations)[]

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, VideoScrubberTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('feature-video-scrubber-react locale bond', () => {
