# @molecule/app-locales-share

Translations for @molecule/app-share in 79 languages

## Purpose

Provides translations for the `@molecule/app-share` package which has 1 translation key.
...
```typescript
import { af, am, ar } from '@molecule/app-locales-share'
import type { ShareTranslationKey, ShareTranslations } from '@molecule/app-locales-share'
```
...
import * as locales from '@molecule/app-locales-share'
...
| Key | English |
|-----|---------|
| `share.error.noProvider` | Share provider is not configured. |
