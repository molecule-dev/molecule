...
import type { CalendarTranslationKey, CalendarTranslations } from '../types.js'

const REQUIRED_KEYS: CalendarTranslationKey[] = ['calendar.error.noProvider']

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, CalendarTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('calendar locale bond', () => {
