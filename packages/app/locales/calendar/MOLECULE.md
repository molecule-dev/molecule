# @molecule/app-locales-calendar

Translations for @molecule/app-calendar in 79 languages

## Purpose

Provides translations for the `@molecule/app-calendar` package which has 1 translation key.
...
```typescript
import { af, am, ar } from '@molecule/app-locales-calendar'
import type { CalendarTranslationKey, CalendarTranslations } from '@molecule/app-locales-calendar'
```
...
import * as locales from '@molecule/app-locales-calendar'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-calendar`
