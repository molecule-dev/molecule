...
Translations for @molecule/app-announcement-bar-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-announcement-bar-react` package which has 1 translation key.
...
import * as locales from '@molecule/app-locales-announcement-bar'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-announcement-bar-react`
