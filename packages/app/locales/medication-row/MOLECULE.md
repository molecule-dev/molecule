...
Translations for @molecule/app-medication-row-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-medication-row-react` package which has 1 translation key.
...
import * as locales from '@molecule/app-locales-medication-row'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-medication-row-react`
