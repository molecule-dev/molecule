# @molecule/app-locales-secret-row-react
...
```typescript
import * as secret_row_react from '@molecule/app-locales-secret-row-react'
import type { SecretRowTranslationKey, SecretRowTranslations } from '@molecule/app-locales-secret-row-react'
```
