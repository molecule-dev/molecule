# @molecule/app-locales-piano-roll-react
...
```typescript
import * as piano_roll_react from '@molecule/app-locales-piano-roll-react'
import type { PianoRollTranslationKey, PianoRollTranslations } from '@molecule/app-locales-piano-roll-react'
```
