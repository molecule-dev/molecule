...
Translations for @molecule/app-drawing-toolbar-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-drawing-toolbar-react` package which has 1 translation key.
...
import * as locales from '@molecule/app-locales-drawing-toolbar'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-drawing-toolbar-react`
