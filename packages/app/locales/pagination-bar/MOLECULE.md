...
Translations for @molecule/app-pagination-bar-react in 79 languages
...
import * as locales from '@molecule/app-locales-pagination-bar'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-pagination-bar-react`
