...
/** PasswordStrengthMeter translations for vi. */
export const vi: Partial<PasswordStrengthMeterTranslations> = {
  'passwordStrengthMeter.rule.length': 'Ít nhất 12 ký tự',
  'passwordStrengthMeter.label.0': 'Rất yếu',
  'passwordStrengthMeter.label.1': 'Yếu đuối',
  ...
  'passwordStrengthMeter.rule.symbol': 'Chứa một biểu tượng',
  'passwordStrengthMeter.rule.noCommon': 'Không phải là mật khẩu thông dụng',
}
