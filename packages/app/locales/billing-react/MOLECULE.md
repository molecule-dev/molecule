# @molecule/app-locales-billing-react
...
```typescript
import * as billing_react from '@molecule/app-locales-billing-react'
import type { BillingTranslationKey, BillingTranslations } from '@molecule/app-locales-billing-react'
```
