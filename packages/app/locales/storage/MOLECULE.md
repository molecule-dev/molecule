# @molecule/app-locales-storage

Translations for @molecule/app-storage in 79 languages

## Purpose

Provides translations for the `@molecule/app-storage` package which has 2 translation keys.
...
```typescript
import { af, am, ar } from '@molecule/app-locales-storage'
import type { StorageTranslationKey, StorageTranslations } from '@molecule/app-locales-storage'
```
...
import * as locales from '@molecule/app-locales-storage'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-storage`
