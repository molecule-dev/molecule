...
Translations for @molecule/app-photo-lightbox-react in 79 languages
...
import * as locales from '@molecule/app-locales-photo-lightbox'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-photo-lightbox-react`
