# @molecule/app-locales-thread-tree-react
...
```typescript
import * as thread_tree_react from '@molecule/app-locales-thread-tree-react'
import type { ThreadTreeTranslationKey, ThreadTreeTranslations } from '@molecule/app-locales-thread-tree-react'
```
