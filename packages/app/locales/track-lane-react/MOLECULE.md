# @molecule/app-locales-track-lane-react
...
```typescript
import * as track_lane_react from '@molecule/app-locales-track-lane-react'
import type { TrackLaneTranslationKey, TrackLaneTranslations } from '@molecule/app-locales-track-lane-react'
```
