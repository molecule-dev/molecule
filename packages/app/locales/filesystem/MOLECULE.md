# @molecule/app-locales-filesystem

Translations for @molecule/app-filesystem in 79 languages

## Purpose

Provides translations for the `@molecule/app-filesystem` package which has 1 translation key.
...
import * as locales from '@molecule/app-locales-filesystem'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-filesystem`
