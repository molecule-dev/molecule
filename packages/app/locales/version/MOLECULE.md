# @molecule/app-locales-version

Translations for @molecule/app-version in 79 languages

## Purpose

Provides translations for the `@molecule/app-version` package which has 1 translation key.
...
```typescript
import { af, am, ar } from '@molecule/app-locales-version'
import type { VersionTranslationKey, VersionTranslations } from '@molecule/app-locales-version'
```
...
import * as locales from '@molecule/app-locales-version'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-version`
