...
/** FeatureTransportBar translations for sv. */
export const sv: Partial<FeatureTransportBarTranslations> = {
  'transportBar.aria.play': 'Spela',
  ...
  'transportBar.aria.skipBack': 'Hoppa bakåt',
  'transportBar.aria.skipForward': 'Hoppa framåt',
  'transportBar.aria.stop': 'Stopp',
  'transportBar.aria.loopOn': 'Inaktivera loopen',
