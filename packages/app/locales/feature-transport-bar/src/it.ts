...
/** FeatureTransportBar translations for it. */
export const it: Partial<TransportBarTranslations> = {
  'transportBar.aria.play': 'Riproduci',
  ...
  'transportBar.aria.skipBack': 'Torna indietro',
  'transportBar.aria.skipForward': 'Vai avanti',
  'transportBar.aria.stop': 'Fermare',
  'transportBar.aria.loopOn': 'Disabilita il ciclo',
