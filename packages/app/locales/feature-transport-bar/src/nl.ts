...
/** FeatureTransportBar translations for nl. */
export const nl: Partial<FeatureTransportBarTranslations> = {
  'transportBar.aria.play': 'Afspelen',
  ...
  'transportBar.aria.skipBack': 'Spring achteruit',
  'transportBar.aria.skipForward': 'Spring vooruit',
  'transportBar.aria.stop': 'Stop',
  'transportBar.aria.loopOn': 'Schakel de lus uit',
