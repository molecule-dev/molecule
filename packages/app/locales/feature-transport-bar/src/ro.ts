...
/** FeatureTransportBar translations for ro. */
export const ro: Partial<FeatureTransportBarTranslations> = {
  ...
  'transportBar.aria.skipBack': 'Sari înapoi',
  ...
  'transportBar.aria.loopOn': 'Dezactivați bucla',
