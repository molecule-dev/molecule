# @molecule/app-locales-password-strength-meter-react
...
```typescript
import { af, am, ar } from '@molecule/app-locales-password-strength-meter-react'
import type { PasswordStrengthMeterTranslationKey, PasswordStrengthMeterTranslations } from '@molecule/app-locales-password-strength-meter-react'
```
