...
export const pa: Partial<NotificationsPageTranslations> = {
  ...
  'notificationsPage.feedAriaLabel': 'ਸੂਚਨਾਵਾਂ',
  'notificationsPage.loading': 'ਸੂਚਨਾਵਾਂ ਲੋਡ ਕੀਤੀਆਂ ਜਾ ਰਹੀਆਂ ਹਨ…',
  'notificationsPage.error': 'ਸੂਚਨਾਵਾਂ ਲੋਡ ਨਹੀਂ ਕੀਤੀਆਂ ਜਾ ਸਕੀਆਂ।',
