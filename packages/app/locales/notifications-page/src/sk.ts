...
export const sk: Partial<NotificationsPageTranslations> = {
  ...
  'notificationsPage.feedAriaLabel': 'Upozornenia',
  'notificationsPage.loading': 'Načítavajú sa upozornenia…',
  'notificationsPage.error': 'Nepodarilo sa načítať upozornenia.',
