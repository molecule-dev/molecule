...
export const mr: Partial<NotificationsPageTranslations> = {
  ...
  'notificationsPage.filterAriaLabel': 'सूचना फिल्टर करा',
  'notificationsPage.feedAriaLabel': 'सूचना',
  'notificationsPage.loading': 'सूचना लोड होत आहेत…',
  'notificationsPage.error': 'सूचना लोड होऊ शकल्या नाहीत.',
