...
export const uz: Partial<NotificationsPageTranslations> = {
  ...
  'notificationsPage.feedAriaLabel': 'Bildirishnomalar',
  'notificationsPage.loading': 'Bildirishnomalar yuklanmoqda…',
  'notificationsPage.error': 'Bildirishnomalar yuklanmadi.',
