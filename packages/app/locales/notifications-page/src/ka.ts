...
export const ka: Partial<NotificationsPageTranslations> = {
  ...
  'notificationsPage.feedAriaLabel': 'შეტყობინებები',
  'notificationsPage.loading': 'შეტყობინებები იტვირთება…',
  'notificationsPage.error': 'შეტყობინებების ჩატვირთვა ვერ მოხერხდა.',
