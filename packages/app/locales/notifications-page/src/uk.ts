...
/** NotificationsPage translations for uk. */
export const uk: Partial<NotificationsPageTranslations> = {
  'notificationsPage.title': 'Сповіщення',
  'notificationsPage.filterAll': 'Усі',
  'notificationsPage.filterMentions': 'Згадки',
  'notificationsPage.filterAriaLabel': 'Фільтрувати сповіщення',
