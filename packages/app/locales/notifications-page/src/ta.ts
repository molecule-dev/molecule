...
export const ta: Partial<NotificationsPageTranslations> = {
  ...
  'notificationsPage.feedAriaLabel': 'அறிவிப்புகள்',
  'notificationsPage.loading': 'அறிவிப்புகள் ஏற்றப்படுகின்றன…',
  'notificationsPage.error': 'அறிவிப்புகளை ஏற்ற முடியவில்லை.',
