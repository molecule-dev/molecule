...
export const kn: Partial<NotificationsPageTranslations> = {
  ...
  'notificationsPage.feedAriaLabel': 'ಅಧಿಸೂಚನೆಗಳು',
  'notificationsPage.loading': 'ಅಧಿಸೂಚನೆಗಳನ್ನು ಲೋಡ್ ಮಾಡಲಾಗುತ್ತಿದೆ...',
  'notificationsPage.error': 'ಅಧಿಸೂಚನೆಗಳನ್ನು ಲೋಡ್ ಮಾಡಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ.',
