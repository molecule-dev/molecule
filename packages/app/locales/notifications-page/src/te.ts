...
export const te: Partial<NotificationsPageTranslations> = {
  ...
  'notificationsPage.feedAriaLabel': 'నోటిఫికేషన్లు',
  'notificationsPage.loading': 'నోటిఫికేషన్‌లు లోడ్ అవుతున్నాయి…',
  'notificationsPage.error': 'నోటిఫికేషన్‌లను లోడ్ చేయలేకపోయింది.',
