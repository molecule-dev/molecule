...
export const ky: Partial<NotificationsPageTranslations> = {
  ...
  'notificationsPage.filterAriaLabel': 'Эскертмелерди чыпкалоо',
  'notificationsPage.feedAriaLabel': 'Эскертмелер',
  'notificationsPage.loading': 'Эскертмелер жүктөлүүдө…',
  'notificationsPage.error': 'Эскертмелер жүктөлбөй койду.',
