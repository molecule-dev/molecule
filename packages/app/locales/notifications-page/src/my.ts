...
export const my: Partial<NotificationsPageTranslations> = {
  ...
  'notificationsPage.feedAriaLabel': 'အကြောင်းကြားချက်များ',
  'notificationsPage.loading': 'အကြောင်းကြားချက်များကို တင်နေသည်…',
  'notificationsPage.error': 'အကြောင်းကြားချက်များကို တင်၍မရပါ။',
