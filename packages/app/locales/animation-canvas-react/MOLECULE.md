# @molecule/app-locales-animation-canvas-react
...
```typescript
import * as animation_canvas_react from '@molecule/app-locales-animation-canvas-react'
import type { AnimationCanvasTranslationKey, AnimationCanvasTranslations } from '@molecule/app-locales-animation-canvas-react'
```
