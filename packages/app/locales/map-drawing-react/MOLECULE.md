# @molecule/app-locales-map-drawing-react
...
```typescript
import * as map_drawing_react from '@molecule/app-locales-map-drawing-react'
import type { MapDrawingTranslationKey, MapDrawingTranslations } from '@molecule/app-locales-map-drawing-react'
```
