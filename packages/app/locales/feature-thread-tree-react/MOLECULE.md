# @molecule/app-locales-feature-thread-tree-react
...
```typescript
import { af, am, ar } from '@molecule/app-locales-feature-thread-tree-react'
import type { ThreadTreeTranslationKey, ThreadTreeTranslations } from '@molecule/app-locales-feature-thread-tree-react'
```
