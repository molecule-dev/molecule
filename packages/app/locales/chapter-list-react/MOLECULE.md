# @molecule/app-locales-chapter-list-react
...
```typescript
import * as chapter_list_react from '@molecule/app-locales-chapter-list-react'
import type { ChapterListTranslationKey, ChapterListTranslations } from '@molecule/app-locales-chapter-list-react'
```
