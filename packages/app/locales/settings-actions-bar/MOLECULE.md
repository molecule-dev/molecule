# @molecule/app-locales-settings-actions-bar

Translations for @molecule/app-settings-actions-bar-react in 79 languages
...
import * as locales from '@molecule/app-locales-settings-actions-bar'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-settings-actions-bar-react`
