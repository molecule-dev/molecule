# @molecule/app-locales-social-share-buttons-react
...
```typescript
import * as social_share_buttons_react from '@molecule/app-locales-social-share-buttons-react'
import type { SocialShareButtonsTranslationKey, SocialShareButtonsTranslations } from '@molecule/app-locales-social-share-buttons-react'
```
