# @molecule/app-locales-transport-bar
...
```typescript
import * as transport_bar_react from '@molecule/app-locales-transport-bar'
import type { TransportBarTranslationKey, TransportBarTranslations } from '@molecule/app-locales-transport-bar'
```
