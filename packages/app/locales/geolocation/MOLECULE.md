# @molecule/app-locales-geolocation

Translations for molecule geolocation components in 79 languages

## Purpose

Provides translations for the `@molecule/app-geolocation` package which has 1 translation key.
...
import * as locales from '@molecule/app-locales-geolocation'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-geolocation`
