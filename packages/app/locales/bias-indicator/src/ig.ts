...
/** BiasIndicator translations for ig. */
export const ig: Partial<BiasIndicatorTranslations> = {
  'biasIndicator.bias.farLeft': 'Aka ekpe dị anya',
  ...
  'biasIndicator.reliability.disputed': 'Ntụkwasị obi: arụrịta ụka',
}
