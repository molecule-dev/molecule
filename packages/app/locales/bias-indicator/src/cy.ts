...
/** BiasIndicator translations for cy. */
export const cy: Partial<BiasIndicatorTranslations> = {
  ...
  'biasIndicator.reliability.low': 'Dibynadwyedd: isel',
  'biasIndicator.reliability.disputed': 'Dibynadwyedd: dan anghydfod',
}
