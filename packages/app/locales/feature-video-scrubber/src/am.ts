...
export const am: Partial<FeatureVideoScrubberTranslations> = {
  ...
  'videoScrubber.aria.frameReadout': 'ፍሬም<x> {{ፍሬም}}</x> የ<x> {{ጠቅላላ}}</x>',
  'videoScrubber.aria.thumbnail': 'የፍሬም ቅድመ-እይታ',
  'videoScrubber.thumbnails.empty': 'ምንም ቅድመ እይታ የለም',
  'videoScrubber.frameReadout.total': '/<x> {{ጠቅላላ}}</x> ክፈፎች',
}
