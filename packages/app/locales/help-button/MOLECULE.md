...
Translations for @molecule/app-help-button-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-help-button-react` package which has 1 translation key.
...
import * as locales from '@molecule/app-locales-help-button'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-help-button-react`
