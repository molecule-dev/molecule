...
Translations for @molecule/app-cookie-banner-react in 79 languages
...
import * as locales from '@molecule/app-locales-cookie-banner'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-cookie-banner-react`
