...
Translations for @molecule/app-video-player-react in 79 languages
...
import * as locales from '@molecule/app-locales-video-player'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-video-player-react`
