...
export const km: Partial<ReactUiTranslations> = {
  ...
  'react.error.useAccordionOutsideProvider': 'សមាសធាតុ​អាកកូឌីយ៉ុង​ត្រូវតែ​ប្រើ​ក្នុង​អាកកូឌីយ៉ុង',
  'ui.alert.dismiss': 'បដិសេធ',
  'ui.avatar.alt': 'រូប​តំណាង',
  'ui.input.clear': 'ជម្រះ',
  'ui.modal.close': 'បិទ',
  ...
  'sidebar.memberStatus': 'សមាជិក​លំដាប់​ខ្ពស់',
  'sidebarUserCard.guest': 'ភ្ញៀវ',
  'ui.spinner.loading': 'កំពុងផ្ទុក',
  'ui.table.empty': 'គ្មានទិន្នន័យទេ',
  'ui.toast.close': 'បិទ',
  'react.error.useToastOutsideProvider': 'useToast ត្រូវតែប្រើនៅក្នុង ToastProvider',
  'userMenu.guestName': 'អ្នកវិភាគ',
  'userMenuPopover.guest': 'គណនី',
}
