...
/** ReactUi translations for uz. */
export const uz: Partial<ReactUiTranslations> = {
  'userMenu.navLabel': 'Hisob menyusi',
  'react.error.useAccordionOutsideProvider':
    'Akkordeon komponentlari akkordeon ichida ishlatilishi kerak',
  ...
  'sidebar.memberStatus': "Premium a'zo",
  'sidebarUserCard.guest': 'Mehmon',
  'ui.spinner.loading': 'Yuklanmoqda',
  'ui.table.empty': "Ma'lumotlar mavjud emas",
  'ui.toast.close': 'Yopish',
  'react.error.useToastOutsideProvider':
    'useToast funksiyasi ToastProvider ichida ishlatilishi kerak',
  'userMenu.guestName': 'Tahlilchi',
  'userMenuPopover.guest': 'Hisob',
}
