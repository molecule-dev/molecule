...
export const ga: Partial<ReactUiTranslations> = {
  'react.error.useAccordionOutsideProvider':
    'Ní mór comhpháirteanna an accordion a úsáid laistigh de Accordion',
  ...
  'sidebar.memberStatus': 'Ball Préimhe',
  'sidebarUserCard.guest': 'Aoi',
  'ui.spinner.loading': 'Ag luchtú',
  'ui.table.empty': 'Níl aon sonraí ar fáil',
  'ui.toast.close': 'Dún',
  'react.error.useToastOutsideProvider': 'Ní mór useToast a úsáid laistigh de Sholáthraí Toast',
  'userMenu.guestName': 'Anailísí',
  'userMenuPopover.guest': 'Cuntas',
  'userMenu.navLabel': 'Roghchlár cuntais',
}
