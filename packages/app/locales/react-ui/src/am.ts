...
export const am: Partial<ReactUiTranslations> = {
  ...
  'react.error.useAccordionOutsideProvider': 'የአኮርዲዮን ክፍሎች በአኮርዲዮን ውስጥ ጥቅም ላይ መዋል አለባቸው',
  ...
  'sidebar.memberStatus': 'የፕሪሚየም አባል',
  'sidebarUserCard.guest': 'እንግዳ',
  'ui.spinner.loading': 'በመጫን ላይ',
  'ui.table.empty': 'ምንም ውሂብ አይገኝም',
  'ui.toast.close': 'ገጠመ',
  'react.error.useToastOutsideProvider': 'ቶስት በቶስት አቅራቢ ውስጥ ጥቅም ላይ መዋል አለበት',
  'userMenu.guestName': 'ተንታኝ',
  'userMenuPopover.guest': 'መለያ',
}
