...
/** ReactUi translations for eu. */
export const eu: Partial<ReactUiTranslations> = {
  'react.error.useAccordionOutsideProvider':
    'Akordeoiaren osagaiak akordeoi baten barruan erabili behar dira',
  'ui.alert.dismiss': 'Baztertu',
  'ui.avatar.alt': 'Avatarra',
  'ui.input.clear': 'Garbitu',
  'ui.modal.close': 'Itxi',
  ...
  'sidebar.memberStatus': 'Premium kidea',
  'sidebarUserCard.guest': 'Gonbidatua',
  'ui.spinner.loading': 'Kargatzen',
  'ui.table.empty': 'Ez dago daturik eskuragarri',
  'ui.toast.close': 'Itxi',
  'react.error.useToastOutsideProvider': 'useToast ToastProvider baten barruan erabili behar da',
  'userMenu.guestName': 'Analista',
  'userMenuPopover.guest': 'Kontua',
  'userMenu.navLabel': 'Kontuaren menua',
}
