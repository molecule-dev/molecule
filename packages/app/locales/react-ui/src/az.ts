...
/** ReactUi translations for az. */
export const az: Partial<ReactUiTranslations> = {
  'react.error.useAccordionOutsideProvider':
    'Akkordeon komponentləri akkordeonda istifadə olunmalıdır',
  'ui.alert.dismiss': 'Ləğv et',
  'ui.avatar.alt': 'Avatar',
  'ui.input.clear': 'Təmiz',
  ...
  'sidebar.memberStatus': 'Premium Üzv',
  'sidebarUserCard.guest': 'Qonaq',
  'ui.spinner.loading': 'Yüklənir',
  'ui.table.empty': 'Məlumat mövcud deyil',
  'ui.toast.close': 'Bağla',
  'react.error.useToastOutsideProvider':
    'useToast funksiyası ToastProvider daxilində istifadə olunmalıdır',
  'userMenu.guestName': 'Analitik',
  'userMenuPopover.guest': 'Hesab',
  'userMenu.navLabel': 'Hesab menyusu',
}
