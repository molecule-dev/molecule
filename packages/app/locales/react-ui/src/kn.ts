...
export const kn: Partial<ReactUiTranslations> = {
  ...
  'react.error.useAccordionOutsideProvider': 'ಅಕಾರ್ಡಿಯನ್ ಘಟಕಗಳನ್ನು ಅಕಾರ್ಡಿಯನ್ ಒಳಗೆ ಬಳಸಬೇಕು.',
  'ui.alert.dismiss': 'ವಜಾಗೊಳಿಸಿ',
  'ui.avatar.alt': 'ಅವತಾರ್',
  'ui.input.clear': 'ಸ್ಪಷ್ಟ',
  ...
  'sidebar.memberStatus': 'ಪ್ರೀಮಿಯಂ ಸದಸ್ಯ',
  'sidebarUserCard.guest': 'ಅತಿಥಿ',
  'ui.spinner.loading': 'ಲೋಡ್ ಆಗುತ್ತಿದೆ',
  'ui.table.empty': 'ಯಾವುದೇ ಡೇಟಾ ಲಭ್ಯವಿಲ್ಲ.',
  'ui.toast.close': 'ಮುಚ್ಚಿ',
  'react.error.useToastOutsideProvider': 'useToast ಅನ್ನು ToastProvider ನಲ್ಲಿಯೇ ಬಳಸಬೇಕು.',
  'userMenu.guestName': 'ವಿಶ್ಲೇಷಕ',
  'userMenuPopover.guest': 'ಖಾತೆ',
}
