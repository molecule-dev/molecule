...
/** ReactUi translations for be. */
export const be: Partial<ReactUiTranslations> = {
  'react.error.useAccordionOutsideProvider':
    'Кампаненты акардэона павінны выкарыстоўвацца ўнутры акардэона',
  'ui.alert.dismiss': 'Адхіліць',
  'ui.avatar.alt': 'Аватар',
  'ui.input.clear': 'Ачысціць',
  ...
  'sidebar.memberStatus': 'Прэміум-удзельнік',
  'sidebarUserCard.guest': 'Госць',
  'ui.spinner.loading': 'Загрузка',
  'ui.table.empty': 'Няма дадзеных',
  'ui.toast.close': 'Закрыць',
  'react.error.useToastOutsideProvider': 'useToast павінен выкарыстоўвацца ўнутры ToastProvider',
  'userMenu.guestName': 'Аналітык',
  'userMenuPopover.guest': 'Рахунак',
  'userMenu.navLabel': 'Меню ўліковага запісу',
}
