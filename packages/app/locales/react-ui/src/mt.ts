...
/** ReactUi translations for mt. */
export const mt: Partial<ReactUiTranslations> = {
  ...
  'sidebarUserCard.guest': 'Mistieden',
  'ui.spinner.loading': 'Tagħbija',
  'ui.table.empty': 'L-ebda dejta disponibbli',
  'ui.toast.close': 'Agħlaq',
  'react.error.useToastOutsideProvider': 'useToast irid jintuża fi ħdan ToastProvider',
  'userMenu.guestName': 'Analista',
  'userMenuPopover.guest': 'Kont',
  'userMenu.navLabel': 'Menù tal-Kont',
}
