...
/** ReactUi translations for gl. */
export const gl: Partial<ReactUiTranslations> = {
  'react.error.useAccordionOutsideProvider':
    'Os compoñentes do acordeón deben usarse dentro dun acordeón',
  ...
  'ui.table.empty': 'Non hai datos dispoñibles',
  'ui.toast.close': 'Pechar',
  'react.error.useToastOutsideProvider': 'useToast debe usarse dentro dun ToastProvider',
  'userMenu.guestName': 'Analista',
  'userMenuPopover.guest': 'Conta',
  'userMenu.navLabel': 'Menú da conta',
}
