...
/** ReactUi translations for my. */
export const my: Partial<ReactUiTranslations> = {
  'userMenu.navLabel': 'အကောင့်မီနူး',
  ...
  'sidebar.memberStatus': 'ပရီမီယံအသင်းဝင်',
  'sidebarUserCard.guest': 'ဧည့်သည်',
  'ui.spinner.loading': 'တင်နေသည်',
  'ui.table.empty': 'ဒေတာ မရှိပါ',
  'ui.toast.close': 'ပိတ်ရန်',
  'react.error.useToastOutsideProvider': 'useToast ကို ToastProvider အတွင်းတွင် အသုံးပြုရမည်',
  'userMenu.guestName': 'ခွဲခြမ်းစိတ်ဖြာသူ',
  'userMenuPopover.guest': 'အကောင့်',
}
