...
/** ReactUi translations for sw. */
export const sw: Partial<ReactUiTranslations> = {
  'react.error.useAccordionOutsideProvider':
    'Vipengele vya akodoni lazima vitumike ndani ya akodoni',
  ...
  'sidebar.memberStatus': 'Mwanachama wa Premium',
  'sidebarUserCard.guest': 'Mgeni',
  'ui.spinner.loading': 'Inapakia',
  'ui.table.empty': 'Hakuna data inayopatikana',
  'ui.toast.close': 'Funga',
  'react.error.useToastOutsideProvider': 'useToast lazima itumike ndani ya ToastProvider',
  'userMenu.guestName': 'Mchambuzi',
  'userMenuPopover.guest': 'Akaunti',
  'userMenu.navLabel': 'Menyu ya akaunti',
}
