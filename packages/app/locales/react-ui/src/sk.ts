...
/** ReactUi translations for sk. */
export const sk: Partial<ReactUiTranslations> = {
  'react.error.useAccordionOutsideProvider': 'Komponenty akordeónu sa musia používať v akordeóne',
  'ui.alert.dismiss': 'Zavrieť',
  'ui.avatar.alt': 'Avatar',
  'ui.input.clear': 'Jasné',
  ...
  'sidebarUserCard.guest': 'Hosť',
  'ui.spinner.loading': 'Načítava sa',
  'ui.table.empty': 'Nie sú k dispozícii žiadne údaje',
  'ui.toast.close': 'Zatvoriť',
  'react.error.useToastOutsideProvider': 'useToast sa musí použiť v rámci ToastProvider',
  'userMenu.guestName': 'Analytik',
  'userMenuPopover.guest': 'Účet',
  'userMenu.navLabel': 'Ponuka účtu',
}
