...
/** ReactUi translations for tr. */
export const tr: Partial<ReactUiTranslations> = {
  'ui.alert.dismiss': 'Kapat',
  'ui.input.clear': 'Temizle',
  'ui.modal.close': 'Kapat',
  'ui.progress.label': 'İlerleme',
  'sidebarUserCard.guest': 'Misafir',
  'ui.spinner.loading': 'Yükleniyor',
  'ui.toast.close': 'Kapat',
  'userMenu.guestName': 'Analist',
  'userMenuPopover.guest': 'Hesap',
  'userMenu.navLabel': 'Hesap menüsü',
  'react.error.useAccordionOutsideProvider':
    'Akordiyon parçaları, bir akordiyon içinde kullanılmalıdır.',
  ...
  'react.error.useToastOutsideProvider': 'useToast, bir ToastProvider içinde kullanılmalıdır.',
}
