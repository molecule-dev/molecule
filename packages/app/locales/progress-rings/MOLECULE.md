# @molecule/app-locales-progress-rings

Translations for @molecule/app-progress-rings-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-progress-rings-react` package which has 2 translation keys.
...
import * as locales from '@molecule/app-locales-progress-rings'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-progress-rings-react`
