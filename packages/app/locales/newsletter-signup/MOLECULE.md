...
Translations for @molecule/app-newsletter-signup-react in 79 languages
...
import * as locales from '@molecule/app-locales-newsletter-signup'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-newsletter-signup-react`
