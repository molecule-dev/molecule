# @molecule/app-locales-rating-form-react
...
```typescript
import * as rating_form_react from '@molecule/app-locales-rating-form-react'
import type { RatingFormTranslationKey, RatingFormTranslations } from '@molecule/app-locales-rating-form-react'
```
