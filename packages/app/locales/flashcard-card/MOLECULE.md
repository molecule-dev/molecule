...
Translations for @molecule/app-flashcard-card-react in 79 languages
...
import * as locales from '@molecule/app-locales-flashcard-card'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-flashcard-card-react`
