...
const reference = locales.en as PricingPageTranslations
const REQUIRED_KEYS = Object.keys(reference) as (keyof PricingPageTranslations)[]

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, PricingPageTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('pricing-page-react locale bond', () => {
