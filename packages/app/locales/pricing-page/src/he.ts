...
/** PricingPage translations for he. */
export const he: Partial<PricingPageTranslations> = {
  'pricingPage.currentCta': 'התוכנית הנוכחית',
  'pricingPage.periodToggle.monthly': 'יַרחוֹן',
  'pricingPage.periodToggle.yearly': 'שְׁנָתִי',
  'pricingPage.heading': 'בחר את התוכנית שלך',
  'pricingPage.loading': 'טוען תוכניות...',
