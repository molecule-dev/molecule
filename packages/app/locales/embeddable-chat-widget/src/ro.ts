...
/** EmbeddableChatWidget translations for ro. */
export const ro: Partial<EmbeddableChatWidgetTranslations> = {
  ...
  'embeddableChatWidget.composer.placeholder': 'Scrie mesajul tău…',
  'embeddableChatWidget.error.streamError': 'Ceva nu a mers bine. Vă rugăm să încercați din nou.',
}
