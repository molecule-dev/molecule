...
/** EmbeddableChatWidget translations for uk. */
export const uk: Partial<EmbeddableChatWidgetTranslations> = {
  ...
  'embeddableChatWidget.composer.placeholder': 'Введіть своє повідомлення…',
  'embeddableChatWidget.error.streamError': 'Щось пішло не так. Спробуйте ще раз.',
}
