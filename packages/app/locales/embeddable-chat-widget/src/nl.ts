...
/** EmbeddableChatWidget translations for nl. */
export const nl: Partial<EmbeddableChatWidgetTranslations> = {
  ...
  'embeddableChatWidget.panel.headerLabel': 'Chatten met {{brandName}}',
