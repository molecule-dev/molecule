...
/** EmbeddableChatWidget translations for hu. */
export const hu: Partial<EmbeddableChatWidgetTranslations> = {
  ...
  'embeddableChatWidget.composer.placeholder': 'Írd be az üzeneted…',
  'embeddableChatWidget.error.streamError': 'Valami hiba történt. Próbáld újra.',
}
