...
/** EmbeddableChatWidget translations for cs. */
export const cs: Partial<EmbeddableChatWidgetTranslations> = {
  ...
  'embeddableChatWidget.composer.placeholder': 'Napište svou zprávu…',
  'embeddableChatWidget.error.streamError': 'Něco se pokazilo. Zkuste to prosím znovu.',
}
