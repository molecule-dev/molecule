...
/** EmbeddableChatWidget translations for tr. */
export const tr: Partial<EmbeddableChatWidgetTranslations> = {
  ...
  'embeddableChatWidget.error.streamError': 'Bir sorun oluştu. Lütfen tekrar deneyin.',
}
