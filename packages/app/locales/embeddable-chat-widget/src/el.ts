...
/** EmbeddableChatWidget translations for el. */
export const el: Partial<EmbeddableChatWidgetTranslations> = {
  ...
  'embeddableChatWidget.composer.placeholder': 'Πληκτρολογήστε το μήνυμά σας…',
  'embeddableChatWidget.error.streamError': 'Κάτι πήγε στραβά. Δοκιμάστε ξανά.',
}
