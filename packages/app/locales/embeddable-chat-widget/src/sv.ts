...
/** EmbeddableChatWidget translations for sv. */
export const sv: Partial<EmbeddableChatWidgetTranslations> = {
  ...
  'embeddableChatWidget.error.streamError': 'Något gick fel. Försök igen.',
}
