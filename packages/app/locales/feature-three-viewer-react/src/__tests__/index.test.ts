...
const reference = locales.en as ThreeViewerTranslations
const REQUIRED_KEYS = Object.keys(reference) as (keyof ThreeViewerTranslations)[]

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, ThreeViewerTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('feature-three-viewer-react locale bond', () => {
