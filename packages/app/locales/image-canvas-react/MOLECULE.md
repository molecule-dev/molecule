# @molecule/app-locales-image-canvas-react
...
```typescript
import * as image_canvas_react from '@molecule/app-locales-image-canvas-react'
import type { ImageCanvasTranslationKey, ImageCanvasTranslations } from '@molecule/app-locales-image-canvas-react'
```
