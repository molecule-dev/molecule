# @molecule/app-locales-i18n

Translations for @molecule/app-i18n in 79 languages

## Purpose

Provides translations for the `@molecule/app-i18n` package which has 1 translation key.
...
```typescript
import { af, am, ar } from '@molecule/app-locales-i18n'
import type { I18nTranslationKey, I18nTranslations } from '@molecule/app-locales-i18n'
```
...
import * as locales from '@molecule/app-locales-i18n'
...
| Key | English |
|-----|---------|
| `i18n.date.invalidDate` | Invalid Date |
