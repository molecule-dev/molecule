...
import type { I18nTranslations } from '../types.js'

const reference = locales.en as I18nTranslations
const REQUIRED_KEYS = Object.keys(reference) as (keyof I18nTranslations)[]

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, I18nTranslations] => entry[1] !== null && typeof entry[1] === 'object',
)

describe('i18n locale bond', () => {
