...
Translations for @molecule/app-search-autocomplete-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-search-autocomplete-react` package which has 1 translation key.
...
import * as locales from '@molecule/app-locales-search-autocomplete'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-search-autocomplete-react`
