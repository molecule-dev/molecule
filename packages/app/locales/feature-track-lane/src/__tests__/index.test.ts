...
const reference = locales.en as TrackLaneTranslations
const REQUIRED_KEYS = Object.keys(reference) as (keyof TrackLaneTranslations)[]

const localeTables = Object.entries(locales).filter(
  (entry): entry is [string, TrackLaneTranslations] =>
    entry[1] !== null && typeof entry[1] === 'object',
)

describe('feature-track-lane-react locale bond', () => {
