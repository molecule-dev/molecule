...
Translations for @molecule/app-contact-form-react in 79 languages
...
import * as locales from '@molecule/app-locales-contact-form'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-contact-form-react`
