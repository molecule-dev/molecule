# @molecule/app-locales-bulk-action-toolbar

Translations for @molecule/app-bulk-action-toolbar-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-bulk-action-toolbar-react` package which has 1 translation key.
...
import * as locales from '@molecule/app-locales-bulk-action-toolbar'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-bulk-action-toolbar-react`
