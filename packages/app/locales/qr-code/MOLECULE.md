# @molecule/app-locales-qr-code

Translations for @molecule/app-qr-code-react in 79 languages

## Purpose

Provides translations for the `@molecule/app-qr-code-react` package which has 1 translation key.
...
```typescript
import { af, am, ar } from '@molecule/app-locales-qr-code'
import type { QrCodeTranslationKey, QrCodeTranslations } from '@molecule/app-locales-qr-code'
```
...
import * as locales from '@molecule/app-locales-qr-code'
...
| Key | English |
|-----|---------|
| `qrCode.aria.label` | QR code for {{value}} |
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-qr-code-react`
