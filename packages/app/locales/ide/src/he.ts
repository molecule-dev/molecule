...
export const he: Partial<IdeTranslations> = {
  ...
  'ide.chat.modelSet': "מודל הצ'אט מוגדר ל- {{name}}",
  ...
  'ide.chat.modelUpgradeRequired': '{{model}} זמין ב-Pro. שדרג כדי לגשת לכל הדגמים.',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} קבצים לא מחויבים',
  ...
  'ide.contextMenu.deleteCount': 'לִמְחוֹק {{count}} פריטים',
  ...
  'ide.preview.retryCount': 'ניסיון חוזר {{count}}',
  ...
  'ide.toolCall.newFileLines': 'קובץ חדש, {{count}} קווים',
  ...
  'ide.toolCall.andMore': '... ו {{count}} יוֹתֵר',
  ...
  'ide.toolCall.entryCount': '{{count}} ערכים',
  ...
  'ide.chat.maxLoopsSet': 'מספר איטרציות הכלי המקסימלי מוגדר ל- {{n}}',
  ...
  'ide.chat.voiceEngineTitle': 'מנוע הכתבה',
  'ide.chat.voiceEnginePrivacy': 'כל אפשרות פועלת במכשיר שלך — השמע לעולם לא עוזב את הדפדפן.',
  'ide.chat.voiceEngineNoDownload': 'ללא הורדה',
  'ide.chat.voiceEngineDownload': 'הורדה של ~{{mb}} MB, ואז נשמר במטמון',
  'ide.chat.voiceEngineDownloadRange': 'הורדה של ~{{min}}–{{max}} MB, ואז נשמר במטמון',
  'ide.chat.voiceAccuracyBest': 'הדיוק הטוב ביותר',
  'ide.chat.voiceAccuracyGood': 'דיוק טוב',
  'ide.chat.voiceAccuracyBasic': 'דיוק בסיסי',
  'ide.chat.voiceEngineNative': 'מובנה בדפדפן',
  'ide.chat.voiceEngineOnDevice': 'במכשיר',
  'ide.chat.voiceEngineNoBrowserSupport': 'לא זמין בדפדפן זה',
  'ide.chat.voiceEngineNoLanguageSupport': 'לא זמין לשפה שלך',
  'ide.chat.voiceEngineCurrent': 'נוכחי',
  'ide.chat.voiceLangsAll': 'כל השפות',
  'ide.chat.voiceLangOnly': '{{language}} בלבד',
  'ide.chat.voiceLangsCount': '{{count}} שפות',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'מעובד ב: {{region}} — לחצו לשינוי',
  'ide.chat.model.regionOnlyHint': 'מתארח רק ב: {{region}}',
  'ide.chat.model.regionMenuLabel': 'אזור עיבוד',
  'ide.chat.models.colRegion': 'אזור',
  'ide.chat.modelInUseRegion': 'משתמש כעת ב-{{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} קווים',
  'ide.toolCall.linesRemoved': '− {{count}} קווים',
  'ide.toolCall.changesApplied': '{{count}} שינויים שהוחלו',
  'ide.toolCall.applied': 'יישומי',
  'ide.tabs.close': 'לִסְגוֹר {{fileName}}',
  ...
  'ide.chat.share.notAllowed': 'ניהול קישורי שיתוף דורש תפקיד מנהל בפרויקט זה.',
  ...
  'ide.chat.fastModeOn': 'מצב מהיר מופעל - תגובות מהירות יותר בקצב גבוה יותר',
  ...
  'ide.tests.testCount': '{{count}} בדיקות',
  'ide.tests.run': 'לָרוּץ',
  'ide.tests.runAll': 'הפעל את הכל',
  'ide.tests.runE2e': 'רוץ e2e',
  'ide.tests.runUnit': 'יחידת הפעלת',
  'ide.tests.runGroup': 'קבוצת ריצה',
  'ide.tests.stop': 'לְהַפְסִיק',
  'ide.tests.running': 'רִיצָה…',
  'ide.tests.passedCount': '{{count}} עבר',
  'ide.tests.failedCount': '{{count}} נִכשָׁל',
  'ide.tests.statusPassed': 'עבר',
  'ide.tests.statusFailed': 'נִכשָׁל',
  'ide.tests.statusSkipped': 'דילג',
  'ide.tests.kind.e2e': 'מקצה לקצה',
  'ide.tests.kind.unit': 'יְחִידָה',
  'ide.tests.workspace.app': 'אפליקציה',
  'ide.tests.workspace.api': 'ממשק API',
  'ide.tests.workspace.root': 'פּרוֹיֶקט',
  'ide.tests.e2eHint':
    'אלה פועלים כנגד התצוגה המקדימה החיה, לכן יש להשאיר את התצוגה המקדימה פתוחה.',
  'ide.tests.showOutput': 'הצג פלט',
  'ide.tests.hideOutput': 'הסתר פלט',
  ...
  'ide.tests.cancelled': 'הריצה נעצרה.',
  'ide.tests.listError': 'לא ניתן היה לפרט את הבדיקות של הפרויקט הזה.',
