...
export const ar: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'حجم الملف كبير جدًا. الحد الأقصى للحجم هو {{maxSize}} م.ب.',
  'ide.chat.modelSet': 'تم ضبط نموذج الدردشة على {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} الملفات غير الملتزمة',
  ...
  'ide.contextMenu.deleteCount': 'يمسح {{count}} أغراض',
  ...
  'ide.chat.loopLimitReached': 'بلغ الحد الأقصى لـ {{max}} تكرارات الأدوات.',
  'ide.chat.maxLoopsSet': 'تم ضبط الحد الأقصى لعدد تكرارات الأداة على {{n}}',
  ...
  'ide.chat.voiceEngineTitle': 'محرك الإملاء',
  'ide.chat.voiceEnginePrivacy': 'كل خيار يعمل على جهازك — الصوت لا يغادر متصفحك أبدًا.',
  'ide.chat.voiceEngineNoDownload': 'بدون تنزيل',
  'ide.chat.voiceEngineDownload': 'تنزيل ~{{mb}} م.ب، ثم يُخزَّن',
  'ide.chat.voiceEngineDownloadRange': 'تنزيل ~{{min}}–{{max}} م.ب، ثم يُخزَّن',
  'ide.chat.voiceAccuracyBest': 'أفضل دقة',
  'ide.chat.voiceAccuracyGood': 'دقة جيدة',
  'ide.chat.voiceAccuracyBasic': 'دقة أساسية',
  'ide.chat.voiceEngineNative': 'مدمج في المتصفح',
  'ide.chat.voiceEngineOnDevice': 'على الجهاز',
  'ide.chat.voiceEngineNoBrowserSupport': 'غير متاح في هذا المتصفح',
  'ide.chat.voiceEngineNoLanguageSupport': 'غير متاح للغتك',
  'ide.chat.voiceEngineCurrent': 'الحالي',
  'ide.chat.voiceLangsAll': 'كل اللغات',
  'ide.chat.voiceLangOnly': '{{language}} فقط',
  'ide.chat.voiceLangsCount': '{{count}} لغة',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'تتم المعالجة في: {{region}} — انقر للتغيير',
  'ide.chat.model.regionOnlyHint': 'مستضاف فقط في: {{region}}',
  'ide.chat.model.regionMenuLabel': 'منطقة المعالجة',
  'ide.chat.models.colRegion': 'المنطقة',
  'ide.chat.modelInUseRegion': 'يُستخدم الآن {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} خطوط',
  'ide.toolCall.linesRemoved': '- {{count}} خطوط',
  'ide.toolCall.changesApplied': '{{count}} تم تطبيق التغييرات',
  'ide.tabs.close': 'يغلق {{fileName}}',
  ...
  'ide.chat.streaming.thinking': 'أفكر...',
  'ide.chat.streaming.analyzing': 'جاري التحليل...',
  'ide.chat.streaming.reasoning': 'التفكير المنطقي...',
  'ide.chat.streaming.crafting': 'جاري إعداد الرد...',
  'ide.chat.streaming.working': 'أعمل على ذلك...',
  'ide.chat.streaming.processing': 'جاري المعالجة...',
  'ide.chat.streaming.connecting': 'ربط النقاط...',
  'ide.chat.streaming.almostThere': 'أوشكنا على الوصول...',
  'ide.chat.help.card.heading': 'مساعدة',
  'ide.chat.help.card.commandsTitle': 'الأوامر',
  'ide.chat.help.card.modesTitle': 'الأوضاع',
  'ide.chat.help.card.tipsTitle': 'نصائح',
  ...
  'ide.tests.testCount': '{{count}} الاختبارات',
  'ide.tests.run': 'تشغيل',
  'ide.tests.runAll': 'تشغيل الكل',
  'ide.tests.runE2e': 'تشغيل e2e',
  'ide.tests.runUnit': 'تشغيل الوحدة',
  'ide.tests.runGroup': 'مجموعة الجري',
  'ide.tests.stop': 'توقف',
  'ide.tests.running': 'الجري…',
  'ide.tests.passedCount': '{{count}} تم إقراره',
  'ide.tests.failedCount': '{{count}} فشل',
  'ide.tests.statusPassed': 'تم إقراره',
  'ide.tests.statusFailed': 'فشل',
  'ide.tests.statusSkipped': 'تم تخطيها',
  'ide.tests.kind.e2e': 'من البداية إلى النهاية',
  'ide.tests.kind.unit': 'الوحدة',
  ...
  'ide.tests.cancelled': 'توقف التشغيل.',
  'ide.tests.listError': 'تعذر عرض قائمة اختبارات هذا المشروع.',
