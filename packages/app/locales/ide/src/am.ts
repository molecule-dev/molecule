...
export const am: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'ፋይሉ በጣም ትልቅ ነው። ከፍተኛው መጠን {{maxSize}} ኤምቢ.',
  'ide.chat.modelSet': 'የውይይት ሞዴል ወደ ተቀናብሯል {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} ያልተገደቡ ፋይሎች',
  ...
  'ide.contextMenu.deleteCount': 'ሰርዝ {{count}} እቃዎች',
  ...
  'ide.preview.retryCount': 'እንደገና ይሞክሩት ሙከራ {{count}}',
  ...
  'ide.chat.loopLimitReached': 'ከፍተኛውን ደረጃ ላይ ደርሷል {{max}} የመሳሪያ ድግግሞሾች።',
  'ide.chat.maxLoopsSet': 'ከፍተኛው የመሳሪያ ድግግሞሽ ወደ {{n}}',
  ...
  'ide.chat.voiceEngineTitle': 'የንግግር ሞተር',
  'ide.chat.voiceEnginePrivacy': 'እያንዳንዱ አማራጭ በመሣሪያዎ ላይ ይሰራል — ድምፅ አሳሽዎን በፍጹም አይለቅም።',
  'ide.chat.voiceEngineNoDownload': 'ማውረድ የለም',
  'ide.chat.voiceEngineDownload': '~{{mb}} MB ማውረድ፣ ከዚያ ይቀመጣል',
  'ide.chat.voiceEngineDownloadRange': '~{{min}}–{{max}} MB ማውረድ፣ ከዚያ ይቀመጣል',
  'ide.chat.voiceAccuracyBest': 'ምርጥ ትክክለኛነት',
  'ide.chat.voiceAccuracyGood': 'ጥሩ ትክክለኛነት',
  'ide.chat.voiceAccuracyBasic': 'መሠረታዊ ትክክለኛነት',
  'ide.chat.voiceEngineNative': 'የአሳሽ ውስጣዊ',
  'ide.chat.voiceEngineOnDevice': 'በመሣሪያ ላይ',
  'ide.chat.voiceEngineNoBrowserSupport': 'በዚህ አሳሽ ውስጥ አይገኝም',
  'ide.chat.voiceEngineNoLanguageSupport': 'ለቋንቋዎ አይገኝም',
  'ide.chat.voiceEngineCurrent': 'የአሁኑ',
  'ide.chat.voiceLangsAll': 'ሁሉም ቋንቋዎች',
  'ide.chat.voiceLangOnly': '{{language}} ብቻ',
  'ide.chat.voiceLangsCount': '{{count}} ቋንቋዎች',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'የሚሰራው በ: {{region}} — ለመቀየር ጠቅ ያድርጉ',
  'ide.chat.model.regionOnlyHint': 'የሚስተናገደው በ: {{region}} ብቻ ነው',
  'ide.chat.model.regionMenuLabel': 'የማቀነባበሪያ ክልል',
  'ide.chat.models.colRegion': 'ክልል',
  'ide.chat.modelInUseRegion': 'አሁን {{model}} ({{region}}) በጥቅም ላይ ነው',
  ...
  'ide.tests.testCount': '{{count}} ፈተናዎች',
  'ide.tests.run': 'ሩጫ',
  'ide.tests.runAll': 'ሁሉንም አሂድ',
  'ide.tests.runE2e': 'e2e ን ያሂዱ',
  'ide.tests.runUnit': 'የሩጫ አሃድ',
  'ide.tests.runGroup': 'ቡድን አሂድ',
  'ide.tests.stop': 'ተወ',
  'ide.tests.running': 'እየሮጠች…',
  'ide.tests.passedCount': '{{count}} አልፏል',
  'ide.tests.failedCount': '{{count}} አልተሳካም',
  'ide.tests.statusPassed': 'አልፏል',
  'ide.tests.statusFailed': 'አልተሳካም',
  'ide.tests.statusSkipped': 'ተዘልሏል',
  'ide.tests.kind.e2e': 'ከጫፍ እስከ ጫፍ',
  'ide.tests.kind.unit': 'ዩኒት',
  'ide.tests.workspace.app': 'መተግበሪያ',
  'ide.tests.workspace.api': 'ኤፒአይ',
  'ide.tests.workspace.root': 'ፕሮጀክት',
  'ide.tests.e2eHint': 'እነዚህ ከቀጥታ ቅድመ እይታ ጋር ይጣጣማሉ፣ ስለዚህ ቅድመ እይታውን ክፍት ያድርጉት።',
  'ide.tests.showOutput': 'ውጤት አሳይ',
  'ide.tests.hideOutput': 'ውጤትን ደብቅ',
  ...
  'ide.tests.cancelled': 'ሩጫው ቆሟል።',
  'ide.tests.listError': 'የዚህን ፕሮጀክት ፈተናዎች መዘርዘር አልተቻለም።',
