...
export const hi: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'फ़ाइल का आकार बहुत बड़ा है। अधिकतम आकार है {{maxSize}} एमबी.',
  'ide.chat.modelSet': 'चैट मॉडल सेट किया गया {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} अप्रतिबद्ध फ़ाइलें',
  ...
  'ide.contextMenu.deleteCount': 'मिटाना {{count}} सामान',
  ...
  'ide.toolCall.newFileLines': 'नई फ़ाइल, {{count}} पंक्तियां',
  ...
  'ide.chat.loopLimitReached': 'अधिकतम सीमा तक पहुँच गया {{max}} टूल पुनरावृति।',
  'ide.chat.maxLoopsSet': 'अधिकतम टूल पुनरावृति को सेट किया गया है {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'सर्वोत्तम सटीकता',
  'ide.chat.voiceAccuracyGood': 'अच्छी सटीकता',
  'ide.chat.voiceAccuracyBasic': 'बुनियादी सटीकता',
  'ide.chat.voiceEngineNative': 'ब्राउज़र में निर्मित',
  'ide.chat.voiceEngineOnDevice': 'डिवाइस पर',
  'ide.chat.voiceEngineNoBrowserSupport': 'इस ब्राउज़र में उपलब्ध नहीं',
  'ide.chat.voiceEngineNoLanguageSupport': 'आपकी भाषा के लिए उपलब्ध नहीं',
  'ide.chat.voiceEngineCurrent': 'वर्तमान',
  'ide.chat.voiceLangsAll': 'सभी भाषाएँ',
  'ide.chat.voiceLangOnly': 'केवल {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} भाषाएँ',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'प्रोसेसिंग: {{region}} में — बदलने के लिए क्लिक करें',
  'ide.chat.model.regionOnlyHint': 'केवल {{region}} में होस्ट किया गया',
  'ide.chat.model.regionMenuLabel': 'प्रोसेसिंग क्षेत्र',
  'ide.chat.models.colRegion': 'क्षेत्र',
  'ide.chat.modelInUseRegion': 'अब {{model}} ({{region}}) उपयोग में है',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} पंक्तियां',
  'ide.toolCall.linesRemoved': '− {{count}} पंक्तियां',
  'ide.toolCall.changesApplied': '{{count}} परिवर्तन लागू किए गए',
  'ide.tabs.close': 'बंद करना {{fileName}}',
  ...
  'ide.chat.fastModeOn': 'फास्ट मोड चालू — तेज़ प्रतिक्रियाएँ और उच्च दर',
  'ide.chat.fastModeOff': 'फास्ट मोड बंद',
  'ide.chat.fastModeEnable': 'फास्ट मोड — उच्च टोकन दर पर 2.5 गुना तक तेज़ आउटपुट',
  'ide.chat.fastModeDisable': 'फास्ट मोड बंद करें',
  ...
  'ide.tests.testCount': '{{count}} परीक्षण',
  'ide.tests.run': 'दौड़ना',
  'ide.tests.runAll': 'सभी चलाएँ',
  'ide.tests.runE2e': 'e2e चलाएँ',
  'ide.tests.runUnit': 'रन यूनिट',
  'ide.tests.runGroup': 'समूह चलाएँ',
  'ide.tests.stop': 'रुकना',
  'ide.tests.running': 'दौड़ना…',
  'ide.tests.passedCount': '{{count}} उत्तीर्ण',
  'ide.tests.failedCount': '{{count}} असफल',
  'ide.tests.statusPassed': 'उत्तीर्ण',
  'ide.tests.statusFailed': 'असफल',
  'ide.tests.statusSkipped': 'छोड़ा गया',
  'ide.tests.kind.e2e': 'शुरू से अंत तक',
  'ide.tests.kind.unit': 'इकाई',
  'ide.tests.workspace.app': 'अनुप्रयोग',
  'ide.tests.workspace.api': 'एपीआई',
  'ide.tests.workspace.root': 'परियोजना',
  'ide.tests.e2eHint': 'ये लाइव प्रीव्यू के साथ चलते हैं, इसलिए प्रीव्यू को खुला रखें।',
  'ide.tests.showOutput': 'आउटपुट दिखाएँ',
  'ide.tests.hideOutput': 'आउटपुट छुपाएँ',
  ...
  'ide.tests.cancelled': 'दौड़ रुक गई।',
  'ide.tests.listError': 'इस प्रोजेक्ट के टेस्ट की सूची नहीं मिल सकी।',
