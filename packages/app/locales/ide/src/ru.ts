...
export const ru: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileCount': '{{count}} файлы',
  ...
  'ide.chat.fileTooLarge': 'Файл слишком большой. Максимальный размер равен... {{maxSize}} МБ.',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} незафиксированные файлы',
  ...
  'ide.contextMenu.deleteCount': 'Удалить {{count}} Предметы',
  ...
  'ide.preview.retryCount': 'Повторить попытку {{count}}',
  ...
  'ide.toolCall.newFileLines': 'новый файл, {{count}} линии',
  ...
  'ide.toolCall.andMore': '… и {{count}} более',
  ...
  'ide.toolCall.matchCount': '{{count}} матчи',
  'ide.toolCall.fileCount': '{{count}} файлы',
  ...
  'ide.chat.loopLimitReached': 'Достигнут максимум {{max}} Итерации инструментария.',
  'ide.chat.maxLoopsSet': 'Максимальное количество итераций инструмента установлено на {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'лучшая точность',
  'ide.chat.voiceAccuracyGood': 'хорошая точность',
  'ide.chat.voiceAccuracyBasic': 'базовая точность',
  'ide.chat.voiceEngineNative': 'встроенный в браузер',
  'ide.chat.voiceEngineOnDevice': 'на устройстве',
  'ide.chat.voiceEngineNoBrowserSupport': 'недоступно в этом браузере',
  'ide.chat.voiceEngineNoLanguageSupport': 'недоступно для вашего языка',
  'ide.chat.voiceEngineCurrent': 'текущий',
  'ide.chat.voiceLangsAll': 'все языки',
  'ide.chat.voiceLangOnly': 'только {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} языков',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Обрабатывается в: {{region}} — нажмите, чтобы изменить',
  'ide.chat.model.regionOnlyHint': 'Размещено только в: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Регион обработки',
  'ide.chat.models.colRegion': 'Регион',
  'ide.chat.modelInUseRegion': 'Теперь используется {{model}} ({{region}})',
  ...
  'ide.toolCall.changesApplied': '{{count}} внесенные изменения',
  'ide.toolCall.applied': 'Применяемый',
  'ide.tabs.close': 'Закрывать {{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} тесты',
  'ide.tests.run': 'Запустить',
  'ide.tests.runAll': 'Запустить все',
  'ide.tests.runE2e': 'Запустить e2e',
  'ide.tests.runUnit': 'Запустить модуль',
  'ide.tests.runGroup': 'Группа бегунов',
  'ide.tests.stop': 'Стоп',
  'ide.tests.running': 'Бег…',
  'ide.tests.passedCount': '{{count}} принят',
  'ide.tests.failedCount': '{{count}} не удалось',
  'ide.tests.statusPassed': 'Принято',
  'ide.tests.statusFailed': 'Не удалось',
  'ide.tests.statusSkipped': 'Пропущено',
  'ide.tests.kind.e2e': 'От начала до конца',
  'ide.tests.kind.unit': 'Единица',
  ...
  'ide.tests.cancelled': 'Запуск остановлен.',
  'ide.tests.listError': 'Не удалось составить список тестов для этого проекта.',
  'ide.tests.runError': 'Пробный запуск не удалось запустить.',
  'ide.tests.viewerCannotRun': 'Запускать тесты этого проекта могут только редакторы.',
  'ide.tests.needsSandbox': 'Запустите проект, чтобы выполнить его тесты.',
  'ide.tests.heading': 'Тесты',
  'ide.tests.searchPlaceholder': 'Тесты фильтров…',
  'ide.tests.loading': 'Загрузка тестов…',
