...
export const ur: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'فائل بہت بڑی ہے۔ زیادہ سے زیادہ سائز ہے۔ {{maxSize}} ایم بی',
  'ide.chat.modelSet': 'چیٹ ماڈل پر سیٹ ہے۔ {{name}}',
  ...
  'ide.contextMenu.deleteCount': 'حذف کریں۔ {{count}} اشیاء',
  ...
  'ide.preview.retryCount': 'دوبارہ کوشش کریں۔ {{count}}',
  ...
  'ide.toolCall.newFileLines': 'نئی فائل، {{count}} لائنیں',
  ...
  'ide.chat.loopLimitReached': 'کی زیادہ سے زیادہ تک پہنچ گئی۔ {{max}} ٹول کی تکرار',
  'ide.chat.maxLoopsSet': 'ٹول کی زیادہ سے زیادہ تکرار پر سیٹ ہے۔ {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'بہترین درستگی',
  'ide.chat.voiceAccuracyGood': 'اچھی درستگی',
  'ide.chat.voiceAccuracyBasic': 'بنیادی درستگی',
  'ide.chat.voiceEngineNative': 'براؤزر میں شامل',
  'ide.chat.voiceEngineOnDevice': 'آلے پر',
  'ide.chat.voiceEngineNoBrowserSupport': 'اس براؤزر میں دستیاب نہیں',
  'ide.chat.voiceEngineNoLanguageSupport': 'آپ کی زبان کے لیے دستیاب نہیں',
  'ide.chat.voiceEngineCurrent': 'موجودہ',
  'ide.chat.voiceLangsAll': 'تمام زبانیں',
  'ide.chat.voiceLangOnly': 'صرف {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} زبانیں',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'پروسیسنگ: {{region}} میں — تبدیل کرنے کے لیے کلک کریں',
  'ide.chat.model.regionOnlyHint': 'صرف {{region}} میں ہوسٹ کیا گیا',
  'ide.chat.model.regionMenuLabel': 'پروسیسنگ خطہ',
  'ide.chat.models.colRegion': 'خطہ',
  'ide.chat.modelInUseRegion': 'اب {{model}} ({{region}}) استعمال ہو رہا ہے',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} لائنیں',
  'ide.toolCall.linesRemoved': '- {{count}} لائنیں',
  'ide.toolCall.changesApplied': '{{count}} تبدیلیاں لاگو',
  'ide.toolCall.applied': 'لاگو',
  'ide.tabs.close': 'بند {{fileName}}',
  ...
  'ide.chat.fastModeOn': 'فاسٹ موڈ آن — زیادہ شرح پر تیز جوابات',
  ...
  'ide.tests.testCount': '{{count}} ٹیسٹ',
  'ide.tests.run': 'دوڑو',
  'ide.tests.runAll': 'سب چلائیں',
  'ide.tests.runE2e': 'e2e چلائیں۔',
  'ide.tests.runUnit': 'یونٹ چلائیں۔',
  'ide.tests.runGroup': 'گروپ چلائیں۔',
  'ide.tests.stop': 'رک جاؤ',
  'ide.tests.running': 'چل رہا ہے…',
  'ide.tests.passedCount': '{{count}} پاس',
  'ide.tests.failedCount': '{{count}} ناکام',
  'ide.tests.statusPassed': 'پاس کیا۔',
  'ide.tests.statusFailed': 'ناکام',
  'ide.tests.statusSkipped': 'چھوڑ دیا',
  'ide.tests.kind.e2e': 'آخر سے آخر تک',
  'ide.tests.kind.unit': 'یونٹ',
  'ide.tests.workspace.app': 'ایپ',
  'ide.tests.workspace.api': 'API',
  'ide.tests.workspace.root': 'پروجیکٹ',
  'ide.tests.e2eHint': 'یہ لائیو پیش نظارہ کے خلاف چلتے ہیں، لہذا پیش نظارہ کو کھلا رکھیں۔',
  'ide.tests.showOutput': 'آؤٹ پٹ دکھائیں۔',
  'ide.tests.hideOutput': 'آؤٹ پٹ چھپائیں۔',
  ...
  'ide.tests.cancelled': 'دوڑنا رک گیا۔',
  'ide.tests.listError': 'اس پروجیکٹ کے ٹیسٹوں کی فہرست نہیں بن سکی۔',
