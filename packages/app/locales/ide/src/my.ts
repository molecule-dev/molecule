...
export const my: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileCount': '{{count}} ဖိုင်များ',
  ...
  'ide.chat.fileTooLarge': 'ဖိုင်က အရမ်းကြီးပါတယ်။ အကြီးဆုံးအရွယ်အစားက {{maxSize}} အမ်ဘီ။',
  'ide.chat.modelSet': 'ချတ်မော်ဒယ်ကို အောက်ပါအတိုင်း သတ်မှတ်ထားသည် {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} ကတိမတည်ရသေးသောဖိုင်များ',
  ...
  'ide.contextMenu.deleteCount': 'ဖျက်ရန် {{count}} ပစ္စည်းများ',
  ...
  'ide.preview.retryCount': 'ပြန်လည်ကြိုးစားခြင်း {{count}}',
  ...
  'ide.toolCall.newFileLines': 'ဖိုင်အသစ်၊ {{count}} လိုင်းများ',
  ...
  'ide.toolCall.andMore': '… နှင့် {{count}} နောက်ထပ်',
  ...
  'ide.toolCall.entryCount': '{{count}} မှတ်တမ်းများ',
  'ide.toolCall.matchCount': '{{count}} ကိုက်ညီမှုများ',
  'ide.toolCall.fileCount': '{{count}} ဖိုင်များ',
  ...
  'ide.chat.voiceAccuracyBest': 'အကောင်းဆုံး တိကျမှု',
  'ide.chat.voiceAccuracyGood': 'ကောင်းမွန်သော တိကျမှု',
  'ide.chat.voiceAccuracyBasic': 'အခြေခံ တိကျမှု',
  'ide.chat.voiceEngineNative': 'ဘရောက်ဆာ ပါရှိပြီး',
  'ide.chat.voiceEngineOnDevice': 'စက်ပေါ်တွင်',
  'ide.chat.voiceEngineNoBrowserSupport': 'ဤဘရောက်ဆာတွင် မရနိုင်ပါ',
  'ide.chat.voiceEngineNoLanguageSupport': 'သင့်ဘာသာစကားအတွက် မရနိုင်ပါ',
  'ide.chat.voiceEngineCurrent': 'လက်ရှိ',
  'ide.chat.voiceLangsAll': 'ဘာသာစကားအားလုံး',
  'ide.chat.voiceLangOnly': '{{language}} သာ',
  'ide.chat.voiceLangsCount': 'ဘာသာစကား {{count}} ခု',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'လုပ်ဆောင်သည့်နေရာ: {{region}} — ပြောင်းရန် နှိပ်ပါ',
  'ide.chat.model.regionOnlyHint': '{{region}} တွင်သာ လက်ခံဆောင်ရွက်သည်',
  'ide.chat.model.regionMenuLabel': 'လုပ်ဆောင်မှုဒေသ',
  'ide.chat.models.colRegion': 'ဒေသ',
  'ide.chat.modelInUseRegion': 'ယခု {{model}} ({{region}}) ကို အသုံးပြုနေသည်',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} လိုင်းများ',
  'ide.toolCall.linesRemoved': '− {{count}} လိုင်းများ',
  'ide.toolCall.changesApplied': '{{count}} ပြောင်းလဲမှုများ သက်ရောက်သည်',
  'ide.toolCall.applied': 'အသုံးချပြီး',
  'ide.tabs.close': 'ပိတ်ရန် {{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} စမ်းသပ်မှုများ',
  'ide.tests.run': 'ပြေးပါ',
  'ide.tests.runAll': 'အားလုံးကို လုပ်ဆောင်ပါ',
  'ide.tests.runE2e': 'e2e ကို လည်ပတ်ပါ',
  'ide.tests.runUnit': 'လည်ပတ်ယူနစ်',
  'ide.tests.runGroup': 'ပြေးအဖွဲ့',
  'ide.tests.stop': 'ရပ်',
  'ide.tests.running': 'ပြေးနေသည်…',
  'ide.tests.passedCount': '{{count}} အောင်မြင်ပြီး',
  'ide.tests.failedCount': '{{count}} မအောင်မြင်',
  'ide.tests.statusPassed': 'အောင်မြင်ပြီး',
  'ide.tests.statusFailed': 'မအောင်မြင်ပါ',
  'ide.tests.statusSkipped': 'ကျော်သွားပါပြီ',
  'ide.tests.kind.e2e': 'အစမှအဆုံး',
  'ide.tests.kind.unit': 'ယူနစ်',
  ...
  'ide.tests.cancelled': 'ပြေးတာ ရပ်သွားတယ်။',
  'ide.tests.listError': 'ဤပရောဂျက်၏ စမ်းသပ်မှုများကို စာရင်းပြုစု၍မရပါ။',
