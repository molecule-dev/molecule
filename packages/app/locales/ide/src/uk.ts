...
export const uk: Partial<IdeTranslations> = {
  ...
  'ide.chat.queuedCount': '{{count}} у черзі',
  ...
  'ide.chat.modelSet': 'Модель чату встановлена на {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} незафіксовані файли',
  ...
  'ide.contextMenu.deleteCount': 'Видалити {{count}} Елементи',
  ...
  'ide.preview.retryCount': 'Повторна спроба {{count}}',
  ...
  'ide.toolCall.matchCount': '{{count}} матчі',
  ...
  'ide.chat.voiceAccuracyBest': 'найкраща точність',
  'ide.chat.voiceAccuracyGood': 'хороша точність',
  'ide.chat.voiceAccuracyBasic': 'базова точність',
  'ide.chat.voiceEngineNative': 'вбудований у браузер',
  'ide.chat.voiceEngineOnDevice': 'на пристрої',
  'ide.chat.voiceEngineNoBrowserSupport': 'недоступно в цьому браузері',
  'ide.chat.voiceEngineNoLanguageSupport': 'недоступно для вашої мови',
  'ide.chat.voiceEngineCurrent': 'поточний',
  'ide.chat.voiceLangsAll': 'усі мови',
  'ide.chat.voiceLangOnly': 'лише {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} мов',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Обробляється в: {{region}} — натисніть, щоб змінити',
  'ide.chat.model.regionOnlyHint': 'Розміщено лише в: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Регіон обробки',
  'ide.chat.models.colRegion': 'Регіон',
  'ide.chat.modelInUseRegion': 'Тепер використовується {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} лінії',
  'ide.toolCall.linesRemoved': '− {{count}} лінії',
  'ide.toolCall.changesApplied': '{{count}} застосовані зміни',
  ...
  'ide.tests.testCount': '{{count}} тести',
  'ide.tests.run': 'Запустити',
  'ide.tests.runAll': 'Виконати все',
  'ide.tests.runE2e': 'Запустити e2e',
  'ide.tests.runUnit': 'Запустити модуль',
  'ide.tests.runGroup': 'Група бігунів',
  'ide.tests.stop': 'Стоп',
  'ide.tests.running': 'Біг…',
  'ide.tests.passedCount': '{{count}} прийнято',
  'ide.tests.failedCount': '{{count}} не вдалося',
  'ide.tests.statusPassed': 'Прийнято',
  'ide.tests.statusFailed': 'Не вдалося',
  'ide.tests.statusSkipped': 'Пропущено',
  'ide.tests.kind.e2e': 'Від початку до кінця',
  'ide.tests.kind.unit': 'Одиниця',
  ...
  'ide.tests.cancelled': 'Виконання зупинено.',
  'ide.tests.listError': 'Не вдалося створити список тестів для цього проєкту.',
