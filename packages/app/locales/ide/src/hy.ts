...
export const hy: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileCount': '{{count}} ֆայլեր',
  ...
  'ide.chat.fileTooLarge': 'Ֆայլը չափազանց մեծ է։ Առավելագույն չափը՝ {{maxSize}} ՄԲ',
  'ide.chat.modelSet': 'Զրույցի մոդելը սահմանված է {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} չհաստատված ֆայլեր',
  ...
  'ide.contextMenu.deleteCount': 'Ջնջել {{count}} Ապրանքներ',
  ...
  'ide.preview.retryCount': 'Կրկին փորձել {{count}}',
  ...
  'ide.toolCall.newFileLines': 'նոր ֆայլ, {{count}} գծեր',
  ...
  'ide.toolCall.andMore': '… և {{count}} ավելին',
  ...
  'ide.toolCall.entryCount': '{{count}} գրառումներ',
  'ide.toolCall.matchCount': '{{count}} համընկնումներ',
  'ide.toolCall.fileCount': '{{count}} ֆայլեր',
  ...
  'ide.chat.loopLimitReached': 'Հասել է առավելագույնին {{max}} գործիքային կրկնություններ։',
  'ide.chat.maxLoopsSet': 'Գործիքի առավելագույն իտերացիաները սահմանված են {{n}}',
  ...
  'ide.chat.voiceEngineTitle': 'Թելադրման շարժիչ',
  'ide.chat.voiceEnginePrivacy':
    'Յուրաքանչյուր տարբերակ աշխատում է ձեր սարքում — ձայնը երբեք չի լքում դիտարկիչը։',
  'ide.chat.voiceEngineNoDownload': 'առանց ներբեռնման',
  'ide.chat.voiceEngineDownload': '~{{mb}} ՄԲ ներբեռնում, ապա պահվում է',
  'ide.chat.voiceEngineDownloadRange': '~{{min}}–{{max}} ՄԲ ներբեռնում, ապա պահվում է',
  'ide.chat.voiceAccuracyBest': 'լավագույն ճշգրտություն',
  'ide.chat.voiceAccuracyGood': 'լավ ճշգրտություն',
  'ide.chat.voiceAccuracyBasic': 'հիմնական ճշգրտություն',
  'ide.chat.voiceEngineNative': 'դիտարկիչի ներկառուցված',
  'ide.chat.voiceEngineOnDevice': 'սարքի վրա',
  'ide.chat.voiceEngineNoBrowserSupport': 'հասանելի չէ այս դիտարկիչում',
  'ide.chat.voiceEngineNoLanguageSupport': 'հասանելի չէ ձեր լեզվի համար',
  'ide.chat.voiceEngineCurrent': 'ընթացիկ',
  'ide.chat.voiceLangsAll': 'բոլոր լեզուները',
  'ide.chat.voiceLangOnly': 'միայն {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} լեզու',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Մշակվում է՝ {{region}} — սեղմեք փոխելու համար',
  'ide.chat.model.regionOnlyHint': 'Տեղակայված է միայն՝ {{region}}',
  'ide.chat.model.regionMenuLabel': 'Մշակման տարածաշրջան',
  'ide.chat.models.colRegion': 'Տարածաշրջան',
  'ide.chat.modelInUseRegion': 'Այժմ օգտագործվում է {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} գծեր',
  'ide.toolCall.linesRemoved': '− {{count}} գծեր',
  'ide.toolCall.changesApplied': '{{count}} կիրառված փոփոխությունները',
  'ide.toolCall.applied': 'Կիրառված',
  'ide.tabs.close': 'Փակել {{fileName}}',
  ...
  'ide.chat.share.notAllowed':
    'Կիսվելու հղումների կառավարումը պահանջում է ադմինիստրատորի դեր այս նախագծում։',
  ...
  'ide.chat.fastModeOn': 'Արագ ռեժիմը միացված է՝ ավելի արագ արձագանքներ՝ ավելի բարձր արագությամբ',
  'ide.chat.fastModeOff': 'Արագ ռեժիմն անջատված է',
  ...
  'ide.tests.testCount': '{{count}} թեստեր',
  'ide.tests.run': 'Վազել',
  'ide.tests.runAll': 'Գործարկել բոլորը',
  'ide.tests.runE2e': 'Գործարկել e2e-ն',
  'ide.tests.runUnit': 'Գործարկել միավորը',
  'ide.tests.runGroup': 'Գործարկման խումբ',
  'ide.tests.stop': 'Կանգ առեք',
  'ide.tests.running': 'Վազում եմ…',
  'ide.tests.passedCount': '{{count}} անցավ',
  'ide.tests.failedCount': '{{count}} ձախողված',
  'ide.tests.statusPassed': 'Հանձնված է',
  'ide.tests.statusFailed': 'Չհաջողվեց',
  'ide.tests.statusSkipped': 'Բաց թողնված',
  'ide.tests.kind.e2e': 'Ամբողջությամբ',
  'ide.tests.kind.unit': 'Միավոր',
  'ide.tests.workspace.app': 'Հավելված',
  'ide.tests.workspace.api': 'API',
  'ide.tests.workspace.root': 'Նախագիծ',
  'ide.tests.e2eHint': 'Սրանք աշխատում են ուղիղ նախադիտման դեմ, այնպես որ նախադիտումը բաց պահեք։',
  'ide.tests.showOutput': 'Ցուցադրել արդյունքը',
  'ide.tests.hideOutput': 'Թաքցնել արդյունքը',
  ...
  'ide.tests.cancelled': 'Վազքը դադարեց։',
  'ide.tests.listError': 'Հնարավոր չէ թվարկել այս նախագծի թեստերը։',
