...
export const de: Partial<IdeTranslations> = {
  ...
  'ide.chat.queuedCount': '{{count}} in Warteschlange',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} nicht übertragene Dateien',
  ...
  'ide.contextMenu.deleteCount': 'Löschen {{count}} Artikel',
  ...
  'ide.chat.loopLimitReached': 'Das Maximum erreicht {{max}} Werkzeugiterationen.',
  'ide.chat.maxLoopsSet': 'Maximale Werkzeugiterationen eingestellt auf {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'beste Genauigkeit',
  'ide.chat.voiceAccuracyGood': 'gute Genauigkeit',
  'ide.chat.voiceAccuracyBasic': 'einfache Genauigkeit',
  'ide.chat.voiceEngineNative': 'browser-nativ',
  'ide.chat.voiceEngineOnDevice': 'auf dem Gerät',
  'ide.chat.voiceEngineNoBrowserSupport': 'in diesem Browser nicht verfügbar',
  'ide.chat.voiceEngineNoLanguageSupport': 'für deine Sprache nicht verfügbar',
  'ide.chat.voiceEngineCurrent': 'aktuell',
  'ide.chat.voiceLangsAll': 'alle Sprachen',
  'ide.chat.voiceLangOnly': 'nur {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} Sprachen',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Verarbeitet in: {{region}} — zum Ändern klicken',
  'ide.chat.model.regionOnlyHint': 'Nur gehostet in: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Verarbeitungsregion',
  'ide.chat.models.colRegion': 'Region',
  'ide.chat.modelInUseRegion': 'Jetzt wird {{model}} ({{region}}) verwendet',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} Linien',
  'ide.toolCall.linesRemoved': '− {{count}} Linien',
  'ide.toolCall.changesApplied': '{{count}} Änderungen angewendet',
  'ide.tabs.close': 'Schließen {{fileName}}',
  ...
  'ide.tests.run': 'Laufen',
  'ide.tests.runAll': 'Alle ausführen',
  'ide.tests.runE2e': 'e2e ausführen',
  'ide.tests.runUnit': 'Einheit ausführen',
  'ide.tests.runGroup': 'Laufgruppe',
  'ide.tests.stop': 'Stopp',
  'ide.tests.running': 'Laufen…',
  'ide.tests.passedCount': '{{count}} bestanden',
  'ide.tests.failedCount': '{{count}} fehlgeschlagen',
  'ide.tests.statusPassed': 'Bestanden',
  'ide.tests.statusFailed': 'Fehlgeschlagen',
  'ide.tests.statusSkipped': 'Übersprungen',
  'ide.tests.kind.e2e': 'Von Anfang bis Ende',
  'ide.tests.kind.unit': 'Einheit',
  ...
  'ide.tests.cancelled': 'Der Lauf wurde unterbrochen.',
  'ide.tests.listError': 'Die Tests dieses Projekts konnten nicht aufgelistet werden.',
