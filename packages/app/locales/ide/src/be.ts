...
export const be: Partial<IdeTranslations> = {
  ...
  'ide.chat.voiceEngineTitle': 'Рухавік дыктоўкі',
  'ide.chat.voiceEnginePrivacy':
    'Кожны варыянт працуе на вашай прыладзе — гук ніколі не пакідае браўзер.',
  'ide.chat.voiceEngineNoDownload': 'без спампоўкі',
  'ide.chat.voiceEngineDownload': 'спампоўка ~{{mb}} МБ, потым кэшуецца',
  'ide.chat.voiceEngineDownloadRange': 'спампоўка ~{{min}}–{{max}} МБ, потым кэшуецца',
  'ide.chat.voiceAccuracyBest': 'найлепшая дакладнасць',
  'ide.chat.voiceAccuracyGood': 'добрая дакладнасць',
  'ide.chat.voiceAccuracyBasic': 'базавая дакладнасць',
  'ide.chat.voiceEngineNative': 'убудаваны ў браўзер',
  'ide.chat.voiceEngineOnDevice': 'на прыладзе',
  'ide.chat.voiceEngineNoBrowserSupport': 'недаступна ў гэтым браўзеры',
  'ide.chat.voiceEngineNoLanguageSupport': 'недаступна для вашай мовы',
  'ide.chat.voiceEngineCurrent': 'бягучы',
  'ide.chat.voiceLangsAll': 'усе мовы',
  'ide.chat.voiceLangOnly': 'толькі {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} моў',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Апрацоўваецца ў: {{region}} — націсніце, каб змяніць',
  'ide.chat.model.regionOnlyHint': 'Размяшчаецца толькі ў: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Рэгіён апрацоўкі',
  'ide.chat.models.colRegion': 'Рэгіён',
  'ide.chat.modelInUseRegion': 'Цяпер выкарыстоўваецца {{model}} ({{region}})',
  ...
  'ide.chat.share.notAllowed':
    'Для кіравання спасылкамі абагульвання патрэбна роля адміністратара ў гэтым праекце.',
  ...
  'ide.chat.fastModeOn': 'Хуткі рэжым уключаны — хутчэйшыя адказы з большай частатой',
  'ide.chat.fastModeOff': 'Хуткі рэжым выключаны',
  'ide.chat.fastModeEnable':
    'Хуткі рэжым — да 2,5 разоў хутчэйшы вывад пры больш высокай хуткасці токенаў',
  'ide.chat.fastModeDisable': 'Выключыць хуткі рэжым',
  'ide.chat.scripts.runWithOptions': 'Запусціць…',
  'ide.chat.scripts.required': '(абавязкова)',
  'ide.chat.scripts.cancelRun': 'Адмяніць',
  ...
  'ide.tests.testCount': '{{count}} тэсты',
  'ide.tests.run': 'Бегчы',
  'ide.tests.runAll': 'Выканаць усё',
  'ide.tests.runE2e': 'Запусціце e2e',
  'ide.tests.runUnit': 'Запусціць адзінку',
  'ide.tests.runGroup': 'Група бегаў',
  'ide.tests.stop': 'Спыніцца',
  'ide.tests.running': 'Бег…',
  'ide.tests.passedCount': '{{count}} прайшоў',
  'ide.tests.failedCount': '{{count}} не атрымалася',
  'ide.tests.statusPassed': 'Здадзена',
  'ide.tests.statusFailed': 'Не атрымалася',
  'ide.tests.statusSkipped': 'Прапушчана',
  'ide.tests.kind.e2e': 'Ад канца да канца',
  'ide.tests.kind.unit': 'Адзінка',
  'ide.tests.workspace.app': 'Праграма',
  'ide.tests.workspace.api': 'API',
  'ide.tests.workspace.root': 'Праект',
  'ide.tests.e2eHint':
    'Яны працуюць супраць папярэдняга прагляду ў рэжыме рэальнага часу, таму трымайце папярэдні прагляд адкрытым.',
  'ide.tests.showOutput': 'Паказаць вынік',
  'ide.tests.hideOutput': 'Схаваць вынік',
  ...
  'ide.tests.cancelled': 'Бег спынены.',
  'ide.tests.listError': 'Не атрымалася пералічыць тэсты гэтага праекта.',
