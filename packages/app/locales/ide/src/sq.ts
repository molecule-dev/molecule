...
export const sq: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'Skedari është shumë i madh. Madhësia maksimale është {{maxSize}} MB.',
  'ide.chat.modelSet': 'Modeli i bisedës është vendosur në {{name}}',
  ...
  'ide.contextMenu.deleteCount': 'Fshij {{count}} Artikuj',
  ...
  'ide.preview.retryCount': 'Përpjekje për riprovim {{count}}',
  ...
  'ide.toolCall.newFileLines': 'skedar i ri, {{count}} vija',
  ...
  'ide.toolCall.andMore': '… dhe {{count}} më shumë',
  ...
  'ide.chat.loopLimitReached': 'Arriti maksimumin e {{max}} përsëritje të mjeteve.',
  'ide.chat.maxLoopsSet': 'Iteracionet maksimale të mjetit janë vendosur në {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'saktësia më e mirë',
  'ide.chat.voiceAccuracyGood': 'saktësi e mirë',
  'ide.chat.voiceAccuracyBasic': 'saktësi bazë',
  'ide.chat.voiceEngineNative': 'i integruar në shfletues',
  'ide.chat.voiceEngineOnDevice': 'në pajisje',
  'ide.chat.voiceEngineNoBrowserSupport': 'i padisponueshëm në këtë shfletues',
  'ide.chat.voiceEngineNoLanguageSupport': 'i padisponueshëm për gjuhën tuaj',
  'ide.chat.voiceEngineCurrent': 'aktual',
  'ide.chat.voiceLangsAll': 'të gjitha gjuhët',
  'ide.chat.voiceLangOnly': 'vetëm {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} gjuhë',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Përpunohet në: {{region}} — klikoni për të ndryshuar',
  'ide.chat.model.regionOnlyHint': 'I mbajtur vetëm në: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Rajoni i përpunimit',
  'ide.chat.models.colRegion': 'Rajoni',
  'ide.chat.modelInUseRegion': 'Tani po përdoret {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} vija',
  'ide.toolCall.linesRemoved': '− {{count}} vija',
  ...
  'ide.tests.testCount': '{{count}} testet',
  'ide.tests.run': 'Vrapo',
  'ide.tests.runAll': 'Ekzekutoni të gjitha',
  'ide.tests.runE2e': 'Ekzekutoni e2e',
  'ide.tests.runUnit': 'Ekzekutoni njësinë',
  'ide.tests.runGroup': 'Grupi i vrapimit',
  'ide.tests.stop': 'Ndalo',
  'ide.tests.running': 'Duke vrapuar…',
  'ide.tests.passedCount': '{{count}} kaloi',
  'ide.tests.failedCount': '{{count}} dështoi',
  'ide.tests.statusPassed': 'Kaloi',
  'ide.tests.statusFailed': 'Dështoi',
  'ide.tests.statusSkipped': 'U anashkalua',
  'ide.tests.kind.e2e': 'Nga fillimi në fund',
  'ide.tests.kind.unit': 'Njësia',
  ...
  'ide.tests.cancelled': 'Vrapimi u ndal.',
  'ide.tests.listError': 'Nuk mund të listoheshin testet e këtij projekti.',
