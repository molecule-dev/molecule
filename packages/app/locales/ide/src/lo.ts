...
export const lo: Partial<IdeTranslations> = {
  ...
  'ide.chat.uncommittedFileCount': '{{count}} ໄຟລ໌ທີ່ບໍ່ໄດ້ຜູກມັດ',
  ...
  'ide.contextMenu.deleteCount': 'ລຶບ {{count}} ລາຍການ',
  ...
  'ide.preview.retryCount': 'ລອງໃໝ່ {{count}}',
  ...
  'ide.toolCall.newFileLines': 'ໄຟລ໌ໃໝ່, {{count}} ສາຍ',
  ...
  'ide.toolCall.andMore': '... ແລະ {{count}} ເພີ່ມເຕີມ',
  ...
  'ide.chat.loopLimitReached': 'ຮອດຈຸດສູງສຸດຂອງ {{max}} ການເຮັດຊ້ຳເຄື່ອງມືຕ່າງໆ.',
  'ide.chat.maxLoopsSet': 'ຈຳນວນເຄື່ອງມືຊ້ຳຊ້ອນສູງສຸດຖືກຕັ້ງຄ່າເປັນ {{n}}',
  ...
  'ide.chat.voiceEngineTitle': 'ເຄື່ອງຈັກຂຽນຕາມສຽງ',
  'ide.chat.voiceEnginePrivacy': 'ທຸກຕົວເລືອກເຮັດວຽກຢູ່ໃນອຸປະກອນຂອງທ່ານ — ສຽງບໍ່ເຄີຍອອກຈາກບຣາວເຊີ.',
  'ide.chat.voiceEngineNoDownload': 'ບໍ່ມີການດາວໂຫຼດ',
  'ide.chat.voiceEngineDownload': 'ດາວໂຫຼດ ~{{mb}} MB ຈາກນັ້ນເກັບໄວ້',
  'ide.chat.voiceEngineDownloadRange': 'ດາວໂຫຼດ ~{{min}}–{{max}} MB ຈາກນັ້ນເກັບໄວ້',
  'ide.chat.voiceAccuracyBest': 'ຄວາມແມ່ນຍຳສູງສຸດ',
  'ide.chat.voiceAccuracyGood': 'ຄວາມແມ່ນຍຳດີ',
  'ide.chat.voiceAccuracyBasic': 'ຄວາມແມ່ນຍຳພື້ນຖານ',
  'ide.chat.voiceEngineNative': 'ໃນຕົວບຣາວເຊີ',
  'ide.chat.voiceEngineOnDevice': 'ໃນອຸປະກອນ',
  'ide.chat.voiceEngineNoBrowserSupport': 'ບໍ່ສາມາດໃຊ້ໄດ້ໃນບຣາວເຊີນີ້',
  'ide.chat.voiceEngineNoLanguageSupport': 'ບໍ່ສາມາດໃຊ້ໄດ້ສຳລັບພາສາຂອງທ່ານ',
  'ide.chat.voiceEngineCurrent': 'ປັດຈຸບັນ',
  'ide.chat.voiceLangsAll': 'ທຸກພາສາ',
  'ide.chat.voiceLangOnly': '{{language}} ເທົ່ານັ້ນ',
  'ide.chat.voiceLangsCount': '{{count}} ພາສາ',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'ປະມວນຜົນຢູ່: {{region}} — ຄລິກເພື່ອປ່ຽນ',
  'ide.chat.model.regionOnlyHint': 'ໂຮສຢູ່ {{region}} ເທົ່ານັ້ນ',
  'ide.chat.model.regionMenuLabel': 'ພາກພື້ນປະມວນຜົນ',
  'ide.chat.models.colRegion': 'ພາກພື້ນ',
  'ide.chat.modelInUseRegion': 'ຕອນນີ້ກຳລັງໃຊ້ {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} ສາຍ',
  'ide.toolCall.linesRemoved': '− {{count}} ສາຍ',
  'ide.toolCall.changesApplied': '{{count}} ການປ່ຽນແປງທີ່ນຳໃຊ້ແລ້ວ',
  ...
  'ide.tests.testCount': '{{count}} ການທົດສອບ',
  'ide.tests.run': 'ແລ່ນ',
  'ide.tests.runAll': 'ແລ່ນທັງໝົດ',
  'ide.tests.runE2e': 'ແລ່ນ e2e',
  'ide.tests.runUnit': 'ແລ່ນໜ່ວຍ',
  'ide.tests.runGroup': 'ກຸ່ມແລ່ນ',
  'ide.tests.stop': 'ຢຸດ',
  'ide.tests.running': 'ກຳລັງແລ່ນ...',
  'ide.tests.passedCount': '{{count}} ຜ່ານໄປແລ້ວ',
  'ide.tests.failedCount': '{{count}} ລົ້ມເຫຼວ',
  'ide.tests.statusPassed': 'ຜ່ານແລ້ວ',
  'ide.tests.statusFailed': 'ລົ້ມເຫຼວ',
  'ide.tests.statusSkipped': 'ຂ້າມແລ້ວ',
  'ide.tests.kind.e2e': 'ຕັ້ງແຕ່ຕົ້ນຈົນຈົບ',
  'ide.tests.kind.unit': 'ໜ່ວຍ',
  ...
  'ide.tests.cancelled': 'ຢຸດການແລ່ນແລ້ວ.',
  'ide.tests.listError': 'ບໍ່ສາມາດລະບຸລາຍການການທົດສອບຂອງໂຄງການນີ້ໄດ້.',
