...
export const lt: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileCount': '{{count}} failai',
  ...
  'ide.chat.modelSet': 'Pokalbių modelis nustatytas į {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} nepatvirtinti failai',
  ...
  'ide.contextMenu.deleteCount': 'Ištrinti {{count}} Elementai',
  ...
  'ide.preview.retryCount': 'Bandymas dar kartą {{count}}',
  ...
  'ide.toolCall.newFileLines': 'naujas failas, {{count}} linijos',
  ...
  'ide.toolCall.andMore': '... ir {{count}} daugiau',
  ...
  'ide.toolCall.entryCount': '{{count}} įrašai',
  'ide.toolCall.matchCount': '{{count}} degtukai',
  'ide.toolCall.fileCount': '{{count}} failai',
  ...
  'ide.chat.loopLimitReached': 'Pasiekė maksimumą {{max}} įrankių iteracijos.',
  'ide.chat.maxLoopsSet': 'Maksimalus įrankių iteracijų skaičius nustatytas į {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'geriausias tikslumas',
  'ide.chat.voiceAccuracyGood': 'geras tikslumas',
  'ide.chat.voiceAccuracyBasic': 'bazinis tikslumas',
  'ide.chat.voiceEngineNative': 'naršyklės integruotas',
  'ide.chat.voiceEngineOnDevice': 'įrenginyje',
  'ide.chat.voiceEngineNoBrowserSupport': 'nepasiekiama šioje naršyklėje',
  'ide.chat.voiceEngineNoLanguageSupport': 'nepasiekiama jūsų kalbai',
  'ide.chat.voiceEngineCurrent': 'dabartinis',
  'ide.chat.voiceLangsAll': 'visos kalbos',
  'ide.chat.voiceLangOnly': 'tik {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} kalbos',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Apdorojama: {{region}} — spustelėkite, kad pakeistumėte',
  'ide.chat.model.regionOnlyHint': 'Talpinama tik: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Apdorojimo regionas',
  'ide.chat.models.colRegion': 'Regionas',
  'ide.chat.modelInUseRegion': 'Dabar naudojama {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} linijos',
  'ide.toolCall.linesRemoved': '− {{count}} linijos',
  'ide.toolCall.changesApplied': '{{count}} pritaikyti pakeitimai',
  ...
  'ide.tests.testCount': '{{count}} testai',
  'ide.tests.run': 'Paleisti',
  'ide.tests.runAll': 'Vykdyti viską',
  'ide.tests.runE2e': 'Paleisti e2e',
  'ide.tests.runUnit': 'Paleisti modulį',
  'ide.tests.runGroup': 'Bėgimo grupė',
  'ide.tests.stop': 'Sustoti',
  'ide.tests.running': 'Bėgimas…',
  'ide.tests.passedCount': '{{count}} priimtas',
  'ide.tests.failedCount': '{{count}} nepavyko',
  'ide.tests.statusPassed': 'Priimta',
  'ide.tests.statusFailed': 'Nepavyko',
  'ide.tests.statusSkipped': 'Praleista',
  'ide.tests.kind.e2e': 'Nuo pradžios iki pabaigos',
  'ide.tests.kind.unit': 'Vienetas',
  ...
  'ide.tests.cancelled': 'Vykdymas sustabdytas.',
  'ide.tests.listError': 'Nepavyko išvardyti šio projekto testų.',
