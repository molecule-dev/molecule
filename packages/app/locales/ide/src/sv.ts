...
export const sv: Partial<IdeTranslations> = {
  ...
  'ide.chat.queuedCount': '{{count}} i kö',
  ...
  'ide.chat.modelSet': 'Chattmodellen är inställd på {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} obekräftade filer',
  ...
  'ide.contextMenu.deleteCount': 'Radera {{count}} Föremål',
  ...
  'ide.preview.retryCount': 'Försök igen {{count}}',
  ...
  'ide.toolCall.andMore': '… och {{count}} mer',
  ...
  'ide.chat.maxLoopsSet': 'Max antal verktygsiterationer inställt på {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'bästa noggrannhet',
  'ide.chat.voiceAccuracyGood': 'bra noggrannhet',
  'ide.chat.voiceAccuracyBasic': 'grundläggande noggrannhet',
  'ide.chat.voiceEngineNative': 'inbyggd i webbläsaren',
  'ide.chat.voiceEngineOnDevice': 'på enheten',
  'ide.chat.voiceEngineNoBrowserSupport': 'inte tillgänglig i den här webbläsaren',
  'ide.chat.voiceEngineNoLanguageSupport': 'inte tillgänglig för ditt språk',
  'ide.chat.voiceEngineCurrent': 'nuvarande',
  'ide.chat.voiceLangsAll': 'alla språk',
  'ide.chat.voiceLangOnly': 'endast {{language}}',
  ...
  'ide.chat.model.regionOnlyHint': 'Endast värdbaserad i: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Bearbetningsregion',
  'ide.chat.models.colRegion': 'Region',
  'ide.chat.modelInUseRegion': 'Använder nu {{model}} ({{region}})',
  ...
  'ide.tests.run': 'Kör',
  'ide.tests.runAll': 'Kör alla',
  'ide.tests.runE2e': 'Kör e2e',
  'ide.tests.runUnit': 'Kör enhet',
  'ide.tests.runGroup': 'Löpgrupp',
  'ide.tests.stop': 'Stopp',
  'ide.tests.running': 'Springer…',
  'ide.tests.passedCount': '{{count}} antogs',
  'ide.tests.failedCount': '{{count}} misslyckades',
  'ide.tests.statusPassed': 'Godkänd',
  'ide.tests.statusFailed': 'Misslyckades',
  'ide.tests.statusSkipped': 'Hoppades över',
  'ide.tests.kind.e2e': 'Från början till slut',
  ...
  'ide.tests.cancelled': 'Loppet avbröts.',
  'ide.tests.listError': 'Det gick inte att visa listan över testerna för detta projekt.',
