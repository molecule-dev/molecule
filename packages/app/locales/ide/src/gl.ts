...
export const gl: Partial<IdeTranslations> = {
  ...
  'ide.chat.modelSet': 'Modelo de chat definido como {{name}}',
  ...
  'ide.chat.models.peakNow': 'punta ×{{multiplier}} agora',
  'ide.chat.models.peakLater': '×{{multiplier}} en horas punta',
  'ide.chat.models.peakHint':
    'Este modelo custa ×{{multiplier}} entre {{windows}}. O resto do día aplícase a tarifa normal.',
  ...
  'ide.chat.autoApproveEnabled':
    'Aprobación automática activada: os comandos destrutivos execútanse sen pedir confirmación. A protección contra a exfiltración segue a pedir confirmación. Desactívaa con /autoapprove.',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} ficheiros non confirmados',
  ...
  'ide.contextMenu.deleteCount': 'Eliminar {{count}} elementos',
  ...
  'ide.preview.retryCount': 'Tentativo de novo {{count}}',
  ...
  'ide.toolCall.newFileLines': 'novo ficheiro, {{count}} liñas',
  ...
  'ide.toolCall.matchCount': '{{count}} partidos',
  ...
  'ide.chat.loopLimitReached': 'Alcanzou o máximo de {{max}} iteracións da ferramenta.',
  'ide.chat.maxLoopsSet': 'Iteracións máximas da ferramenta definidas en {{n}}',
  ...
  'ide.chat.voice': 'Voz',
  'ide.chat.voiceUnavailable': 'O ditado non está dispoñible neste navegador.',
  'ide.chat.voiceMicBlocked': 'O acceso ao micrófono está bloqueado.',
  'ide.chat.voicePreparing': 'Preparando o ditado — a primeira vez pode tardar un momento.',
  'ide.chat.voiceTranscribeFailed': 'A transcrición fallou.',
  'ide.chat.voiceEngineTitle': 'Motor de ditado',
  'ide.chat.voiceEnginePrivacy':
    'Cada opción execútase no teu dispositivo — o audio nunca sae do navegador.',
  'ide.chat.voiceEngineNoDownload': 'sen descarga',
  'ide.chat.voiceEngineDownload': 'descarga de ~{{mb}} MB, logo na caché',
  'ide.chat.voiceEngineDownloadRange': 'descarga de ~{{min}}–{{max}} MB, logo na caché',
  'ide.chat.voiceAccuracyBest': 'máxima precisión',
  'ide.chat.voiceAccuracyGood': 'boa precisión',
  ...
  'ide.chat.voiceEngineNoBrowserSupport': 'non dispoñible neste navegador',
  'ide.chat.voiceEngineNoLanguageSupport': 'non dispoñible para o teu idioma',
  'ide.chat.voiceEngineCurrent': 'actual',
  'ide.chat.voiceLangsAll': 'todos os idiomas',
  'ide.chat.voiceLangOnly': 'só {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} idiomas',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Procésase en: {{region}} — preme para cambiar',
  'ide.chat.model.regionOnlyHint': 'Só aloxado en: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Rexión de procesamento',
  'ide.chat.models.colRegion': 'Rexión',
  'ide.chat.modelInUseRegion': 'Agora úsase {{model}} ({{region}})',
  ...
  'ide.chat.share.notAllowed':
    'Xestionar as ligazóns para compartir require un rol de administrador neste proxecto.',
  ...
  'ide.tests.testCount': '{{count}} probas',
  'ide.tests.run': 'Correr',
  'ide.tests.runAll': 'Executar todo',
  'ide.tests.runE2e': 'Executar e2e',
  'ide.tests.runUnit': 'Unidade de execución',
  'ide.tests.runGroup': 'Grupo de execución',
  'ide.tests.stop': 'Parar',
  'ide.tests.running': 'Correndo…',
  'ide.tests.passedCount': '{{count}} pasado',
  'ide.tests.failedCount': '{{count}} fallou',
  'ide.tests.statusPassed': 'Aprobado',
  'ide.tests.statusFailed': 'Fallou',
  ...
  'ide.tests.workspace.root': 'Proxecto',
  'ide.tests.e2eHint':
    'Estes execútanse coa vista previa en directo, polo que debes manter a vista previa aberta.',
  'ide.tests.showOutput': 'Mostrar saída',
  ...
  'ide.tests.cancelled': 'A carreira parou.',
  'ide.tests.listError': 'Non se puideron listar as probas deste proxecto.',
