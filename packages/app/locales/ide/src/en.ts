...
export const en: IdeTranslations = {
  ...
  // Streaming indicator — molecule-themed rotating status while the AI responds (the
  // agent Synthase is named after ATP synthase; the phrases read as a reaction).
  ...
  'ide.chat.skipToolCall': 'Skip',
  'ide.chat.skippingToolCall': 'Skipping…',
  'ide.chat.skipToolCallViewer': 'Only editors can skip this.',
  ...
  'ide.toolCall.statusSkipped': 'Skipped',
  ...
  // Reset the per-project default-skill set back to "all loaded by default" (unset).
  ...
  // Tests bar — the project's own tests, listed and run from the chat composer.
  // The end-to-end specs drive the LIVE PREVIEW through the app-e2e-preview bond.
  'ide.tests.testCount': '{{count}} tests',
  'ide.tests.run': 'Run',
  'ide.tests.runAll': 'Run all',
  'ide.tests.runE2e': 'Run e2e',
  'ide.tests.runUnit': 'Run unit',
  'ide.tests.runGroup': 'Run group',
  'ide.tests.stop': 'Stop',
  'ide.tests.skip': 'Skip',
  'ide.tests.skipping': 'Skipping…',
  'ide.tests.skippedCount': '{{count}} skipped',
  'ide.tests.skippedByUser': 'Run finished. The tests you skipped did not run.',
  'ide.tests.viewerCannotSkip': 'Only editors can skip this project’s tests.',
  'ide.tests.running': 'Running…',
  'ide.tests.passedCount': '{{count}} passed',
  'ide.tests.failedCount': '{{count}} failed',
  'ide.tests.statusPassed': 'Passed',
  'ide.tests.statusFailed': 'Failed',
  'ide.tests.statusSkipped': 'Skipped',
  ...
  'ide.tests.e2eHint': 'These run against the live preview, so keep the preview open.',
  'ide.tests.showOutput': 'Show output',
  'ide.tests.hideOutput': 'Hide output',
  ...
  'ide.tests.cancelled': 'Run stopped.',
  'ide.tests.listError': 'Could not list this project’s tests.',
