...
export const fil: Partial<IdeTranslations> = {
  ...
  'ide.chat.queuedCount': '{{count}} nakapila',
  ...
  'ide.chat.modelSet': 'Nakatakda ang modelo ng chat sa {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} mga hindi naka-commit na file',
  ...
  'ide.contextMenu.deleteCount': 'Burahin {{count}} Mga Aytem',
  ...
  'ide.preview.retryCount': 'Subukan muli {{count}}',
  ...
  'ide.toolCall.entryCount': '{{count}} mga entry',
  'ide.toolCall.matchCount': '{{count}} mga tugma',
  ...
  'ide.chat.loopLimitReached': 'Naabot ang pinakamataas na {{max}} mga pag-ulit ng kagamitan.',
  'ide.chat.maxLoopsSet': 'Nakatakda ang maximum na mga iterasyon ng tool sa {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'pinakamahusay na katumpakan',
  'ide.chat.voiceAccuracyGood': 'magandang katumpakan',
  'ide.chat.voiceAccuracyBasic': 'pangunahing katumpakan',
  'ide.chat.voiceEngineNative': 'katutubo sa browser',
  'ide.chat.voiceEngineOnDevice': 'sa device',
  'ide.chat.voiceEngineNoBrowserSupport': 'hindi available sa browser na ito',
  'ide.chat.voiceEngineNoLanguageSupport': 'hindi available para sa iyong wika',
  'ide.chat.voiceEngineCurrent': 'kasalukuyan',
  'ide.chat.voiceLangsAll': 'lahat ng wika',
  'ide.chat.voiceLangOnly': '{{language}} lamang',
  'ide.chat.voiceLangsCount': '{{count}} wika',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Pinoproseso sa: {{region}} — i-click para baguhin',
  'ide.chat.model.regionOnlyHint': 'Naka-host lamang sa: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Rehiyon ng pagproseso',
  'ide.chat.models.colRegion': 'Rehiyon',
  'ide.chat.modelInUseRegion': 'Ginagamit na ngayon ang {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} mga linya',
  'ide.toolCall.linesRemoved': '− {{count}} mga linya',
  'ide.toolCall.changesApplied': '{{count}} mga pagbabagong inilapat',
  'ide.tabs.close': 'Isara {{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} mga pagsusulit',
  'ide.tests.run': 'Tumakbo',
  'ide.tests.runAll': 'Patakbuhin lahat',
  'ide.tests.runE2e': 'Patakbuhin ang e2e',
  'ide.tests.runUnit': 'Yunit ng pagpapatakbo',
  'ide.tests.runGroup': 'Grupo ng pagtakbo',
  'ide.tests.stop': 'Huminto',
  'ide.tests.running': 'Tumatakbo…',
  'ide.tests.passedCount': '{{count}} nakapasa',
  'ide.tests.failedCount': '{{count}} nabigo',
  'ide.tests.statusPassed': 'Nakapasa',
  'ide.tests.statusFailed': 'Nabigo',
  'ide.tests.statusSkipped': 'Nilaktawan',
  'ide.tests.kind.e2e': 'Dulo-hanggang-dulo',
  'ide.tests.kind.unit': 'Yunit',
