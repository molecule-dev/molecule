...
export const sl: Partial<IdeTranslations> = {
  ...
  'ide.chat.modelSet': 'Model klepeta je nastavljen na {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} nepotrjene datoteke',
  ...
  'ide.contextMenu.deleteCount': 'Izbriši {{count}} Predmeti',
  ...
  'ide.preview.retryCount': 'Ponovni poskus {{count}}',
  ...
  'ide.toolCall.newFileLines': 'nova datoteka, {{count}} črte',
  ...
  'ide.toolCall.andMore': '... in {{count}} več',
  ...
  'ide.toolCall.entryCount': '{{count}} vnosi',
  'ide.toolCall.matchCount': '{{count}} tekme',
  ...
  'ide.chat.loopLimitReached': 'Dosegel maksimum {{max}} iteracije orodja.',
  'ide.chat.maxLoopsSet': 'Največje število iteracij orodja je nastavljeno na {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'najboljša natančnost',
  'ide.chat.voiceAccuracyGood': 'dobra natančnost',
  'ide.chat.voiceAccuracyBasic': 'osnovna natančnost',
  'ide.chat.voiceEngineNative': 'vgrajeno v brskalnik',
  'ide.chat.voiceEngineOnDevice': 'na napravi',
  'ide.chat.voiceEngineNoBrowserSupport': 'ni na voljo v tem brskalniku',
  'ide.chat.voiceEngineNoLanguageSupport': 'ni na voljo za vaš jezik',
  'ide.chat.voiceEngineCurrent': 'trenutno',
  'ide.chat.voiceLangsAll': 'vsi jeziki',
  'ide.chat.voiceLangOnly': 'samo {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} jezikov',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Obdelava v: {{region}} — kliknite za spremembo',
  'ide.chat.model.regionOnlyHint': 'Gostovano samo v: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Regija obdelave',
  'ide.chat.models.colRegion': 'Regija',
  'ide.chat.modelInUseRegion': 'Zdaj se uporablja {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} črte',
  'ide.toolCall.linesRemoved': '− {{count}} črte',
  'ide.toolCall.changesApplied': '{{count}} uporabljene spremembe',
  ...
  'ide.chat.streaming.thinking': 'Razmišljam...',
  'ide.chat.streaming.analyzing': 'Analiziranje...',
  'ide.chat.streaming.reasoning': 'Razlogi...',
  'ide.chat.streaming.crafting': 'Pripravljam odgovor...',
  'ide.chat.streaming.working': 'Delam na tem...',
  'ide.chat.streaming.processing': 'Obdelava...',
  'ide.chat.streaming.connecting': 'Če povežemo vse točke...',
  'ide.chat.streaming.almostThere': 'Skoraj smo tam...',
  'ide.chat.help.card.heading': 'Pomoč',
  'ide.chat.help.card.commandsTitle': 'Ukazi',
  'ide.chat.help.card.modesTitle': 'Načini',
  ...
  'ide.tests.run': 'Teči',
  'ide.tests.runAll': 'Zaženi vse',
  'ide.tests.runE2e': 'Zaženi e2e',
  'ide.tests.runUnit': 'Zagon enote',
  'ide.tests.runGroup': 'Tekmovalna skupina',
  'ide.tests.stop': 'Stop',
  'ide.tests.running': 'Tek…',
  'ide.tests.passedCount': '{{count}} sprejet',
  'ide.tests.failedCount': '{{count}} ni uspelo',
  'ide.tests.statusPassed': 'Sprejeto',
  'ide.tests.statusFailed': 'Ni uspelo',
  'ide.tests.statusSkipped': 'Preskočeno',
  'ide.tests.kind.e2e': 'Od začetka do konca',
  'ide.tests.kind.unit': 'Enota',
  'ide.tests.workspace.app': 'Aplikacija',
  'ide.tests.workspace.api': 'API',
  'ide.tests.workspace.root': 'Projekt',
  'ide.tests.e2eHint': 'Te se izvajajo v ozadju predogleda v živo, zato predogled pustite odprt.',
  'ide.tests.showOutput': 'Prikaži izhod',
  'ide.tests.hideOutput': 'Skrij izhod',
  ...
  'ide.tests.cancelled': 'Tek je bil prekinjen.',
  'ide.tests.listError': 'Testi tega projekta niso bili prikazani.',
