...
export const af: Partial<IdeTranslations> = {
  ...
  'ide.chat.uncommittedFileCount': '{{count}} ongebonde lêers',
  ...
  'ide.contextMenu.deleteCount': 'Vee uit {{count}} Items',
  ...
  'ide.preview.retryCount': 'Herprobeer {{count}}',
  ...
  'ide.toolCall.newFileLines': 'nuwe lêer, {{count}} lyne',
  ...
  'ide.toolCall.matchCount': '{{count}} wedstryde',
  ...
  'ide.chat.loopLimitReached': 'Het die maksimum van bereik {{max}} gereedskap iterasies.',
  'ide.chat.maxLoopsSet': 'Maksimum gereedskap iterasies gestel op {{n}}',
  ...
  'ide.chat.voiceEngineTitle': 'Dikteer-enjin',
  'ide.chat.voiceEnginePrivacy':
    'Elke opsie loop op jou toestel — klank verlaat nooit jou blaaier nie.',
  'ide.chat.voiceEngineNoDownload': 'geen aflaai',
  'ide.chat.voiceEngineDownload': '~{{mb}} MB aflaai, daarna gekas',
  'ide.chat.voiceEngineDownloadRange': '~{{min}}–{{max}} MB aflaai, daarna gekas',
  'ide.chat.voiceAccuracyBest': 'beste akkuraatheid',
  'ide.chat.voiceAccuracyGood': 'goeie akkuraatheid',
  'ide.chat.voiceAccuracyBasic': 'basiese akkuraatheid',
  'ide.chat.voiceEngineNative': 'blaaier-eie',
  'ide.chat.voiceEngineOnDevice': 'op die toestel',
  'ide.chat.voiceEngineNoBrowserSupport': 'nie in hierdie blaaier beskikbaar nie',
  'ide.chat.voiceEngineNoLanguageSupport': 'nie vir jou taal beskikbaar nie',
  'ide.chat.voiceEngineCurrent': 'huidig',
  'ide.chat.voiceLangsAll': 'alle tale',
  'ide.chat.voiceLangOnly': 'slegs {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} tale',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Verwerk in: {{region}} — klik om te verander',
  'ide.chat.model.regionOnlyHint': 'Slegs gehuisves in: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Verwerkingstreek',
  'ide.chat.models.colRegion': 'Streek',
  'ide.chat.modelInUseRegion': 'Gebruik nou {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} lyne',
  'ide.toolCall.linesRemoved': '− {{count}} lyne',
  'ide.toolCall.changesApplied': '{{count}} veranderinge toegepas',
  'ide.toolCall.applied': 'Toegepas',
  'ide.tabs.close': 'Maak toe {{fileName}}',
  ...
  'ide.chat.share.notAllowed': 'Die bestuur van deelskakels vereis ’n admin-rol op hierdie projek.',
  ...
  'ide.tests.testCount': '{{count}} toetse',
  'ide.tests.run': 'Hardloop',
  'ide.tests.runAll': 'Begin alles',
  'ide.tests.runE2e': 'Hardloop e2e',
  'ide.tests.runUnit': 'Begin eenheid',
  'ide.tests.runGroup': 'hardloopgroep',
  'ide.tests.stop': 'Stop',
  'ide.tests.running': 'Hardloop…',
  'ide.tests.passedCount': '{{count}} geslaag',
  'ide.tests.failedCount': '{{count}} misluk',
  'ide.tests.statusPassed': 'Geslaag',
  'ide.tests.statusFailed': 'Misluk',
  'ide.tests.statusSkipped': 'Oorgeslaan',
  'ide.tests.kind.e2e': 'Van begin tot einde',
  'ide.tests.kind.unit': 'Eenheid',
  'ide.tests.workspace.app': 'Toepassing',
  'ide.tests.workspace.api': 'API',
  'ide.tests.workspace.root': 'Projek',
  'ide.tests.e2eHint': 'Hierdie loop teen die regstreekse voorskou, so hou die voorskou oop.',
  'ide.tests.showOutput': 'Wys uitvoer',
  'ide.tests.hideOutput': 'Versteek uitvoer',
  ...
  'ide.tests.cancelled': 'Loop gestop.',
  'ide.tests.listError': 'Kon nie hierdie projek se toetse lys nie.',
