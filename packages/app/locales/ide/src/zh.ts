...
export const zh: Partial<IdeTranslations> = {
  ...
  'ide.contextMenu.deleteCount': '删除{{count}}项目',
  ...
  'ide.preview.retryCount': '重试{{count}}',
  ...
  'ide.toolCall.newFileLines': '新文件， {{count}}线条',
  ...
  'ide.chat.loopLimitReached': '达到最大值{{max}}工具迭代。',
  ...
  'ide.chat.voiceEngineTitle': '语音输入引擎',
  'ide.chat.voiceEnginePrivacy': '每个选项都在您的设备上运行 — 音频绝不会离开浏览器。',
  'ide.chat.voiceEngineNoDownload': '无需下载',
  'ide.chat.voiceEngineDownload': '下载约 {{mb}} MB，之后缓存',
  'ide.chat.voiceEngineDownloadRange': '下载约 {{min}}–{{max}} MB，之后缓存',
  'ide.chat.voiceAccuracyBest': '最佳准确度',
  'ide.chat.voiceAccuracyGood': '良好准确度',
  'ide.chat.voiceAccuracyBasic': '基本准确度',
  'ide.chat.voiceEngineNative': '浏览器内置',
  'ide.chat.voiceEngineOnDevice': '设备端',
  'ide.chat.voiceEngineNoBrowserSupport': '此浏览器不可用',
  'ide.chat.voiceEngineNoLanguageSupport': '不支持您的语言',
  'ide.chat.voiceEngineCurrent': '当前',
  'ide.chat.voiceLangsAll': '所有语言',
  'ide.chat.voiceLangOnly': '仅{{language}}',
  'ide.chat.voiceLangsCount': '{{count}} 种语言',
  'ide.chat.model.region.us': '美国',
  'ide.chat.model.region.cn': '中国',
  'ide.chat.model.regionHint': '处理位置：{{region}} — 点击更改',
  'ide.chat.model.regionOnlyHint': '仅托管于：{{region}}',
  'ide.chat.model.regionMenuLabel': '处理区域',
  'ide.chat.models.colRegion': '区域',
  'ide.chat.modelInUseRegion': '现在使用 {{model}}（{{region}}）',
  ...
  'ide.toolCall.linesAdded': '+ {{count}}线条',
  'ide.toolCall.linesRemoved': '− {{count}}线条',
  'ide.toolCall.changesApplied': '{{count}}应用的变更',
  ...
  'ide.chat.streaming.analyzing': '正在分析...',
  'ide.chat.streaming.reasoning': '推理……',
  'ide.chat.streaming.crafting': '正在撰写回复...',
  'ide.chat.streaming.working': '正在处理中……',
  'ide.chat.streaming.processing': '正在处理...',
  'ide.chat.streaming.connecting': '串联起这些线索……',
  'ide.chat.streaming.almostThere': '快到了……',
  'ide.chat.help.card.heading': '帮助',
  'ide.chat.help.card.commandsTitle': '命令',
  'ide.chat.help.card.modesTitle': '模式',
  'ide.chat.help.card.tipsTitle': '提示',
  'ide.chat.help.card.usageHint': 'Usage: {{usage}}  ([…] optional, <…> required)',
  'ide.chat.report.failed': '无法提交您的报告。请重试。',
  ...
  'ide.tests.testCount': '{{count}} 测试',
  'ide.tests.run': '运行',
  'ide.tests.runAll': '全部运行',
  'ide.tests.runE2e': '运行 e2e',
  'ide.tests.runUnit': '运行单元',
  'ide.tests.runGroup': '跑步小组',
  'ide.tests.stop': '停止',
  'ide.tests.running': '正在运行……',
  'ide.tests.passedCount': '{{count}} 通过了',
  'ide.tests.failedCount': '{{count}} 失败',
  'ide.tests.statusPassed': '通过',
  'ide.tests.statusFailed': '失败',
  'ide.tests.statusSkipped': '已跳过',
  'ide.tests.kind.e2e': '端到端',
  'ide.tests.kind.unit': '单位',
  'ide.tests.workspace.app': 'App',
  'ide.tests.workspace.api': 'API',
  'ide.tests.workspace.root': '项目',
  'ide.tests.e2eHint': '这些操作会影响实时预览，因此请保持预览窗口打开。',
  'ide.tests.showOutput': '显示输出',
  'ide.tests.hideOutput': '隐藏输出',
  ...
  'ide.tests.cancelled': '运行已停止。',
  'ide.tests.listError': '无法列出该项目的测试。',
