...
export const ka: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'ფაილი ძალიან დიდია. მაქსიმალური ზომაა {{maxSize}} მბ.',
  'ide.chat.modelSet': 'ჩატის მოდელი დაყენებულია {{name}}',
  ...
  'ide.contextMenu.deleteCount': 'წაშლა {{count}} ნივთები',
  ...
  'ide.preview.retryCount': 'ხელახლა ცდა {{count}}',
  ...
  'ide.toolCall.newFileLines': 'ახალი ფაილი, {{count}} ხაზები',
  ...
  'ide.toolCall.andMore': '… და {{count}} მეტი',
  ...
  'ide.chat.loopLimitReached': 'მაქსიმუმს მიაღწია, {{max}} ინსტრუმენტის იტერაციები.',
  'ide.chat.maxLoopsSet': 'ხელსაწყოს მაქსიმალური იტერაციები დაყენებულია {{n}}',
  ...
  'ide.chat.voiceEngineTitle': 'კარნახის ძრავა',
  'ide.chat.voiceEnginePrivacy':
    'ყველა ვარიანტი მუშაობს თქვენს მოწყობილობაზე — ხმა არასოდეს ტოვებს ბრაუზერს.',
  'ide.chat.voiceEngineNoDownload': 'ჩამოტვირთვის გარეშე',
  'ide.chat.voiceEngineDownload': '~{{mb}} MB ჩამოტვირთვა, შემდეგ ქეშირდება',
  'ide.chat.voiceEngineDownloadRange': '~{{min}}–{{max}} MB ჩამოტვირთვა, შემდეგ ქეშირდება',
  'ide.chat.voiceAccuracyBest': 'საუკეთესო სიზუსტე',
  'ide.chat.voiceAccuracyGood': 'კარგი სიზუსტე',
  'ide.chat.voiceAccuracyBasic': 'ბაზისური სიზუსტე',
  'ide.chat.voiceEngineNative': 'ბრაუზერის ჩაშენებული',
  'ide.chat.voiceEngineOnDevice': 'მოწყობილობაზე',
  'ide.chat.voiceEngineNoBrowserSupport': 'მიუწვდომელია ამ ბრაუზერში',
  'ide.chat.voiceEngineNoLanguageSupport': 'მიუწვდომელია თქვენი ენისთვის',
  'ide.chat.voiceEngineCurrent': 'მიმდინარე',
  'ide.chat.voiceLangsAll': 'ყველა ენა',
  'ide.chat.voiceLangOnly': 'მხოლოდ {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} ენა',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'მუშავდება: {{region}} — შესაცვლელად დააწკაპუნეთ',
  'ide.chat.model.regionOnlyHint': 'განთავსებულია მხოლოდ: {{region}}',
  'ide.chat.model.regionMenuLabel': 'დამუშავების რეგიონი',
  'ide.chat.models.colRegion': 'რეგიონი',
  'ide.chat.modelInUseRegion': 'ახლა გამოიყენება {{model}} ({{region}})',
  ...
  'ide.activity.type.push': 'დააჭირეთ',
  'ide.activity.type.webhook': 'ვებჰუკები',
  'ide.activity.type.channel': 'არხი',
  'ide.activity.status.captured': 'დატყვევებული',
  'ide.activity.status.sent': 'გაგზავნილია',
  'ide.activity.status.delivered': 'მიწოდებული',
  'ide.activity.status.failed': 'ვერ მოხერხდა',
  ...
  'ide.chat.share.notAllowed':
    'გაზიარების ბმულების მართვას ამ პროექტში ადმინისტრატორის როლი სჭირდება.',
  ...
  'ide.tests.testCount': '{{count}} ტესტები',
  'ide.tests.run': 'სირბილი',
  'ide.tests.runAll': 'გაუშვით ყველა',
  'ide.tests.runE2e': 'გაუშვით e2e',
  'ide.tests.runUnit': 'გაუშვით ერთეული',
  'ide.tests.runGroup': 'გაშვების ჯგუფი',
  'ide.tests.stop': 'გაჩერება',
  'ide.tests.running': 'სირბილი…',
  'ide.tests.passedCount': '{{count}} გავიდა',
  'ide.tests.failedCount': '{{count}} წარუმატებელი',
  'ide.tests.statusPassed': 'გავიდა',
  'ide.tests.statusFailed': 'ვერ მოხერხდა',
  'ide.tests.statusSkipped': 'გამოტოვებულია',
  'ide.tests.kind.e2e': 'ბოლომდე',
  'ide.tests.kind.unit': 'ერთეული',
  'ide.tests.workspace.app': 'აპლიკაცია',
  'ide.tests.workspace.api': 'API',
  'ide.tests.workspace.root': 'პროექტი',
  'ide.tests.e2eHint':
    'ესენი პირდაპირ ეთერში გადახედვის საწინააღმდეგოდ მუშაობს, ამიტომ გადახედვა გახსნილი გქონდეთ.',
  'ide.tests.showOutput': 'გამომავალი მონაცემების ჩვენება',
  'ide.tests.hideOutput': 'გამომავალის დამალვა',
  ...
  'ide.tests.cancelled': 'სირბილი შეწყდა.',
  'ide.tests.listError': 'ამ პროექტის ტესტების ჩამოთვლა ვერ მოხერხდა.',
