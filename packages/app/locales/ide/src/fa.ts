...
export const fa: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileCount': '{{count}} فایل‌ها',
  'common.cancel': 'لغو',
  'common.save': 'ذخیره',
  ...
  'ide.chat.fileTooLarge': 'فایل خیلی بزرگ است. حداکثر اندازه ... است. {{maxSize}} مگابایت',
  'ide.chat.modelSet': 'مدل چت روی تنظیم شده است {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} فایل‌های کامیت نشده',
  ...
  'ide.contextMenu.deleteCount': 'حذف {{count}} اقلام',
  ...
  'ide.preview.retryCount': 'تلاش مجدد {{count}}',
  ...
  'ide.toolCall.newFileLines': 'فایل جدید، {{count}} خطوط',
  ...
  'ide.toolCall.andMore': '… و {{count}} بیشتر',
  ...
  'ide.toolCall.entryCount': '{{count}} نوشته‌ها',
  'ide.toolCall.matchCount': '{{count}} مسابقات',
  'ide.toolCall.fileCount': '{{count}} فایل‌ها',
  ...
  'ide.chat.loopLimitReached': 'به حداکثر مقدار رسید {{max}} تکرار ابزار.',
  'ide.chat.maxLoopsSet': 'حداکثر تکرار ابزار روی تنظیم شده است {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'بهترین دقت',
  'ide.chat.voiceAccuracyGood': 'دقت خوب',
  'ide.chat.voiceAccuracyBasic': 'دقت پایه',
  'ide.chat.voiceEngineNative': 'داخلی مرورگر',
  'ide.chat.voiceEngineOnDevice': 'روی دستگاه',
  'ide.chat.voiceEngineNoBrowserSupport': 'در این مرورگر در دسترس نیست',
  'ide.chat.voiceEngineNoLanguageSupport': 'برای زبان شما در دسترس نیست',
  'ide.chat.voiceEngineCurrent': 'فعلی',
  'ide.chat.voiceLangsAll': 'همه زبان‌ها',
  'ide.chat.voiceLangOnly': 'فقط {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} زبان',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'پردازش در: {{region}} — برای تغییر کلیک کنید',
  'ide.chat.model.regionOnlyHint': 'فقط میزبانی‌شده در: {{region}}',
  'ide.chat.model.regionMenuLabel': 'منطقه پردازش',
  'ide.chat.models.colRegion': 'منطقه',
  'ide.chat.modelInUseRegion': 'اکنون از {{model}} ({{region}}) استفاده می‌شود',
  ...
  'ide.toolCall.changesApplied': '{{count}} تغییرات اعمال شده',
  ...
  'ide.chat.fastModeOn': 'حالت سریع روشن - پاسخ‌های سریع‌تر با نرخ بالاتر',
  ...
  'ide.tests.testCount': '{{count}} آزمایش‌ها',
  'ide.tests.run': 'اجرا کنید',
  'ide.tests.runAll': 'همه را اجرا کنید',
  'ide.tests.runE2e': 'اجرای e2e',
  'ide.tests.runUnit': 'واحد اجرا',
  'ide.tests.runGroup': 'گروه اجرا',
  'ide.tests.stop': 'توقف',
  'ide.tests.running': 'دویدن…',
  'ide.tests.passedCount': '{{count}} گذشت',
  'ide.tests.failedCount': '{{count}} شکست خورده',
  'ide.tests.statusPassed': 'تصویب شد',
  'ide.tests.statusFailed': 'شکست خورده',
  'ide.tests.statusSkipped': 'رد شد',
  'ide.tests.kind.e2e': 'انتها به انتها',
  'ide.tests.kind.unit': 'واحد',
  ...
  'ide.tests.cancelled': 'دویدن متوقف شد.',
  'ide.tests.listError': 'نتوانستم آزمایش‌های این پروژه را فهرست کنم.',
