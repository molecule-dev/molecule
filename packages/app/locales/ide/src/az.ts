...
export const az: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'Fayl çox böyükdür. Maksimum ölçü {{maxSize}} MB.',
  'ide.chat.modelSet': 'Çat modeli ayarlandı {{name}}',
  ...
  'ide.contextMenu.deleteCount': 'Sil {{count}} Əşyalar',
  ...
  'ide.preview.retryCount': 'Təkrar cəhd edin {{count}}',
  ...
  'ide.toolCall.newFileLines': 'yeni fayl, {{count}} xətlər',
  ...
  'ide.chat.loopLimitReached': 'Maksimum həddə çatdı {{max}} alət təkrarlamaları.',
  'ide.chat.maxLoopsSet': 'Maksimum alət təkrarlamaları təyin edildi {{n}}',
  ...
  'ide.chat.voiceEngineTitle': 'Diktə mühərriki',
  'ide.chat.voiceEnginePrivacy':
    'Hər seçim cihazınızda işləyir — səs heç vaxt brauzerinizi tərk etmir.',
  'ide.chat.voiceEngineNoDownload': 'yükləmə yoxdur',
  'ide.chat.voiceEngineDownload': '~{{mb}} MB yükləmə, sonra keşlənir',
  'ide.chat.voiceEngineDownloadRange': '~{{min}}–{{max}} MB yükləmə, sonra keşlənir',
  'ide.chat.voiceAccuracyBest': 'ən yaxşı dəqiqlik',
  'ide.chat.voiceAccuracyGood': 'yaxşı dəqiqlik',
  'ide.chat.voiceAccuracyBasic': 'əsas dəqiqlik',
  'ide.chat.voiceEngineNative': 'brauzer daxili',
  'ide.chat.voiceEngineOnDevice': 'cihazda',
  'ide.chat.voiceEngineNoBrowserSupport': 'bu brauzerdə mövcud deyil',
  'ide.chat.voiceEngineNoLanguageSupport': 'diliniz üçün mövcud deyil',
  'ide.chat.voiceEngineCurrent': 'cari',
  'ide.chat.voiceLangsAll': 'bütün dillər',
  'ide.chat.voiceLangOnly': 'yalnız {{language}}',
  ...
  'ide.chat.model.regionOnlyHint': 'Yalnız burada yerləşdirilib: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Emal regionu',
  'ide.chat.models.colRegion': 'Region',
  'ide.chat.modelInUseRegion': 'İndi {{model}} ({{region}}) istifadə olunur',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} xətlər',
  'ide.toolCall.linesRemoved': '− {{count}} xətlər',
  'ide.toolCall.changesApplied': '{{count}} dəyişikliklər tətbiq edildi',
  'ide.toolCall.applied': 'Tətbiq edildi',
  'ide.tabs.close': 'Bağla {{fileName}}',
  ...
  'ide.chat.share.notAllowed':
    'Paylaşma keçidlərini idarə etmək üçün bu layihədə admin rolu tələb olunur.',
  ...
  'ide.chat.scripts.runWithOptions': 'İşə sal…',
  'ide.chat.scripts.required': '(tələb olunur)',
  ...
  'ide.tests.testCount': '{{count}} testlər',
  'ide.tests.run': 'Qaç',
  'ide.tests.runAll': 'Hamısını işə salın',
  'ide.tests.runE2e': 'e2e-ni işə salın',
  'ide.tests.runUnit': 'Vahidi işlədin',
  'ide.tests.runGroup': 'Qrupu işə salın',
  'ide.tests.stop': 'Dayan',
  'ide.tests.running': 'Qaçış…',
  'ide.tests.passedCount': '{{count}} keçdi',
  'ide.tests.failedCount': '{{count}} uğursuz',
  'ide.tests.statusPassed': 'Keçdi',
  'ide.tests.statusFailed': 'Uğursuz oldu',
  'ide.tests.statusSkipped': 'Atlandı',
  'ide.tests.kind.e2e': 'Başdan-ayağa',
  'ide.tests.kind.unit': 'Vahid',
  'ide.tests.workspace.app': 'Tətbiq',
  'ide.tests.workspace.api': 'API',
  'ide.tests.workspace.root': 'Layihə',
  'ide.tests.e2eHint':
    'Bunlar canlı önizləmə ilə ziddiyyət təşkil edir, ona görə də önizləməni açıq saxlayın.',
  'ide.tests.showOutput': 'Çıxışı göstər',
  'ide.tests.hideOutput': 'Çıxışı gizlət',
  ...
  'ide.tests.cancelled': 'Qaçış dayandı.',
  'ide.tests.listError': 'Bu layihənin testlərini sadalamaq mümkün deyil.',
