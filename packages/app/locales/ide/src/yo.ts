...
export const yo: Partial<IdeTranslations> = {
  ...
  'ide.chat.voiceAccuracyBest': 'ìpéye tó dára jù',
  'ide.chat.voiceAccuracyGood': 'ìpéye dáadáa',
  'ide.chat.voiceAccuracyBasic': 'ìpéye ìpìlẹ̀',
  'ide.chat.voiceEngineNative': 'ti aṣàwákiri fúnra rẹ̀',
  'ide.chat.voiceEngineOnDevice': 'lórí ẹ̀rọ',
  'ide.chat.voiceEngineNoBrowserSupport': 'kò sí lórí aṣàwákiri yìí',
  'ide.chat.voiceEngineNoLanguageSupport': 'kò sí fún èdè rẹ',
  'ide.chat.voiceEngineCurrent': 'lọ́wọ́lọ́wọ́',
  'ide.chat.voiceLangsAll': 'gbogbo èdè',
  'ide.chat.voiceLangOnly': '{{language}} nìkan',
  'ide.chat.voiceLangsCount': 'èdè {{count}}',
  ...
  'ide.tests.testCount': '{{count}} awọn idanwo',
  'ide.tests.run': 'Sáré',
  'ide.tests.runAll': 'Sá gbogbo rẹ̀',
  'ide.tests.runE2e': 'Sáré e2e',
  'ide.tests.runUnit': 'Iṣẹ́ ẹ̀rọ',
  'ide.tests.runGroup': 'Ṣíṣẹ́ ẹgbẹ́',
  'ide.tests.stop': 'Duro',
  'ide.tests.running': 'Nṣiṣẹ…',
  'ide.tests.passedCount': '{{count}} kọjá',
  'ide.tests.failedCount': '{{count}} kùnà',
  'ide.tests.statusPassed': 'Ti kọja',
  'ide.tests.statusFailed': 'Kò ti kùnà',
  'ide.tests.statusSkipped': 'A fò ó',
  'ide.tests.kind.e2e': 'Opin-de-opin',
  'ide.tests.kind.unit': 'Ẹyọ kan',
  ...
  'ide.tests.cancelled': 'Sáré dúró.',
  'ide.tests.listError': 'A ko le ṣe atokọ awọn idanwo iṣẹ akanṣe yii.',
