...
export const ig: Partial<IdeTranslations> = {
  ...
  'ide.chat.voiceEngineTitle': 'Injin ide okwu',
  'ide.chat.voiceEnginePrivacy':
    'Nhọrọ ọ bụla na-arụ ọrụ na ngwaọrụ gị — ụda anaghị ahapụ nchọgharị gị.',
  'ide.chat.voiceEngineNoDownload': 'enweghị nbudata',
  'ide.chat.voiceEngineDownload': 'nbudata ~{{mb}} MB, mgbe ahụ echekwaa ya',
  'ide.chat.voiceEngineDownloadRange': 'nbudata ~{{min}}–{{max}} MB, mgbe ahụ echekwaa ya',
  'ide.chat.voiceAccuracyBest': 'izi ezi kacha mma',
  'ide.chat.voiceAccuracyGood': 'izi ezi dị mma',
  'ide.chat.voiceAccuracyBasic': 'izi ezi bụ isi',
  'ide.chat.voiceEngineNative': 'nke nchọgharị',
  'ide.chat.voiceEngineOnDevice': 'na ngwaọrụ',
  'ide.chat.voiceEngineNoBrowserSupport': 'adịghị na nchọgharị a',
  'ide.chat.voiceEngineNoLanguageSupport': 'adịghị maka asụsụ gị',
  'ide.chat.voiceEngineCurrent': 'nke ugbu a',
  'ide.chat.voiceLangsAll': 'asụsụ niile',
  'ide.chat.voiceLangOnly': 'naanị {{language}}',
  'ide.chat.voiceLangsCount': 'asụsụ {{count}}',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'A na-edozi ya na: {{region}} — pịa iji gbanwee',
  'ide.chat.model.regionOnlyHint': 'Naanị na {{region}} ka e debere ya',
  'ide.chat.model.regionMenuLabel': 'Mpaghara nhazi',
  'ide.chat.models.colRegion': 'Mpaghara',
  'ide.chat.modelInUseRegion': 'Ugbu a na-eji {{model}} ({{region}})',
  ...
  'ide.tests.testCount': '{{count}} ule',
  'ide.tests.run': 'Gbaa ọsọ',
  'ide.tests.runAll': 'Gbaa ha niile',
  'ide.tests.runE2e': 'Gbaa e2e ọsọ',
  'ide.tests.runUnit': 'Ngwa ọsọ',
  'ide.tests.runGroup': 'Gbaa otu ọsọ',
  'ide.tests.stop': 'Kwụsị',
  'ide.tests.running': 'Na-agba ọsọ...',
  'ide.tests.passedCount': '{{count}} gafere',
  'ide.tests.failedCount': '{{count}} adaala',
  'ide.tests.statusPassed': 'Agafere',
  'ide.tests.statusFailed': 'Adịghị mma',
  'ide.tests.statusSkipped': 'Awụfuru',
  'ide.tests.kind.e2e': 'Site na njedebe ruo na njedebe',
  'ide.tests.kind.unit': 'Ngalaba',
  'ide.tests.workspace.app': 'Ngwa',
  'ide.tests.workspace.api': 'API',
  'ide.tests.workspace.root': 'ọrụ',
  'ide.tests.e2eHint':
    'Ndị a na-agba ọsọ megide ihe ngosi dị ndụ, yabụ mee ka ihe ngosi ahụ ghere oghe.',
  'ide.tests.showOutput': 'Gosi mmepụta',
  'ide.tests.hideOutput': 'Zoo mmepụta',
  ...
  'ide.tests.cancelled': 'Ọsọ kwụsịrị.',
  'ide.tests.listError': 'Enweghị m ike ịdepụta ule ọrụ a.',
