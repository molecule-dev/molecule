...
export const pa: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'ਫਾਈਲ ਬਹੁਤ ਵੱਡੀ ਹੈ। ਵੱਧ ਤੋਂ ਵੱਧ ਆਕਾਰ ਹੈ {{maxSize}} ਐਮ.ਬੀ.',
  'ide.chat.modelSet': "ਚੈਟ ਮਾਡਲ ਇਸ 'ਤੇ ਸੈੱਟ ਕੀਤਾ ਗਿਆ ਹੈ {{name}}",
  ...
  'ide.chat.uncommittedFileCount': '{{count}} ਅਣ-ਪ੍ਰਵਾਨਿਤ ਫਾਈਲਾਂ',
  ...
  'ide.contextMenu.deleteCount': 'ਮਿਟਾਓ {{count}} ਆਈਟਮਾਂ',
  ...
  'ide.preview.retryCount': 'ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ {{count}}',
  ...
  'ide.toolCall.entryCount': '{{count}} ਇੰਦਰਾਜ਼',
  ...
  'ide.chat.loopLimitReached': 'ਦੀ ਵੱਧ ਤੋਂ ਵੱਧ ਸੀਮਾ ਤੱਕ ਪਹੁੰਚ ਗਿਆ {{max}} ਟੂਲ ਦੁਹਰਾਓ।',
  'ide.chat.maxLoopsSet': "ਵੱਧ ਤੋਂ ਵੱਧ ਟੂਲ ਦੁਹਰਾਓ ਇਸ 'ਤੇ ਸੈੱਟ ਕੀਤਾ ਗਿਆ ਹੈ {{n}}",
  ...
  'ide.chat.voiceEngineTitle': 'ਡਿਕਟੇਸ਼ਨ ਇੰਜਣ',
  'ide.chat.voiceEnginePrivacy':
    'ਹਰ ਵਿਕਲਪ ਤੁਹਾਡੇ ਡਿਵਾਈਸ ’ਤੇ ਚੱਲਦਾ ਹੈ — ਆਡੀਓ ਕਦੇ ਵੀ ਬ੍ਰਾਊਜ਼ਰ ਤੋਂ ਬਾਹਰ ਨਹੀਂ ਜਾਂਦਾ।',
  'ide.chat.voiceEngineNoDownload': 'ਕੋਈ ਡਾਊਨਲੋਡ ਨਹੀਂ',
  'ide.chat.voiceEngineDownload': '~{{mb}} MB ਡਾਊਨਲੋਡ, ਫਿਰ ਕੈਸ਼',
  'ide.chat.voiceEngineDownloadRange': '~{{min}}–{{max}} MB ਡਾਊਨਲੋਡ, ਫਿਰ ਕੈਸ਼',
  'ide.chat.voiceAccuracyBest': 'ਸਭ ਤੋਂ ਵਧੀਆ ਸ਼ੁੱਧਤਾ',
  'ide.chat.voiceAccuracyGood': 'ਚੰਗੀ ਸ਼ੁੱਧਤਾ',
  'ide.chat.voiceAccuracyBasic': 'ਮੁੱਢਲੀ ਸ਼ੁੱਧਤਾ',
  'ide.chat.voiceEngineNative': 'ਬ੍ਰਾਊਜ਼ਰ ਵਿੱਚ ਬਣਿਆ',
  'ide.chat.voiceEngineOnDevice': 'ਡਿਵਾਈਸ ’ਤੇ',
  'ide.chat.voiceEngineNoBrowserSupport': 'ਇਸ ਬ੍ਰਾਊਜ਼ਰ ਵਿੱਚ ਉਪਲਬਧ ਨਹੀਂ',
  'ide.chat.voiceEngineNoLanguageSupport': 'ਤੁਹਾਡੀ ਭਾਸ਼ਾ ਲਈ ਉਪਲਬਧ ਨਹੀਂ',
  'ide.chat.voiceEngineCurrent': 'ਮੌਜੂਦਾ',
  'ide.chat.voiceLangsAll': 'ਸਾਰੀਆਂ ਭਾਸ਼ਾਵਾਂ',
  'ide.chat.voiceLangOnly': 'ਸਿਰਫ਼ {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} ਭਾਸ਼ਾਵਾਂ',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'ਪ੍ਰੋਸੈਸਿੰਗ: {{region}} ਵਿੱਚ — ਬਦਲਣ ਲਈ ਕਲਿੱਕ ਕਰੋ',
  'ide.chat.model.regionOnlyHint': 'ਸਿਰਫ਼ {{region}} ਵਿੱਚ ਹੋਸਟ ਕੀਤਾ',
  'ide.chat.model.regionMenuLabel': 'ਪ੍ਰੋਸੈਸਿੰਗ ਖੇਤਰ',
  'ide.chat.models.colRegion': 'ਖੇਤਰ',
  'ide.chat.modelInUseRegion': 'ਹੁਣ {{model}} ({{region}}) ਵਰਤਿਆ ਜਾ ਰਿਹਾ ਹੈ',
  ...
  'ide.toolCall.changesApplied': '{{count}} ਬਦਲਾਅ ਲਾਗੂ ਕੀਤੇ ਗਏ',
  'ide.toolCall.applied': 'ਲਾਗੂ ਕੀਤਾ',
  'ide.tabs.close': 'ਬੰਦ ਕਰੋ {{fileName}}',
  ...
  'ide.chat.share.notAllowed':
    'ਸ਼ੇਅਰ ਲਿੰਕਾਂ ਦਾ ਪ੍ਰਬੰਧਨ ਕਰਨ ਲਈ ਇਸ ਪ੍ਰੋਜੈਕਟ ਵਿੱਚ ਐਡਮਿਨ ਭੂਮਿਕਾ ਦੀ ਲੋੜ ਹੈ।',
  ...
  'ide.chat.fastModeOn': "ਤੇਜ਼ ਮੋਡ ਚਾਲੂ — ਉੱਚ ਦਰ 'ਤੇ ਤੇਜ਼ ਜਵਾਬ",
  ...
  'ide.chat.timestampsShown': 'ਟਾਈਮਸਟੈਂਪ ਦਿਖਾਏ ਗਏ।',
  'ide.chat.timestampsHidden': 'ਟਾਈਮਸਟੈਂਪ ਲੁਕਾਏ ਗਏ।',
  'ide.chat.timestampsUsage': 'Usage: /timestamps [on | off]',
  'ide.tests.testCount': '{{count}} ਟੈਸਟ',
  'ide.tests.run': 'ਦੌੜੋ',
  'ide.tests.runAll': 'ਸਾਰੇ ਚਲਾਓ',
  'ide.tests.runE2e': 'e2e ਚਲਾਓ',
  'ide.tests.runUnit': 'ਯੂਨਿਟ ਚਲਾਓ',
  'ide.tests.runGroup': 'ਗਰੁੱਪ ਚਲਾਓ',
  'ide.tests.stop': 'ਰੂਕੋ',
  'ide.tests.running': 'ਚੱਲ ਰਿਹਾ ਹੈ…',
  'ide.tests.passedCount': '{{count}} ਪਾਸ ਕੀਤਾ',
  'ide.tests.failedCount': '{{count}} ਅਸਫਲ',
  'ide.tests.statusPassed': 'ਪਾਸ ਕੀਤਾ',
  'ide.tests.statusFailed': 'ਅਸਫਲ ਰਿਹਾ',
  'ide.tests.statusSkipped': 'ਛੱਡਿਆ ਗਿਆ',
  'ide.tests.kind.e2e': 'ਸਿਰੇ ਤੋਂ ਸਿਰੇ ਤੱਕ',
  'ide.tests.kind.unit': 'ਯੂਨਿਟ',
  'ide.tests.workspace.app': 'ਐਪ',
  'ide.tests.workspace.api': 'ਏਪੀਆਈ',
  'ide.tests.workspace.root': 'ਪ੍ਰੋਜੈਕਟ',
  'ide.tests.e2eHint': 'ਇਹ ਲਾਈਵ ਪ੍ਰੀਵਿਊ ਦੇ ਵਿਰੁੱਧ ਚੱਲਦੇ ਹਨ, ਇਸ ਲਈ ਪ੍ਰੀਵਿਊ ਨੂੰ ਖੁੱਲ੍ਹਾ ਰੱਖੋ।',
  'ide.tests.showOutput': 'ਆਉਟਪੁੱਟ ਦਿਖਾਓ',
  'ide.tests.hideOutput': 'ਆਉਟਪੁੱਟ ਲੁਕਾਓ',
  ...
  'ide.tests.cancelled': 'ਦੌੜ ਰੁਕ ਗਈ।',
  'ide.tests.listError': 'ਇਸ ਪ੍ਰੋਜੈਕਟ ਦੇ ਟੈਸਟਾਂ ਦੀ ਸੂਚੀ ਨਹੀਂ ਦਿੱਤੀ ਜਾ ਸਕੀ।',
