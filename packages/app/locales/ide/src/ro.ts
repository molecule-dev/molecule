...
export const ro: Partial<IdeTranslations> = {
  ...
  'ide.chat.modelSet': 'Modelul de chat este setat la {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} fișiere necommise',
  ...
  'ide.contextMenu.deleteCount': 'Şterge {{count}} Articole',
  ...
  'ide.toolCall.andMore': '... și {{count}} Mai mult',
  ...
  'ide.toolCall.matchCount': '{{count}} meciuri',
  ...
  'ide.chat.loopLimitReached': 'A atins maximul de {{max}} iterații ale instrumentului.',
  'ide.chat.maxLoopsSet': 'Iterațiile maxime ale instrumentului sunt setate la {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'cea mai bună acuratețe',
  'ide.chat.voiceAccuracyGood': 'acuratețe bună',
  'ide.chat.voiceAccuracyBasic': 'acuratețe de bază',
  'ide.chat.voiceEngineNative': 'nativ browserului',
  'ide.chat.voiceEngineOnDevice': 'pe dispozitiv',
  'ide.chat.voiceEngineNoBrowserSupport': 'indisponibil în acest browser',
  'ide.chat.voiceEngineNoLanguageSupport': 'indisponibil pentru limba ta',
  'ide.chat.voiceEngineCurrent': 'curent',
  'ide.chat.voiceLangsAll': 'toate limbile',
  'ide.chat.voiceLangOnly': 'doar {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} limbi',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Procesat în: {{region}} — dați clic pentru a schimba',
  'ide.chat.model.regionOnlyHint': 'Găzduit doar în: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Regiune de procesare',
  'ide.chat.models.colRegion': 'Regiune',
  'ide.chat.modelInUseRegion': 'Acum se folosește {{model}} ({{region}})',
  ...
  'ide.tabs.close': 'Aproape {{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} teste',
  'ide.tests.run': 'Alergare',
  'ide.tests.runAll': 'Execută totul',
  'ide.tests.runE2e': 'Executați e2e',
  'ide.tests.runUnit': 'Unitate de execuție',
  'ide.tests.runGroup': 'Grup de alergare',
  'ide.tests.stop': 'Oprește-te',
  'ide.tests.running': 'Alerg…',
  'ide.tests.passedCount': '{{count}} aprobat',
  'ide.tests.failedCount': '{{count}} eșuat',
  'ide.tests.statusPassed': 'Aprobat',
  'ide.tests.statusFailed': 'Eșec',
  'ide.tests.statusSkipped': 'Omis',
  'ide.tests.kind.e2e': 'De la un capăt la celălalt',
  'ide.tests.kind.unit': 'Unitate',
  ...
  'ide.tests.cancelled': 'Alergarea s-a oprit.',
  'ide.tests.listError': 'Nu s-au putut afișa testele acestui proiect.',
