...
export const vi: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'Tệp tin quá lớn. Kích thước tối đa là {{maxSize}} MB.',
  'ide.chat.modelSet': 'Mô hình trò chuyện được thiết lập thành {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} các tệp chưa được cam kết',
  ...
  'ide.contextMenu.deleteCount': 'Xóa bỏ {{count}} Mặt hàng',
  ...
  'ide.toolCall.andMore': '… Và {{count}} hơn',
  ...
  'ide.chat.loopLimitReached': 'Đã đạt mức tối đa {{max}} các phiên bản công cụ.',
  'ide.chat.maxLoopsSet': 'Số lần lặp công cụ tối đa được đặt thành {{n}}',
  ...
  'ide.chat.voiceEngineNative': 'tích hợp trong trình duyệt',
  'ide.chat.voiceEngineOnDevice': 'trên thiết bị',
  'ide.chat.voiceEngineNoBrowserSupport': 'không khả dụng trên trình duyệt này',
  'ide.chat.voiceEngineNoLanguageSupport': 'không khả dụng cho ngôn ngữ của bạn',
  'ide.chat.voiceEngineCurrent': 'hiện tại',
  'ide.chat.voiceLangsAll': 'tất cả ngôn ngữ',
  'ide.chat.voiceLangOnly': 'chỉ {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} ngôn ngữ',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Xử lý tại: {{region}} — nhấp để thay đổi',
  'ide.chat.model.regionOnlyHint': 'Chỉ được lưu trữ tại: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Khu vực xử lý',
  'ide.chat.models.colRegion': 'Khu vực',
  'ide.chat.modelInUseRegion': 'Đang dùng {{model}} ({{region}})',
  ...
  'ide.toolCall.changesApplied': '{{count}} các thay đổi đã được áp dụng',
  ...
  'ide.tests.testCount': '{{count}} kiểm tra',
  'ide.tests.run': 'Chạy',
  'ide.tests.runAll': 'Chạy tất cả',
  'ide.tests.runE2e': 'Chạy e2e',
  'ide.tests.runUnit': 'Đơn vị vận hành',
  'ide.tests.runGroup': 'Nhóm chạy',
  'ide.tests.stop': 'Dừng lại',
  'ide.tests.running': 'Đang chạy…',
  'ide.tests.passedCount': '{{count}} đi qua',
  'ide.tests.failedCount': '{{count}} thất bại',
  'ide.tests.statusPassed': 'Đi qua',
  'ide.tests.statusFailed': 'Thất bại',
  'ide.tests.statusSkipped': 'Bỏ qua',
  'ide.tests.kind.e2e': 'Từ đầu đến cuối',
  'ide.tests.kind.unit': 'Đơn vị',
  ...
  'ide.tests.cancelled': 'Cuộc chạy dừng lại.',
  'ide.tests.listError': 'Không thể liệt kê các bài kiểm tra của dự án này.',
