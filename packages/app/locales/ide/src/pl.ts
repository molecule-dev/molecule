...
export const pl: Partial<IdeTranslations> = {
  ...
  'ide.chat.queuedCount': '{{count}} w kolejce',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} niezatwierdzone pliki',
  ...
  'ide.contextMenu.deleteCount': 'Usuwać {{count}} Rzeczy',
  ...
  'ide.preview.retryCount': 'Ponów próbę {{count}}',
  ...
  'ide.toolCall.newFileLines': 'nowy plik, {{count}} kwestia',
  ...
  'ide.chat.loopLimitReached': 'Osiągnięto maksimum {{max}} iteracje narzędzi.',
  ...
  'ide.chat.voiceAccuracyBest': 'najlepsza dokładność',
  'ide.chat.voiceAccuracyGood': 'dobra dokładność',
  'ide.chat.voiceAccuracyBasic': 'podstawowa dokładność',
  'ide.chat.voiceEngineNative': 'wbudowany w przeglądarkę',
  'ide.chat.voiceEngineOnDevice': 'na urządzeniu',
  'ide.chat.voiceEngineNoBrowserSupport': 'niedostępne w tej przeglądarce',
  'ide.chat.voiceEngineNoLanguageSupport': 'niedostępne dla Twojego języka',
  'ide.chat.voiceEngineCurrent': 'bieżący',
  'ide.chat.voiceLangsAll': 'wszystkie języki',
  'ide.chat.voiceLangOnly': 'tylko {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} języków',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Przetwarzane w: {{region}} — kliknij, aby zmienić',
  'ide.chat.model.regionOnlyHint': 'Hostowane tylko w: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Region przetwarzania',
  'ide.chat.models.colRegion': 'Region',
  'ide.chat.modelInUseRegion': 'Teraz używany: {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} kwestia',
  'ide.toolCall.linesRemoved': '− {{count}} kwestia',
  'ide.toolCall.changesApplied': '{{count}} zmiany zastosowane',
  ...
  'ide.tests.run': 'Uruchom',
  'ide.tests.runAll': 'Uruchom wszystko',
  'ide.tests.runE2e': 'Uruchom e2e',
  'ide.tests.runUnit': 'Uruchom jednostkę',
  'ide.tests.runGroup': 'Grupa biegowa',
  'ide.tests.stop': 'Stop',
  'ide.tests.running': 'Biegam…',
  'ide.tests.passedCount': '{{count}} przyjęto',
  'ide.tests.failedCount': '{{count}} nie powiodło się',
  'ide.tests.statusPassed': 'Zaliczone',
  'ide.tests.statusFailed': 'Nie powiodło się',
  'ide.tests.statusSkipped': 'Pominięto',
  'ide.tests.kind.e2e': 'Od początku do końca',
  'ide.tests.kind.unit': 'Jednostka',
  ...
  'ide.tests.cancelled': 'Bieg został zatrzymany.',
  'ide.tests.listError': 'Nie udało się wyświetlić listy testów tego projektu.',
