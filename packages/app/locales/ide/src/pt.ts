...
export const pt: Partial<IdeTranslations> = {
  ...
  'ide.chat.queuedCount': '{{count}} na fila',
  ...
  'ide.chat.you': 'Você',
  'ide.chat.itemRenderError': 'Não foi possível exibir esta mensagem.',
  ...
  'ide.chat.fileTooLarge': 'O arquivo é muito grande. O tamanho máximo é {{maxSize}} MB.',
  'ide.chat.modelSet': 'Modelo de bate-papo definido para {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} arquivos não confirmados',
  ...
  'ide.contextMenu.deleteCount': 'Excluir {{count}} Unid',
  ...
  'ide.preview.retryCount': 'Tentativa de novo {{count}}',
  ...
  'ide.chat.loopLimitReached': 'Atingiu o máximo de {{max}} iterações da ferramenta.',
  'ide.chat.maxLoopsSet': 'Número máximo de iterações da ferramenta definido como {{n}}',
  ...
  'ide.chat.voice': 'Voz',
  'ide.chat.voiceUnavailable': 'O ditado não está disponível neste navegador.',
  'ide.chat.voiceMicBlocked': 'O acesso ao microfone está bloqueado.',
  ...
  'ide.chat.voiceAccuracyBest': 'melhor precisão',
  'ide.chat.voiceAccuracyGood': 'boa precisão',
  'ide.chat.voiceAccuracyBasic': 'precisão básica',
  'ide.chat.voiceEngineNative': 'nativo do navegador',
  'ide.chat.voiceEngineOnDevice': 'no dispositivo',
  'ide.chat.voiceEngineNoBrowserSupport': 'indisponível neste navegador',
  'ide.chat.voiceEngineNoLanguageSupport': 'indisponível para o seu idioma',
  'ide.chat.voiceEngineCurrent': 'atual',
  'ide.chat.voiceLangsAll': 'todos os idiomas',
  'ide.chat.voiceLangOnly': 'apenas {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} idiomas',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Processado em: {{region}} — clique para alterar',
  'ide.chat.model.regionOnlyHint': 'Hospedado apenas em: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Região de processamento',
  'ide.chat.models.colRegion': 'Região',
  'ide.chat.modelInUseRegion': 'Agora usando {{model}} ({{region}})',
  ...
  'ide.chat.streaming.analyzing': 'Analisando...',
  'ide.chat.streaming.reasoning': 'Raciocínio...',
  'ide.chat.streaming.crafting': 'Preparando uma resposta...',
  'ide.chat.streaming.working': 'Estou trabalhando nisso...',
  'ide.chat.streaming.processing': 'Processando...',
  'ide.chat.streaming.connecting': 'Juntando as peças...',
  'ide.chat.streaming.almostThere': 'Está quase lá...',
  'ide.chat.help.card.heading': 'Ajuda',
  ...
  'ide.chat.skills.defaultBadge': 'Padrão',
  ...
  'ide.tests.testCount': '{{count}} testes',
  'ide.tests.run': 'Correr',
  'ide.tests.runAll': 'Executar tudo',
  'ide.tests.runE2e': 'Executar o e2e',
  'ide.tests.runUnit': 'Executar unidade',
  'ide.tests.runGroup': 'Grupo de corrida',
  'ide.tests.stop': 'Pare',
  'ide.tests.running': 'Correndo…',
  'ide.tests.passedCount': '{{count}} aprovado',
  'ide.tests.failedCount': '{{count}} falhou',
  'ide.tests.statusPassed': 'Aprovado',
  'ide.tests.statusFailed': 'Falha',
  'ide.tests.statusSkipped': 'Ignorado',
  'ide.tests.kind.e2e': 'De ponta a ponta',
  'ide.tests.kind.unit': 'Unidade',
  ...
  'ide.tests.cancelled': 'A execução foi interrompida.',
  'ide.tests.listError': 'Não foi possível listar os testes deste projeto.',
  'ide.tests.runError': 'O teste não pôde ser iniciado.',
  'ide.tests.viewerCannotRun': 'Somente editores podem executar os testes deste projeto.',
  'ide.tests.needsSandbox': 'Inicie o projeto para executar seus testes.',
  'ide.tests.heading': 'Testes',
  'ide.tests.searchPlaceholder': 'Testes de filtro…',
  'ide.tests.loading': 'Carregando os testes…',
  'ide.tests.waitingForSandbox': 'Execute o projeto para ver seus testes.',
  'ide.tests.empty': 'Ainda não há testes neste projeto.',
  'ide.tests.noMatch': 'Nenhum teste corresponde à sua pesquisa.',
