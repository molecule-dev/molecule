...
export const ga: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'Tá an comhad rómhór. Is é an méid uasta ná {{maxSize}} MB.',
  'ide.chat.modelSet': 'Socraithe samhail comhrá go {{name}}',
  ...
  'ide.contextMenu.deleteCount': 'Scrios {{count}} Míreanna',
  ...
  'ide.preview.retryCount': 'Iarracht eile {{count}}',
  ...
  'ide.toolCall.newFileLines': 'comhad nua, {{count}} línte',
  ...
  'ide.toolCall.andMore': '… agus {{count}} níos mó',
  ...
  'ide.chat.loopLimitReached': 'Shroich an t-uasmhéid de {{max}} athrá uirlisí.',
  'ide.chat.maxLoopsSet': 'Uasmhéid athrá uirlisí socraithe go {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'cruinneas is fearr',
  'ide.chat.voiceAccuracyGood': 'cruinneas maith',
  'ide.chat.voiceAccuracyBasic': 'cruinneas bunúsach',
  'ide.chat.voiceEngineNative': 'dúchasach don bhrabhsálaí',
  'ide.chat.voiceEngineOnDevice': 'ar an ngléas',
  'ide.chat.voiceEngineNoBrowserSupport': 'níl ar fáil sa bhrabhsálaí seo',
  'ide.chat.voiceEngineNoLanguageSupport': 'níl ar fáil do do theanga',
  'ide.chat.voiceEngineCurrent': 'reatha',
  'ide.chat.voiceLangsAll': 'gach teanga',
  'ide.chat.voiceLangOnly': '{{language}} amháin',
  'ide.chat.voiceLangsCount': '{{count}} teanga',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Á phróiseáil i: {{region}} — cliceáil le hathrú',
  'ide.chat.model.regionOnlyHint': 'Óstáilte i {{region}} amháin',
  'ide.chat.model.regionMenuLabel': 'Réigiún próiseála',
  'ide.chat.models.colRegion': 'Réigiún',
  'ide.chat.modelInUseRegion': '{{model}} ({{region}}) in úsáid anois',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} línte',
  'ide.toolCall.linesRemoved': '− {{count}} línte',
  ...
  'ide.tests.testCount': '{{count}} tástálacha',
  'ide.tests.run': 'Rith',
  'ide.tests.runAll': 'Rith gach rud',
  'ide.tests.runE2e': 'Rith e2e',
  'ide.tests.runUnit': 'Rith an t-aonad',
  'ide.tests.runGroup': 'Grúpa rith',
  'ide.tests.stop': 'Stop',
  'ide.tests.running': 'Ag rith…',
  'ide.tests.passedCount': '{{count}} rith',
  'ide.tests.failedCount': '{{count}} theip',
  'ide.tests.statusPassed': 'Rith',
  'ide.tests.statusFailed': 'Theip air',
  'ide.tests.statusSkipped': 'Scipeáilte',
  'ide.tests.kind.e2e': 'Deireadh go deireadh',
  'ide.tests.kind.unit': 'Aonad',
