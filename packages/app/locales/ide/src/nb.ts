...
export const nb: Partial<IdeTranslations> = {
  ...
  'ide.chat.you': 'Deg',
  'ide.chat.itemRenderError': 'Denne meldingen kunne ikke vises.',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} uregistrerte filer',
  ...
  'ide.contextMenu.deleteCount': 'Slett {{count}} Elementer',
  ...
  'ide.preview.retryCount': 'Forsøk på nytt {{count}}',
  ...
  'ide.toolCall.andMore': '… og {{count}} flere',
  ...
  'ide.toolCall.matchCount': '{{count}} kamper',
  ...
  'ide.chat.loopLimitReached': 'Nådde maksimumet av {{max}} verktøyiterasjoner.',
  ...
  'ide.chat.voiceAccuracyBest': 'best nøyaktighet',
  'ide.chat.voiceAccuracyGood': 'god nøyaktighet',
  'ide.chat.voiceAccuracyBasic': 'grunnleggende nøyaktighet',
  'ide.chat.voiceEngineNative': 'innebygd i nettleseren',
  'ide.chat.voiceEngineOnDevice': 'på enheten',
  'ide.chat.voiceEngineNoBrowserSupport': 'ikke tilgjengelig i denne nettleseren',
  'ide.chat.voiceEngineNoLanguageSupport': 'ikke tilgjengelig for språket ditt',
  'ide.chat.voiceEngineCurrent': 'gjeldende',
  'ide.chat.voiceLangsAll': 'alle språk',
  'ide.chat.voiceLangOnly': 'kun {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} språk',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Behandles i: {{region}} — klikk for å endre',
  'ide.chat.model.regionOnlyHint': 'Kun driftet i: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Behandlingsregion',
  'ide.chat.models.colRegion': 'Region',
  'ide.chat.modelInUseRegion': 'Bruker nå {{model}} ({{region}})',
  ...
  'ide.toolCall.changesApplied': '{{count}} endringer som er brukt',
  'ide.tabs.close': 'Lukke {{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} tester',
  'ide.tests.run': 'Løp',
  'ide.tests.runAll': 'Kjør alle',
  'ide.tests.runE2e': 'Kjør e2e',
  'ide.tests.runUnit': 'Kjør enhet',
  'ide.tests.runGroup': 'Løpegruppe',
  'ide.tests.stop': 'Stopp',
  'ide.tests.running': 'Løping…',
  'ide.tests.passedCount': '{{count}} vedtatt',
  'ide.tests.failedCount': '{{count}} mislyktes',
  'ide.tests.statusPassed': 'Bestått',
  'ide.tests.statusFailed': 'Mislykket',
  'ide.tests.statusSkipped': 'Hoppet over',
  'ide.tests.kind.e2e': 'Fra ende til ende',
  'ide.tests.kind.unit': 'Enhet',
  ...
  'ide.tests.cancelled': 'Løpet ble avbrutt.',
  'ide.tests.listError': 'Det var ikke mulig å vise testene for dette prosjektet.',
