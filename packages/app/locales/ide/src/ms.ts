...
export const ms: Partial<IdeTranslations> = {
  ...
  'ide.chat.queuedCount': '{{count}} beratur',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} fail yang tidak dikomit',
  ...
  'ide.contextMenu.deleteCount': 'Padam {{count}} Barangan',
  ...
  'ide.toolCall.matchCount': '{{count}} perlawanan',
  ...
  'ide.chat.loopLimitReached': 'Mencapai tahap maksimum {{max}} iterasi alat.',
  ...
  'ide.chat.voiceAccuracyBest': 'ketepatan terbaik',
  'ide.chat.voiceAccuracyGood': 'ketepatan baik',
  'ide.chat.voiceAccuracyBasic': 'ketepatan asas',
  'ide.chat.voiceEngineNative': 'terbina dalam pelayar',
  'ide.chat.voiceEngineOnDevice': 'pada peranti',
  'ide.chat.voiceEngineNoBrowserSupport': 'tidak tersedia dalam pelayar ini',
  'ide.chat.voiceEngineNoLanguageSupport': 'tidak tersedia untuk bahasa anda',
  'ide.chat.voiceEngineCurrent': 'semasa',
  'ide.chat.voiceLangsAll': 'semua bahasa',
  'ide.chat.voiceLangOnly': '{{language}} sahaja',
  ...
  'ide.chat.model.regionOnlyHint': 'Hanya dihoskan di: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Wilayah pemprosesan',
  'ide.chat.models.colRegion': 'Wilayah',
  'ide.chat.modelInUseRegion': 'Kini menggunakan {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} garisan',
  'ide.toolCall.linesRemoved': '− {{count}} garisan',
  'ide.toolCall.changesApplied': '{{count}} perubahan yang dikenakan',
  ...
  'ide.tests.run': 'Lari',
  'ide.tests.runAll': 'Jalankan semua',
  'ide.tests.runE2e': 'Jalankan e2e',
  'ide.tests.runUnit': 'Unit jalankan',
  'ide.tests.runGroup': 'Kumpulan larian',
  'ide.tests.stop': 'Berhenti',
  'ide.tests.running': 'Berlari…',
  'ide.tests.passedCount': '{{count}} lulus',
  'ide.tests.failedCount': '{{count}} gagal',
  'ide.tests.statusPassed': 'Lulus',
  'ide.tests.statusFailed': 'Gagal',
  'ide.tests.statusSkipped': 'Dilangkau',
  'ide.tests.kind.e2e': 'Hujung ke hujung',
  ...
  'ide.tests.cancelled': 'Larian terhenti.',
  'ide.tests.listError': 'Tidak dapat menyenaraikan ujian projek ini.',
