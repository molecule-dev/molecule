...
export const gu: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'ફાઇલ ખૂબ મોટી છે. મહત્તમ કદ છે {{maxSize}} એમબી.',
  'ide.chat.modelSet': 'ચેટ મોડેલ આના પર સેટ કર્યું છે {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} બિન-પ્રતિબદ્ધ ફાઇલો',
  ...
  'ide.contextMenu.deleteCount': 'કાઢી નાખો {{count}} વસ્તુઓ',
  ...
  'ide.preview.retryCount': 'ફરી પ્રયાસ કરો {{count}}',
  ...
  'ide.toolCall.newFileLines': 'નવી ફાઇલ, {{count}} રેખાઓ',
  ...
  'ide.chat.loopLimitReached': 'મહત્તમ સુધી પહોંચી ગયું {{max}} સાધન પુનરાવર્તનો.',
  'ide.chat.maxLoopsSet': 'મહત્તમ ટૂલ પુનરાવર્તનો આના પર સેટ છે {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'શ્રેષ્ઠ ચોકસાઈ',
  'ide.chat.voiceAccuracyGood': 'સારી ચોકસાઈ',
  'ide.chat.voiceAccuracyBasic': 'મૂળભૂત ચોકસાઈ',
  'ide.chat.voiceEngineNative': 'બ્રાઉઝર મૂળ',
  'ide.chat.voiceEngineOnDevice': 'ડિવાઇસ પર',
  'ide.chat.voiceEngineNoBrowserSupport': 'આ બ્રાઉઝરમાં ઉપલબ્ધ નથી',
  'ide.chat.voiceEngineNoLanguageSupport': 'તમારી ભાષા માટે ઉપલબ્ધ નથી',
  'ide.chat.voiceEngineCurrent': 'વર્તમાન',
  'ide.chat.voiceLangsAll': 'બધી ભાષાઓ',
  'ide.chat.voiceLangOnly': 'માત્ર {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} ભાષાઓ',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'પ્રક્રિયા થાય છે: {{region}} — બદલવા માટે ક્લિક કરો',
  'ide.chat.model.regionOnlyHint': 'ફક્ત {{region}}માં હોસ્ટ કરેલું',
  'ide.chat.model.regionMenuLabel': 'પ્રોસેસિંગ પ્રદેશ',
  'ide.chat.models.colRegion': 'પ્રદેશ',
  'ide.chat.modelInUseRegion': 'હવે {{model}} ({{region}}) વપરાય છે',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} રેખાઓ',
  'ide.toolCall.linesRemoved': '- {{count}} રેખાઓ',
  'ide.toolCall.changesApplied': '{{count}} ફેરફારો લાગુ કર્યા',
  'ide.toolCall.applied': 'લાગુ',
  'ide.tabs.close': 'બંધ કરો {{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} પરીક્ષણો',
  'ide.tests.run': 'દોડો',
  'ide.tests.runAll': 'બધા ચલાવો',
  'ide.tests.runE2e': 'e2e ચલાવો',
  'ide.tests.runUnit': 'યુનિટ ચલાવો',
  'ide.tests.runGroup': 'જૂથ ચલાવો',
  'ide.tests.stop': 'બંધ',
  'ide.tests.running': 'ચાલી રહ્યું છે…',
  'ide.tests.passedCount': '{{count}} પાસ',
  'ide.tests.failedCount': '{{count}} નિષ્ફળ',
  'ide.tests.statusPassed': 'પાસ થયા',
  'ide.tests.statusFailed': 'નિષ્ફળ',
  'ide.tests.statusSkipped': 'છોડી દીધું',
  'ide.tests.kind.e2e': 'શરૂઆતથી અંત સુધી',
  'ide.tests.kind.unit': 'એકમ',
  'ide.tests.workspace.app': 'એપ્લિકેશન',
  'ide.tests.workspace.api': 'API',
  'ide.tests.workspace.root': 'પ્રોજેક્ટ',
  'ide.tests.e2eHint': 'આ લાઇવ પ્રિવ્યૂની વિરુદ્ધ ચાલે છે, તેથી પ્રિવ્યૂ ખુલ્લો રાખો.',
  'ide.tests.showOutput': 'આઉટપુટ બતાવો',
  'ide.tests.hideOutput': 'આઉટપુટ છુપાવો',
  ...
  'ide.tests.cancelled': 'દોડ બંધ થઈ ગઈ.',
  'ide.tests.listError': 'આ પ્રોજેક્ટના પરીક્ષણોની યાદી આપી શકાઈ નથી.',
