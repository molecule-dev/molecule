...
export const ko: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': '파일 크기가 너무 큽니다. 최대 크기는 다음과 같습니다. {{maxSize}} MB.',
  'ide.chat.modelSet': '채팅 모델 설정됨 {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} 커밋되지 않은 파일',
  ...
  'ide.contextMenu.deleteCount': '삭제 {{count}} 품목',
  ...
  'ide.preview.retryCount': '재시도 시도 {{count}}',
  ...
  'ide.chat.loopLimitReached': '최대치에 도달했습니다 {{max}} 도구 반복.',
  'ide.chat.maxLoopsSet': '최대 도구 반복 횟수 설정 {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': '최고 정확도',
  'ide.chat.voiceAccuracyGood': '좋은 정확도',
  'ide.chat.voiceAccuracyBasic': '기본 정확도',
  'ide.chat.voiceEngineNative': '브라우저 내장',
  'ide.chat.voiceEngineOnDevice': '온디바이스',
  'ide.chat.voiceEngineNoBrowserSupport': '이 브라우저에서는 사용할 수 없음',
  'ide.chat.voiceEngineNoLanguageSupport': '사용 중인 언어에서는 사용할 수 없음',
  'ide.chat.voiceEngineCurrent': '현재',
  'ide.chat.voiceLangsAll': '모든 언어',
  'ide.chat.voiceLangOnly': '{{language}} 전용',
  'ide.chat.voiceLangsCount': '{{count}}개 언어',
  'ide.chat.model.region.us': '미국',
  'ide.chat.model.region.cn': '중국',
  'ide.chat.model.regionHint': '처리 위치: {{region}} — 클릭하여 변경',
  'ide.chat.model.regionOnlyHint': '{{region}}에서만 호스팅됨',
  'ide.chat.model.regionMenuLabel': '처리 리전',
  'ide.chat.models.colRegion': '리전',
  'ide.chat.modelInUseRegion': '현재 {{model}}({{region}}) 사용 중',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} 윤곽',
  'ide.toolCall.linesRemoved': '− {{count}} 윤곽',
  'ide.toolCall.changesApplied': '{{count}} 변경 사항이 적용되었습니다',
  'ide.tabs.close': '닫다 {{fileName}}',
  ...
  'ide.chat.streaming.thinking': '생각 중...',
  'ide.chat.streaming.analyzing': '분석 중...',
  'ide.chat.streaming.reasoning': '추론...',
  'ide.chat.streaming.crafting': '답변 작성 중...',
  'ide.chat.streaming.working': '지금 작업 중이에요...',
  'ide.chat.streaming.processing': '처리 중...',
  'ide.chat.streaming.connecting': '점들을 이어보면...',
  'ide.chat.streaming.almostThere': '이제 거의 다 왔어...',
  'ide.chat.help.card.heading': '도움말',
  'ide.chat.help.card.commandsTitle': '명령어',
  'ide.chat.help.card.modesTitle': '모드',
  'ide.chat.help.card.tipsTitle': '팁',
  ...
  'ide.tests.testCount': '{{count}} 시험',
  'ide.tests.run': '실행',
  'ide.tests.runAll': '모두 실행',
  'ide.tests.runE2e': 'e2e 실행',
  'ide.tests.runUnit': '단위 실행',
  'ide.tests.runGroup': '런 그룹',
  'ide.tests.stop': '중지',
  'ide.tests.running': '달리기…',
  'ide.tests.passedCount': '{{count}} 통과했다',
  'ide.tests.failedCount': '{{count}} 실패함',
  'ide.tests.statusPassed': '통과됨',
  'ide.tests.statusFailed': '실패함',
  'ide.tests.statusSkipped': '건뜀',
  'ide.tests.kind.e2e': '종단 간',
  'ide.tests.kind.unit': '단위',
  ...
  'ide.tests.cancelled': '실행이 중지되었습니다.',
  'ide.tests.listError': '이 프로젝트의 테스트를 나열할 수 없습니다.',
