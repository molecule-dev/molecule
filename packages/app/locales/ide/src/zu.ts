...
export const zu: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileCount': '{{count}} amafayela',
  ...
  'ide.chat.fileTooLarge': 'Ifayela likhulu kakhulu. Usayizi omkhulu ngu {{maxSize}} MB.',
  'ide.chat.modelSet': 'Imodeli yengxoxo isethwe ku- {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} amafayela angakabophezeleki',
  ...
  'ide.contextMenu.deleteCount': 'Susa {{count}} Izinto',
  ...
  'ide.preview.retryCount': 'Zama futhi {{count}}',
  ...
  'ide.toolCall.newFileLines': 'ifayela elisha, {{count}} imigqa',
  ...
  'ide.toolCall.andMore': '... futhi {{count}} Okuningi',
  ...
  'ide.toolCall.entryCount': '{{count}} okufakiwe',
  'ide.toolCall.matchCount': '{{count}} okufanayo',
  'ide.toolCall.fileCount': '{{count}} amafayela',
  ...
  'ide.chat.loopLimitReached': 'Kufinyelelwe esiphezulu se {{max}} ukuphindaphinda kwamathuluzi.',
  'ide.chat.maxLoopsSet': 'Ukuphindaphinda kwamathuluzi okuphezulu kusethwe ku- {{n}}',
  ...
  'ide.chat.voiceEngineTitle': 'Injini yokubhala ngezwi',
  'ide.chat.voiceEnginePrivacy':
    'Zonke izinketho zisebenza kudivayisi yakho — umsindo awuphumi kubhrawuza.',
  'ide.chat.voiceEngineNoDownload': 'akukho ukulanda',
  'ide.chat.voiceEngineDownload': 'ukulanda ~{{mb}} MB, bese kugcinwa',
  'ide.chat.voiceEngineDownloadRange': 'ukulanda ~{{min}}–{{max}} MB, bese kugcinwa',
  'ide.chat.voiceAccuracyBest': 'ukunemba okuhle kakhulu',
  'ide.chat.voiceAccuracyGood': 'ukunemba okuhle',
  'ide.chat.voiceAccuracyBasic': 'ukunemba okuyisisekelo',
  'ide.chat.voiceEngineNative': 'okwakhelwe kubhrawuza',
  'ide.chat.voiceEngineOnDevice': 'kudivayisi',
  'ide.chat.voiceEngineNoBrowserSupport': 'akutholakali kule bhrawuza',
  'ide.chat.voiceEngineNoLanguageSupport': 'akutholakali ulimi lwakho',
  'ide.chat.voiceEngineCurrent': 'okwamanje',
  'ide.chat.voiceLangsAll': 'zonke izilimi',
  'ide.chat.voiceLangOnly': '{{language}} kuphela',
  'ide.chat.voiceLangsCount': 'izilimi ezingu-{{count}}',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Icutshungulwa e-: {{region}} — chofoza ukuze ushintshe',
  'ide.chat.model.regionOnlyHint': 'Isingathwe kuphela e-: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Isifunda sokucubungula',
  'ide.chat.models.colRegion': 'Isifunda',
  'ide.chat.modelInUseRegion': 'Manje kusetshenziswa i-{{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} imigqa',
  'ide.toolCall.linesRemoved': '− {{count}} imigqa',
  'ide.toolCall.changesApplied': '{{count}} izinguquko zisetshenzisiwe',
  ...
  'ide.chat.share.notAllowed':
    'Ukulawula izixhumanisi zokwabelana kudinga indima yomlawuli kule phrojekthi.',
  ...
  'ide.tests.testCount': '{{count}} izivivinyo',
  'ide.tests.run': 'Gijima',
  'ide.tests.runAll': 'Sebenzisa konke',
  'ide.tests.runE2e': 'Sebenzisa i-e2e',
  'ide.tests.runUnit': 'Iyunithi yokuqalisa',
  'ide.tests.runGroup': 'Qalisa iqembu',
  'ide.tests.stop': 'Ima',
  'ide.tests.running': 'Ukugijima…',
  'ide.tests.passedCount': '{{count}} kudlulile',
  'ide.tests.failedCount': '{{count}} yehlulekile',
  'ide.tests.statusPassed': 'Kudlulile',
  'ide.tests.statusFailed': 'Yehlulekile',
  'ide.tests.statusSkipped': 'Kweqiwe',
  'ide.tests.kind.e2e': 'Kusukela ekuqaleni kuze kube sekupheleni',
  'ide.tests.kind.unit': 'Iyunithi',
  'ide.tests.workspace.app': 'Uhlelo lokusebenza',
  'ide.tests.workspace.api': 'I-API',
  'ide.tests.workspace.root': 'Iphrojekthi',
  'ide.tests.e2eHint':
    'Lokhu kugijima ngokumelene nokubuka kuqala okubukhoma, ngakho-ke gcina ukubuka kuqala kuvuliwe.',
  'ide.tests.showOutput': 'Bonisa umphumela',
  'ide.tests.hideOutput': 'Fihla okukhiphayo',
  ...
  'ide.tests.cancelled': 'Ukugijima kumisiwe.',
  'ide.tests.listError': 'Ayikwazanga ukufaka ohlwini izivivinyo zale phrojekthi.',
