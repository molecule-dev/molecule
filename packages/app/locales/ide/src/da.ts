...
export const da: Partial<IdeTranslations> = {
  ...
  'ide.chat.queuedCount': '{{count}} i kø',
  ...
  'ide.chat.modelSet': 'Chatmodel indstillet til {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} ikke-committede filer',
  ...
  'ide.contextMenu.deleteCount': 'Slet {{count}} Varer',
  ...
  'ide.preview.retryCount': 'Gentag forsøg {{count}}',
  ...
  'ide.toolCall.entryCount': '{{count}} indlæg',
  'ide.toolCall.matchCount': '{{count}} kampe',
  ...
  'ide.chat.loopLimitReached': 'Nåede maksimum {{max}} værktøjsiterationer.',
  'ide.chat.maxLoopsSet': 'Maks. værktøjsiterationer indstillet til {{n}}',
  ...
  'ide.chat.voiceUnavailable': 'Diktering er ikke tilgængelig i denne browser.',
  'ide.chat.voiceMicBlocked': 'Adgang til mikrofonen er blokeret.',
  ...
  'ide.chat.voiceAccuracyBest': 'bedste nøjagtighed',
  'ide.chat.voiceAccuracyGood': 'god nøjagtighed',
  'ide.chat.voiceAccuracyBasic': 'grundlæggende nøjagtighed',
  'ide.chat.voiceEngineNative': 'indbygget i browseren',
  'ide.chat.voiceEngineOnDevice': 'på enheden',
  'ide.chat.voiceEngineNoBrowserSupport': 'ikke tilgængelig i denne browser',
  'ide.chat.voiceEngineNoLanguageSupport': 'ikke tilgængelig for dit sprog',
  'ide.chat.voiceEngineCurrent': 'aktuel',
  'ide.chat.voiceLangsAll': 'alle sprog',
  'ide.chat.voiceLangOnly': 'kun {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} sprog',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Behandles i: {{region}} — klik for at ændre',
  'ide.chat.model.regionOnlyHint': 'Hostes kun i: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Behandlingsregion',
  'ide.chat.models.colRegion': 'Region',
  'ide.chat.modelInUseRegion': 'Bruger nu {{model}} ({{region}})',
  ...
  'ide.tests.testCount': '{{count}} prøver',
  'ide.tests.run': 'Kør',
  'ide.tests.runAll': 'Kør alle',
  'ide.tests.runE2e': 'Kør e2e',
  'ide.tests.runUnit': 'Kør enhed',
  'ide.tests.runGroup': 'Løbegruppe',
  'ide.tests.stop': 'Stop',
  'ide.tests.running': 'Løb…',
  'ide.tests.passedCount': '{{count}} vedtaget',
  'ide.tests.failedCount': '{{count}} mislykkedes',
  'ide.tests.statusPassed': 'Bestået',
  'ide.tests.statusFailed': 'Mislykket',
  'ide.tests.statusSkipped': 'Springet over',
  'ide.tests.kind.e2e': 'Fra ende til ende',
  'ide.tests.kind.unit': 'Enhed',
  ...
  'ide.tests.cancelled': 'Løbet er afbrudt.',
  'ide.tests.listError': 'Det var ikke muligt at vise dette projekts tests.',
