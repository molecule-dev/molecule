...
export const sw: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'Faili ni kubwa sana. Ukubwa wa juu zaidi ni {{maxSize}} MB.',
  'ide.chat.modelSet': 'Muundo wa gumzo umewekwa kuwa {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} faili ambazo hazijatolewa',
  ...
  'ide.contextMenu.deleteCount': 'Futa {{count}} Vitu',
  ...
  'ide.preview.retryCount': 'Jaribu tena {{count}}',
  ...
  'ide.toolCall.newFileLines': 'faili mpya, {{count}} mistari',
  ...
  'ide.toolCall.entryCount': '{{count}} maingizo',
  'ide.toolCall.matchCount': '{{count}} mechi',
  ...
  'ide.chat.loopLimitReached': 'Imefikia kiwango cha juu cha {{max}} marudio ya zana.',
  'ide.chat.maxLoopsSet': 'Upeo wa marudio ya zana umewekwa kuwa {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'usahihi bora',
  'ide.chat.voiceAccuracyGood': 'usahihi mzuri',
  'ide.chat.voiceAccuracyBasic': 'usahihi wa msingi',
  'ide.chat.voiceEngineNative': 'iliyojengwa kwenye kivinjari',
  'ide.chat.voiceEngineOnDevice': 'kwenye kifaa',
  'ide.chat.voiceEngineNoBrowserSupport': 'haipatikani katika kivinjari hiki',
  'ide.chat.voiceEngineNoLanguageSupport': 'haipatikani kwa lugha yako',
  'ide.chat.voiceEngineCurrent': 'ya sasa',
  'ide.chat.voiceLangsAll': 'lugha zote',
  'ide.chat.voiceLangOnly': '{{language}} pekee',
  'ide.chat.voiceLangsCount': 'lugha {{count}}',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Inachakatwa katika: {{region}} — bofya kubadilisha',
  'ide.chat.model.regionOnlyHint': 'Imepangishwa {{region}} pekee',
  'ide.chat.model.regionMenuLabel': 'Eneo la uchakataji',
  'ide.chat.models.colRegion': 'Eneo',
  'ide.chat.modelInUseRegion': 'Sasa inatumia {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} mistari',
  'ide.toolCall.linesRemoved': '− {{count}} mistari',
  'ide.toolCall.changesApplied': '{{count}} mabadiliko yametumika',
  ...
  'ide.tests.testCount': '{{count}} majaribio',
  'ide.tests.run': 'Kimbia',
  'ide.tests.runAll': 'Endesha zote',
  'ide.tests.runE2e': 'Endesha e2e',
  'ide.tests.runUnit': 'Kitengo cha kukimbia',
  'ide.tests.runGroup': 'Kikundi cha kukimbia',
  'ide.tests.stop': 'Simamisha',
  'ide.tests.running': 'Kukimbia…',
  'ide.tests.passedCount': '{{count}} kupita',
  'ide.tests.failedCount': '{{count}} imeshindwa',
  'ide.tests.statusPassed': 'Imepitishwa',
  'ide.tests.statusFailed': 'Imeshindwa',
  'ide.tests.statusSkipped': 'Imerukwa',
  'ide.tests.kind.e2e': 'Mwisho-mwisho',
  'ide.tests.kind.unit': 'Kitengo',
  ...
  'ide.tests.cancelled': 'Mbio zimesimama.',
  'ide.tests.listError': 'Haikuweza kuorodhesha majaribio ya mradi huu.',
