...
export const is: Partial<IdeTranslations> = {
  ...
  'ide.chat.uncommittedFileCount': '{{count}} óskráðar skrár',
  ...
  'ide.contextMenu.deleteCount': 'Eyða {{count}} Hlutir',
  ...
  'ide.preview.retryCount': 'Endurtekið tilraun {{count}}',
  ...
  'ide.toolCall.andMore': '… og {{count}} meira',
  ...
  'ide.toolCall.matchCount': '{{count}} leikir',
  ...
  'ide.chat.loopLimitReached': 'Náði hámarki {{max}} endurtekningar á tólum.',
  'ide.chat.maxLoopsSet': 'Hámarks ítrekanir tóla stilltar á {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'besta nákvæmni',
  'ide.chat.voiceAccuracyGood': 'góð nákvæmni',
  'ide.chat.voiceAccuracyBasic': 'grunnnákvæmni',
  'ide.chat.voiceEngineNative': 'innbyggt í vafra',
  'ide.chat.voiceEngineOnDevice': 'á tækinu',
  'ide.chat.voiceEngineNoBrowserSupport': 'ekki í boði í þessum vafra',
  'ide.chat.voiceEngineNoLanguageSupport': 'ekki í boði fyrir tungumálið þitt',
  'ide.chat.voiceEngineCurrent': 'núverandi',
  'ide.chat.voiceLangsAll': 'öll tungumál',
  'ide.chat.voiceLangOnly': 'aðeins {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} tungumál',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Unnið í: {{region}} — smelltu til að breyta',
  'ide.chat.model.regionOnlyHint': 'Aðeins hýst í: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Vinnslusvæði',
  'ide.chat.models.colRegion': 'Svæði',
  'ide.chat.modelInUseRegion': 'Notar nú {{model}} ({{region}})',
  ...
  'ide.toolCall.changesApplied': '{{count}} breytingar gerðar',
  ...
  'ide.tests.testCount': '{{count}} próf',
  'ide.tests.run': 'Hlaupa',
  'ide.tests.runAll': 'Keyra allt',
  'ide.tests.runE2e': 'Hlauptu e2e',
  'ide.tests.runUnit': 'Keyrslueining',
  'ide.tests.runGroup': 'Hlaupahópur',
  'ide.tests.stop': 'Stöðva',
  'ide.tests.running': 'Hlaupandi…',
  'ide.tests.passedCount': '{{count}} samþykkt',
  'ide.tests.failedCount': '{{count}} mistókst',
  'ide.tests.statusPassed': 'Samþykkt',
  'ide.tests.statusFailed': 'Mistókst',
  'ide.tests.statusSkipped': 'Sleppt',
  'ide.tests.kind.e2e': 'Enda til enda',
  'ide.tests.kind.unit': 'Eining',
  ...
  'ide.tests.cancelled': 'Hlaupið stöðvað.',
  'ide.tests.listError': 'Gat ekki listað prófanir þessa verkefnis.',
