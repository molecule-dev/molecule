...
export const hr: Partial<IdeTranslations> = {
  ...
  'ide.chat.modelSet': 'Model chata postavljen je na {{name}}',
  ...
  'ide.contextMenu.deleteCount': 'Izbrisati {{count}} Stavke',
  ...
  'ide.toolCall.newFileLines': 'nova datoteka, {{count}} linije',
  ...
  'ide.chat.loopLimitReached': 'Dosegnut je maksimum od {{max}} iteracije alata.',
  ...
  'ide.chat.voiceAccuracyBest': 'najbolja točnost',
  'ide.chat.voiceAccuracyGood': 'dobra točnost',
  'ide.chat.voiceAccuracyBasic': 'osnovna točnost',
  ...
  'ide.chat.model.regionOnlyHint': 'Hostirano samo u: {{region}}',
  ...
  'ide.tabs.close': 'Zatvoriti {{fileName}}',
  ...
  'ide.chat.fastModeOn': 'Uključen brzi način rada — brži odgovori većom brzinom',
  ...
  'ide.tests.passedCount': '{{count}} prošao',
  'ide.tests.failedCount': '{{count}} neuspjeh',
  'ide.tests.statusPassed': 'Prošao',
  ...
  'ide.tests.e2eHint': 'Ovo se odvija protiv pregleda uživo, stoga držite pregled otvorenim.',
  ...
  'ide.tests.cancelled': 'Trčanje je zaustavljeno.',
  'ide.tests.listError': 'Nije moguće navesti testove ovog projekta.',
  'ide.tests.runError': 'Probni rad nije mogao započeti.',
  'ide.tests.viewerCannotRun': 'Samo urednici mogu pokrenuti testove ovog projekta.',
  'ide.tests.needsSandbox': 'Pokrenite projekt kako biste izvršili njegove testove.',
  'ide.tests.heading': 'Testovi',
  'ide.tests.searchPlaceholder': 'Testovi filtera…',
  'ide.tests.loading': 'Učitavanje testova…',
  'ide.tests.waitingForSandbox': 'Pokrenite projekt kako biste vidjeli njegove testove.',
  ...
  'ide.tests.fixFailures': 'Popraviti {{count}} neuspjesi',
  'ide.tests.fixBusy': 'Pričekajte da se završi trenutni potez.',
  'ide.chat.skipToolCall': 'Preskočiti',
