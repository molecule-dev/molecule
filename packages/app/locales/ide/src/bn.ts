...
export const bn: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'ফাইলটি অনেক বড়। সর্বোচ্চ আকার হলো {{maxSize}} এমবি।',
  'ide.chat.modelSet': 'চ্যাট মডেল সেট করা হয়েছে {{name}}',
  ...
  'ide.contextMenu.deleteCount': 'মুছে ফেলুন {{count}} আইটেম',
  ...
  'ide.preview.retryCount': 'পুনরায় চেষ্টা করার চেষ্টা {{count}}',
  ...
  'ide.toolCall.newFileLines': 'নতুন ফাইল, {{count}} লাইন',
  ...
  'ide.toolCall.andMore': '… এবং {{count}} আরও',
  ...
  'ide.chat.loopLimitReached': 'সর্বোচ্চ সীমায় পৌঁছেছে {{max}} টুল পুনরাবৃত্তি।',
  'ide.chat.maxLoopsSet': 'সর্বোচ্চ টুল পুনরাবৃত্তি সেট করা হয়েছে {{n}}',
  ...
  'ide.chat.voiceEngineTitle': 'ডিক্টেশন ইঞ্জিন',
  'ide.chat.voiceEnginePrivacy': 'প্রতিটি বিকল্প আপনার ডিভাইসে চলে — অডিও কখনো ব্রাউজার ছাড়ে না।',
  'ide.chat.voiceEngineNoDownload': 'ডাউনলোড নেই',
  'ide.chat.voiceEngineDownload': '~{{mb}} MB ডাউনলোড, তারপর ক্যাশ হয়',
  'ide.chat.voiceEngineDownloadRange': '~{{min}}–{{max}} MB ডাউনলোড, তারপর ক্যাশ হয়',
  'ide.chat.voiceAccuracyBest': 'সেরা নির্ভুলতা',
  'ide.chat.voiceAccuracyGood': 'ভালো নির্ভুলতা',
  'ide.chat.voiceAccuracyBasic': 'মৌলিক নির্ভুলতা',
  'ide.chat.voiceEngineNative': 'ব্রাউজারের নিজস্ব',
  'ide.chat.voiceEngineOnDevice': 'ডিভাইসে',
  'ide.chat.voiceEngineNoBrowserSupport': 'এই ব্রাউজারে উপলব্ধ নয়',
  'ide.chat.voiceEngineNoLanguageSupport': 'আপনার ভাষার জন্য উপলব্ধ নয়',
  'ide.chat.voiceEngineCurrent': 'বর্তমান',
  'ide.chat.voiceLangsAll': 'সব ভাষা',
  'ide.chat.voiceLangOnly': 'শুধু {{language}}',
  'ide.chat.voiceLangsCount': '{{count}}টি ভাষা',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'প্রক্রিয়াকরণ হয়: {{region}} — পরিবর্তন করতে ক্লিক করুন',
  'ide.chat.model.regionOnlyHint': 'শুধুমাত্র {{region}}-এ হোস্ট করা',
  'ide.chat.model.regionMenuLabel': 'প্রক্রিয়াকরণ অঞ্চল',
  'ide.chat.models.colRegion': 'অঞ্চল',
  'ide.chat.modelInUseRegion': 'এখন {{model}} ({{region}}) ব্যবহার করা হচ্ছে',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} লাইন',
  'ide.toolCall.linesRemoved': '− {{count}} লাইন',
  'ide.toolCall.changesApplied': '{{count}} পরিবর্তন প্রয়োগ করা হয়েছে',
  'ide.toolCall.applied': 'প্রয়োগ করা হয়েছে',
  'ide.tabs.close': 'বন্ধ করুন {{fileName}}',
  ...
  'ide.chat.fastModeOn': 'ফাস্ট মোড চালু — উচ্চতর হারে আরও দ্রুত প্রতিক্রিয়া।',
  ...
  'ide.tests.testCount': '{{count}} পরীক্ষা',
  'ide.tests.run': 'দৌড়',
  'ide.tests.runAll': 'সব চালান',
  'ide.tests.runE2e': 'রান e2e',
  'ide.tests.runUnit': 'ইউনিট চালান',
  'ide.tests.runGroup': 'রান গ্রুপ',
  'ide.tests.stop': 'থামুন',
  'ide.tests.running': 'দৌড়াচ্ছি…',
  'ide.tests.passedCount': '{{count}} পাস',
  'ide.tests.failedCount': '{{count}} ব্যর্থ',
  'ide.tests.statusPassed': 'পাস',
  'ide.tests.statusFailed': 'ব্যর্থ',
  'ide.tests.statusSkipped': 'বাদ দেওয়া হয়েছে',
  'ide.tests.kind.e2e': 'প্রান্ত থেকে প্রান্ত পর্যন্ত',
  'ide.tests.kind.unit': 'ইউনিট',
  'ide.tests.workspace.app': 'অ্যাপ',
  'ide.tests.workspace.api': 'এপিআই',
  'ide.tests.workspace.root': 'প্রকল্প',
  'ide.tests.e2eHint': 'এগুলো লাইভ প্রিভিউয়ের সাথে সামঞ্জস্যপূর্ণ, তাই প্রিভিউটি খোলা রাখুন।',
  'ide.tests.showOutput': 'আউটপুট দেখান',
  'ide.tests.hideOutput': 'আউটপুট লুকান',
  ...
  'ide.tests.cancelled': 'দৌড় থেমে গেল।',
  'ide.tests.listError': 'এই প্রকল্পের পরীক্ষাগুলো তালিকাভুক্ত করা সম্ভব হয়নি।',
