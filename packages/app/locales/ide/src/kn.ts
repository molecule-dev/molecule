...
export const kn: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'ಫೈಲ್ ತುಂಬಾ ದೊಡ್ಡದಾಗಿದೆ. ಗರಿಷ್ಠ ಗಾತ್ರ {{maxSize}} ಎಂಬಿ.',
  'ide.chat.modelSet': 'ಚಾಟ್ ಮಾದರಿಯನ್ನು ಇದಕ್ಕೆ ಹೊಂದಿಸಲಾಗಿದೆ {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} ಬದ್ಧವಾಗಿಲ್ಲದ ಫೈಲ್‌ಗಳು',
  ...
  'ide.contextMenu.deleteCount': 'ಅಳಿಸಿ {{count}} ವಸ್ತುಗಳು',
  ...
  'ide.preview.retryCount': 'ಮರುಪ್ರಯತ್ನದ ಪ್ರಯತ್ನ {{count}}',
  ...
  'ide.toolCall.matchCount': '{{count}} ಪಂದ್ಯಗಳು',
  ...
  'ide.chat.loopLimitReached': 'ಗರಿಷ್ಠ ಮಟ್ಟವನ್ನು ತಲುಪಿದೆ {{max}} ಉಪಕರಣ ಪುನರಾವರ್ತನೆಗಳು.',
  'ide.chat.maxLoopsSet': 'ಗರಿಷ್ಠ ಪರಿಕರ ಪುನರಾವರ್ತನೆಗಳನ್ನು ಇದಕ್ಕೆ ಹೊಂದಿಸಲಾಗಿದೆ {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'ಅತ್ಯುತ್ತಮ ನಿಖರತೆ',
  'ide.chat.voiceAccuracyGood': 'ಉತ್ತಮ ನಿಖರತೆ',
  'ide.chat.voiceAccuracyBasic': 'ಮೂಲ ನಿಖರತೆ',
  'ide.chat.voiceEngineNative': 'ಬ್ರೌಸರ್ ಸ್ವಂತ',
  'ide.chat.voiceEngineOnDevice': 'ಸಾಧನದಲ್ಲಿ',
  'ide.chat.voiceEngineNoBrowserSupport': 'ಈ ಬ್ರೌಸರ್‌ನಲ್ಲಿ ಲಭ್ಯವಿಲ್ಲ',
  'ide.chat.voiceEngineNoLanguageSupport': 'ನಿಮ್ಮ ಭಾಷೆಗೆ ಲಭ್ಯವಿಲ್ಲ',
  'ide.chat.voiceEngineCurrent': 'ಪ್ರಸ್ತುತ',
  'ide.chat.voiceLangsAll': 'ಎಲ್ಲಾ ಭಾಷೆಗಳು',
  'ide.chat.voiceLangOnly': '{{language}} ಮಾತ್ರ',
  'ide.chat.voiceLangsCount': '{{count}} ಭಾಷೆಗಳು',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'ಸಂಸ್ಕರಣೆ: {{region}} — ಬದಲಾಯಿಸಲು ಕ್ಲಿಕ್ ಮಾಡಿ',
  'ide.chat.model.regionOnlyHint': 'ಕೇವಲ {{region}}ನಲ್ಲಿ ಹೋಸ್ಟ್ ಮಾಡಲಾಗಿದೆ',
  'ide.chat.model.regionMenuLabel': 'ಸಂಸ್ಕರಣಾ ಪ್ರದೇಶ',
  'ide.chat.models.colRegion': 'ಪ್ರದೇಶ',
  'ide.chat.modelInUseRegion': 'ಈಗ {{model}} ({{region}}) ಬಳಕೆಯಲ್ಲಿದೆ',
  ...
  'ide.toolCall.changesApplied': '{{count}} ಬದಲಾವಣೆಗಳನ್ನು ಅನ್ವಯಿಸಲಾಗಿದೆ',
  'ide.toolCall.applied': 'ಅನ್ವಯಿಸಲಾಗಿದೆ',
  'ide.tabs.close': 'ಮುಚ್ಚಿ {{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} ಪರೀಕ್ಷೆಗಳು',
  'ide.tests.run': 'ಓಡು',
  'ide.tests.runAll': 'ಎಲ್ಲವನ್ನೂ ರನ್ ಮಾಡಿ',
  'ide.tests.runE2e': 'e2e ರನ್ ಮಾಡಿ',
  'ide.tests.runUnit': 'ರನ್ ಯೂನಿಟ್',
  'ide.tests.runGroup': 'ಗುಂಪನ್ನು ಚಲಾಯಿಸಿ',
  'ide.tests.stop': 'ನಿಲ್ಲಿಸಿ',
  'ide.tests.running': 'ಓಡುತ್ತಿದೆ...',
  'ide.tests.passedCount': '{{count}} ಪಾಸಾಗಿದೆ',
  'ide.tests.failedCount': '{{count}} ವಿಫಲವಾಗಿದೆ',
  'ide.tests.statusPassed': 'ಉತ್ತೀರ್ಣರಾದರು',
  'ide.tests.statusFailed': 'ವಿಫಲವಾಗಿದೆ',
  'ide.tests.statusSkipped': 'ಬಿಟ್ಟುಬಿಡಲಾಗಿದೆ',
  'ide.tests.kind.e2e': 'ಕೊನೆಯಿಂದ ಕೊನೆಯವರೆಗೆ',
  'ide.tests.kind.unit': 'ಘಟಕ',
  ...
  'ide.tests.cancelled': 'ಓಟ ನಿಂತಿತು.',
  'ide.tests.listError': 'ಈ ಯೋಜನೆಯ ಪರೀಕ್ಷೆಗಳನ್ನು ಪಟ್ಟಿ ಮಾಡಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ.',
