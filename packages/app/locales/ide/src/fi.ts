...
export const fi: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'Tiedosto on liian suuri. Suurin mahdollinen koko on {{maxSize}} MB.',
  'ide.chat.modelSet': 'Chat-malliksi asetettu {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} vahvistamattomat tiedostot',
  ...
  'ide.contextMenu.deleteCount': 'Poistaa {{count}} Kohteet',
  ...
  'ide.preview.retryCount': 'Uudelleenyritys {{count}}',
  ...
  'ide.toolCall.newFileLines': 'uusi tiedosto, {{count}} linjat',
  ...
  'ide.toolCall.entryCount': '{{count}} merkinnät',
  'ide.toolCall.matchCount': '{{count}} tulitikut',
  ...
  'ide.chat.loopLimitReached': 'Saavutti maksimimäärän {{max}} työkalujen iteraatiot.',
  'ide.chat.maxLoopsSet': 'Työkalujen iteraatioiden enimmäismääräksi asetettu {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'paras tarkkuus',
  'ide.chat.voiceAccuracyGood': 'hyvä tarkkuus',
  'ide.chat.voiceAccuracyBasic': 'perustarkkuus',
  'ide.chat.voiceEngineNative': 'selaimen oma',
  'ide.chat.voiceEngineOnDevice': 'laitteella',
  'ide.chat.voiceEngineNoBrowserSupport': 'ei saatavilla tässä selaimessa',
  'ide.chat.voiceEngineNoLanguageSupport': 'ei saatavilla kielellesi',
  'ide.chat.voiceEngineCurrent': 'nykyinen',
  'ide.chat.voiceLangsAll': 'kaikki kielet',
  'ide.chat.voiceLangOnly': 'vain {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} kieltä',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Käsitellään alueella: {{region}} — vaihda napsauttamalla',
  'ide.chat.model.regionOnlyHint': 'Isännöity vain alueella: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Käsittelyalue',
  'ide.chat.models.colRegion': 'Alue',
  'ide.chat.modelInUseRegion': 'Nyt käytössä {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} linjat',
  'ide.toolCall.linesRemoved': '− {{count}} linjat',
  'ide.toolCall.changesApplied': '{{count}} muutokset otettu käyttöön',
  'ide.tabs.close': 'Lähellä {{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} testit',
  'ide.tests.run': 'Suorita',
  'ide.tests.runAll': 'Suorita kaikki',
  'ide.tests.runE2e': 'Suorita e2e',
  'ide.tests.runUnit': 'Suorita yksikkö',
  'ide.tests.runGroup': 'Juoksuryhmä',
  'ide.tests.stop': 'Lopeta',
  'ide.tests.running': 'Juoksu…',
  'ide.tests.passedCount': '{{count}} hyväksyttiin',
  'ide.tests.failedCount': '{{count}} epäonnistui',
  'ide.tests.statusPassed': 'Hyväksytty',
  'ide.tests.statusFailed': 'Epäonnistui',
  'ide.tests.statusSkipped': 'Ohitettu',
  'ide.tests.kind.e2e': 'Alusta loppuun',
  'ide.tests.kind.unit': 'Yksikkö',
  ...
  'ide.tests.cancelled': 'Juoksu keskeytyi.',
  'ide.tests.listError': 'Tämän projektin testejä ei voitu luetella.',
