...
export const es: Partial<IdeTranslations> = {
  ...
  'ide.chat.you': 'Tú',
  'ide.chat.itemRenderError': 'No se pudo mostrar este mensaje.',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} archivos no confirmados',
  ...
  'ide.contextMenu.deleteCount': 'Borrar {{count}} Elementos',
  ...
  'ide.preview.retryCount': 'Reintentar {{count}}',
  ...
  'ide.toolCall.newFileLines': 'nuevo archivo, {{count}} pauta',
  ...
  'ide.chat.loopLimitReached': 'Alcanzó el máximo de {{max}} iteraciones de la herramienta.',
  'ide.chat.maxLoopsSet': 'Iteraciones máximas de la herramienta establecidas en {{n}}',
  ...
  'ide.chat.voiceMicBlocked': 'El acceso al micrófono está bloqueado.',
  ...
  'ide.chat.voiceAccuracyBest': 'máxima precisión',
  'ide.chat.voiceAccuracyGood': 'buena precisión',
  'ide.chat.voiceAccuracyBasic': 'precisión básica',
  'ide.chat.voiceEngineNative': 'nativo del navegador',
  'ide.chat.voiceEngineOnDevice': 'en el dispositivo',
  'ide.chat.voiceEngineNoBrowserSupport': 'no disponible en este navegador',
  'ide.chat.voiceEngineNoLanguageSupport': 'no disponible para tu idioma',
  'ide.chat.voiceEngineCurrent': 'actual',
  'ide.chat.voiceLangsAll': 'todos los idiomas',
  'ide.chat.voiceLangOnly': 'solo {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} idiomas',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Se procesa en: {{region}} — haz clic para cambiar',
  'ide.chat.model.regionOnlyHint': 'Solo alojado en: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Región de procesamiento',
  'ide.chat.models.colRegion': 'Región',
  'ide.chat.modelInUseRegion': 'Ahora se usa {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} pauta',
  'ide.toolCall.linesRemoved': '− {{count}} pauta',
  'ide.toolCall.changesApplied': '{{count}} cambios aplicados',
  'ide.tabs.close': 'Cerca {{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} pruebas',
  'ide.tests.run': 'Correr',
  'ide.tests.runAll': 'Ejecutar todo',
  'ide.tests.runE2e': 'Ejecutar e2e',
  'ide.tests.runUnit': 'Ejecutar unidad',
  'ide.tests.runGroup': 'Grupo de carrera',
  'ide.tests.stop': 'Alto',
  'ide.tests.running': 'Corriendo…',
  'ide.tests.passedCount': '{{count}} aprobado',
  'ide.tests.failedCount': '{{count}} falló',
  'ide.tests.statusPassed': 'Aprobado',
  'ide.tests.statusFailed': 'Fallido',
  'ide.tests.statusSkipped': 'Omitido',
  'ide.tests.kind.e2e': 'De extremo a extremo',
  'ide.tests.kind.unit': 'Unidad',
  ...
  'ide.tests.cancelled': 'La carrera se ha suspendido.',
  'ide.tests.listError': 'No se han podido mostrar las pruebas de este proyecto.',
  'ide.tests.runError': 'No se ha podido iniciar la prueba.',
  'ide.tests.viewerCannotRun': 'Solo los editores pueden ejecutar las pruebas de este proyecto.',
  'ide.tests.needsSandbox': 'Inicia el proyecto para ejecutar sus pruebas.',
  'ide.tests.heading': 'Pruebas',
  'ide.tests.searchPlaceholder': 'Pruebas de filtros…',
  'ide.tests.loading': 'Cargando pruebas…',
  ...
  'ide.chat.skipToolCall': 'Saltar',
  'ide.chat.skippingToolCall': 'Saltando…',
  'ide.chat.skipToolCallViewer': 'Solo los editores pueden saltarse esto.',
