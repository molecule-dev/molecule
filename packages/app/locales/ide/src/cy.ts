...
export const cy: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileCount': '{{count}} ffeiliau',
  ...
  'ide.chat.fileTooLarge': "Mae'r ffeil yn rhy fawr. Maint mwyaf yw {{maxSize}} MB.",
  'ide.chat.modelSet': "Model sgwrsio wedi'i osod i {{name}}",
  ...
  'ide.chat.uncommittedFileCount': '{{count}} ffeiliau heb eu hymrwymo',
  ...
  'ide.contextMenu.deleteCount': 'Dileu {{count}} Eitemau',
  ...
  'ide.preview.retryCount': 'Ymgais arall {{count}}',
  ...
  'ide.toolCall.newFileLines': 'ffeil newydd, {{count}} llinellau',
  ...
  'ide.toolCall.andMore': '… a {{count}} mwy',
  ...
  'ide.toolCall.entryCount': '{{count}} cofnodion',
  'ide.toolCall.matchCount': '{{count}} gemau',
  'ide.toolCall.fileCount': '{{count}} ffeiliau',
  ...
  'ide.chat.loopLimitReached': 'Cyrhaeddodd yr uchafswm o {{max}} iteriadau offeryn.',
  'ide.chat.maxLoopsSet': "Uchafswm iteriadau offeryn wedi'u gosod i {{n}}",
  ...
  'ide.chat.voiceEngineTitle': 'Injan arddweud',
  'ide.chat.voiceEnginePrivacy':
    'Mae pob opsiwn yn rhedeg ar eich dyfais — nid yw sain byth yn gadael eich porwr.',
  'ide.chat.voiceEngineNoDownload': 'dim lawrlwytho',
  'ide.chat.voiceEngineDownload': 'lawrlwytho ~{{mb}} MB, yna wedi’i storio',
  'ide.chat.voiceEngineDownloadRange': 'lawrlwytho ~{{min}}–{{max}} MB, yna wedi’i storio',
  'ide.chat.voiceAccuracyBest': 'cywirdeb gorau',
  'ide.chat.voiceAccuracyGood': 'cywirdeb da',
  'ide.chat.voiceAccuracyBasic': 'cywirdeb sylfaenol',
  'ide.chat.voiceEngineNative': 'brodorol i’r porwr',
  'ide.chat.voiceEngineOnDevice': 'ar y ddyfais',
  'ide.chat.voiceEngineNoBrowserSupport': 'ddim ar gael yn y porwr hwn',
  'ide.chat.voiceEngineNoLanguageSupport': 'ddim ar gael ar gyfer eich iaith',
  'ide.chat.voiceEngineCurrent': 'cyfredol',
  'ide.chat.voiceLangsAll': 'pob iaith',
  'ide.chat.voiceLangOnly': '{{language}} yn unig',
  'ide.chat.voiceLangsCount': '{{count}} iaith',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Yn cael ei brosesu yn: {{region}} — cliciwch i newid',
  'ide.chat.model.regionOnlyHint': "Wedi'i gynnal yn {{region}} yn unig",
  'ide.chat.model.regionMenuLabel': 'Rhanbarth prosesu',
  'ide.chat.models.colRegion': 'Rhanbarth',
  'ide.chat.modelInUseRegion': 'Nawr yn defnyddio {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} llinellau',
  'ide.toolCall.linesRemoved': '− {{count}} llinellau',
  'ide.toolCall.changesApplied': '{{count}} newidiadau a gymhwyswyd',
  ...
  'ide.chat.share.notAllowed':
    'Mae rheoli dolenni rhannu yn gofyn am rôl gweinyddwr ar y prosiect hwn.',
  ...
  'ide.tests.testCount': '{{count}} profion',
  'ide.tests.run': 'Rhedeg',
  'ide.tests.runAll': 'Rhedeg y cyfan',
  'ide.tests.runE2e': 'Rhedeg e2e',
  'ide.tests.runUnit': 'Rhedeg yr uned',
  'ide.tests.runGroup': 'Rhedeg grŵp',
  'ide.tests.stop': 'Stopiwch',
  'ide.tests.running': 'Rhedeg…',
  'ide.tests.passedCount': '{{count}} wedi pasio',
  'ide.tests.failedCount': '{{count}} methu',
  'ide.tests.statusPassed': 'Wedi pasio',
  'ide.tests.statusFailed': 'Methodd',
  'ide.tests.statusSkipped': "Wedi'i hepgor",
  'ide.tests.kind.e2e': "O'r dechrau i'r diwedd",
  'ide.tests.kind.unit': 'Uned',
  'ide.tests.workspace.app': 'Ap',
  'ide.tests.workspace.api': 'API',
  'ide.tests.workspace.root': 'Prosiect',
  'ide.tests.e2eHint':
    "Mae'r rhain yn rhedeg yn erbyn y rhagolwg byw, felly cadwch y rhagolwg ar agor.",
  'ide.tests.showOutput': 'Dangos allbwn',
  'ide.tests.hideOutput': 'Cuddio allbwn',
  ...
  'ide.tests.cancelled': 'Rhediad wedi stopio.',
  'ide.tests.listError': 'Methwyd rhestru profion y prosiect hwn.',
