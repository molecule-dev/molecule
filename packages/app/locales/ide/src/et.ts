...
export const et: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileCount': '{{count}} failid',
  'common.cancel': 'Tühista',
  'common.save': 'Salvesta',
  'ide.chat.queued': 'Järjekorras',
  'ide.chat.queuedCount': '{{count}} järjekorras',
  ...
  'ide.chat.modelSet': 'Vestlusmudel on seatud väärtusele {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} kinnitamata failid',
  ...
  'ide.contextMenu.deleteCount': 'Kustuta {{count}} Esemed',
  ...
  'ide.preview.retryCount': 'Uuesti proovimine {{count}}',
  ...
  'ide.toolCall.newFileLines': 'uus fail, {{count}} jooned',
  ...
  'ide.toolCall.andMore': '... ja {{count}} rohkem',
  ...
  'ide.toolCall.entryCount': '{{count}} kanded',
  'ide.toolCall.matchCount': '{{count}} tikud',
  'ide.toolCall.fileCount': '{{count}} failid',
  ...
  'ide.chat.voiceEngineNoDownload': 'allalaadimiseta',
  'ide.chat.voiceEngineDownload': '~{{mb}} MB allalaadimine, seejärel vahemälus',
  'ide.chat.voiceEngineDownloadRange': '~{{min}}–{{max}} MB allalaadimine, seejärel vahemälus',
  'ide.chat.voiceAccuracyBest': 'parim täpsus',
  'ide.chat.voiceAccuracyGood': 'hea täpsus',
  'ide.chat.voiceAccuracyBasic': 'põhitäpsus',
  'ide.chat.voiceEngineNative': 'brauseri sisseehitatud',
  'ide.chat.voiceEngineOnDevice': 'seadmes',
  'ide.chat.voiceEngineNoBrowserSupport': 'selles brauseris pole saadaval',
  'ide.chat.voiceEngineNoLanguageSupport': 'sinu keele jaoks pole saadaval',
  'ide.chat.voiceEngineCurrent': 'praegune',
  'ide.chat.voiceLangsAll': 'kõik keeled',
  'ide.chat.voiceLangOnly': 'ainult {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} keelt',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Töödeldakse: {{region}} — muutmiseks klõpsa',
  'ide.chat.model.regionOnlyHint': 'Majutatud ainult: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Töötlemispiirkond',
  'ide.chat.models.colRegion': 'Piirkond',
  'ide.chat.modelInUseRegion': 'Nüüd kasutusel {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} jooned',
  'ide.toolCall.linesRemoved': '− {{count}} jooned',
  'ide.toolCall.changesApplied': '{{count}} muudatused rakendatud',
  'ide.toolCall.applied': 'Rakendatud',
  'ide.tabs.close': 'Sule {{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} testid',
  'ide.tests.run': 'Jookse',
  'ide.tests.runAll': 'Käivita kõik',
  'ide.tests.runE2e': 'Käivita e2e',
  'ide.tests.runUnit': 'Käivita üksus',
  'ide.tests.runGroup': 'Jooksugrupp',
  'ide.tests.stop': 'Peatu',
  'ide.tests.running': 'Jooksmine…',
  'ide.tests.passedCount': '{{count}} vastu võetud',
  'ide.tests.failedCount': '{{count}} ei õnnestunud',
  'ide.tests.statusPassed': 'Heaks kiidetud',
  'ide.tests.statusFailed': 'Ebaõnnestus',
  'ide.tests.statusSkipped': 'Vahelejäänud',
  'ide.tests.kind.e2e': 'Lõpuni',
  'ide.tests.kind.unit': 'Üksus',
  'ide.tests.workspace.app': 'Rakendus',
  'ide.tests.workspace.api': 'API',
  'ide.tests.workspace.root': 'Projekt',
  'ide.tests.e2eHint': 'Need töötavad koos reaalajas eelvaatega, seega hoidke eelvaade avatuna.',
  'ide.tests.showOutput': 'Näita väljundit',
  'ide.tests.hideOutput': 'Peida väljund',
  ...
  'ide.tests.cancelled': 'Jooks peatati.',
  'ide.tests.listError': 'Selle projekti teste ei õnnestunud loetleda.',
