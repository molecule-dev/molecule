...
export const mr: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'फाईल खूप मोठी आहे. कमाल आकार आहे {{maxSize}} एमबी.',
  'ide.chat.modelSet': 'चॅट मॉडेल सेट केले {{name}}',
  ...
  'ide.contextMenu.deleteCount': 'हटवा {{count}} वस्तू',
  ...
  'ide.preview.retryCount': 'पुन्हा प्रयत्न करा {{count}}',
  ...
  'ide.toolCall.newFileLines': 'नवीन फाईल, {{count}} ओळी',
  ...
  'ide.toolCall.andMore': '… आणि {{count}} अधिक',
  ...
  'ide.chat.loopLimitReached': 'कमाल मर्यादेपर्यंत पोहोचले {{max}} साधनांच्या पुनरावृत्ती.',
  'ide.chat.maxLoopsSet': 'कमाल टूल पुनरावृत्तींची संख्या सेट केली आहे {{n}}',
  ...
  'ide.chat.voice': 'आवाज',
  'ide.chat.voiceUnavailable': 'या ब्राउझरमध्ये डिक्टेशन उपलब्ध नाही.',
  'ide.chat.voiceMicBlocked': 'मायक्रोफोन प्रवेश अवरोधित आहे.',
  ...
  'ide.chat.voiceAccuracyBest': 'सर्वोत्तम अचूकता',
  'ide.chat.voiceAccuracyGood': 'चांगली अचूकता',
  'ide.chat.voiceAccuracyBasic': 'मूलभूत अचूकता',
  'ide.chat.voiceEngineNative': 'ब्राउझर अंगभूत',
  'ide.chat.voiceEngineOnDevice': 'डिव्हाइसवर',
  'ide.chat.voiceEngineNoBrowserSupport': 'या ब्राउझरमध्ये उपलब्ध नाही',
  'ide.chat.voiceEngineNoLanguageSupport': 'तुमच्या भाषेसाठी उपलब्ध नाही',
  'ide.chat.voiceEngineCurrent': 'सध्याचे',
  'ide.chat.voiceLangsAll': 'सर्व भाषा',
  'ide.chat.voiceLangOnly': 'फक्त {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} भाषा',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'प्रक्रिया होते: {{region}} — बदलण्यासाठी क्लिक करा',
  'ide.chat.model.regionOnlyHint': 'फक्त {{region}}मध्ये होस्ट केलेले',
  'ide.chat.model.regionMenuLabel': 'प्रक्रिया प्रदेश',
  'ide.chat.models.colRegion': 'प्रदेश',
  'ide.chat.modelInUseRegion': 'आता {{model}} ({{region}}) वापरात आहे',
  ...
  'ide.tabs.close': 'बंद करा {{fileName}}',
  ...
  'ide.chat.fastModeOn': 'फास्ट मोड चालू — अधिक वेगाने प्रतिसाद',
  'ide.chat.fastModeOff': 'फास्ट मोड बंद',
  'ide.chat.fastModeEnable': 'फास्ट मोड — उच्च टोकन दरावर २.५ पट पर्यंत जलद आउटपुट',
  'ide.chat.fastModeDisable': 'फास्ट मोड बंद करा',
  ...
  'ide.tests.testCount': '{{count}} चाचण्या',
  'ide.tests.run': 'धावणे',
  'ide.tests.runAll': 'सर्व चालवा',
  'ide.tests.runE2e': 'रन ई२ई',
  'ide.tests.runUnit': 'युनिट चालवा',
  'ide.tests.runGroup': 'गट चालवा',
  'ide.tests.stop': 'थांबा',
  'ide.tests.running': 'धावत…',
  'ide.tests.passedCount': '{{count}} पास झाले',
  'ide.tests.failedCount': '{{count}} अयशस्वी',
  'ide.tests.statusPassed': 'पास झाले',
  'ide.tests.statusFailed': 'अयशस्वी',
  'ide.tests.statusSkipped': 'वगळले',
  'ide.tests.kind.e2e': 'सुरुवातीपासून शेवटपर्यंत',
  'ide.tests.kind.unit': 'युनिट',
  'ide.tests.workspace.app': 'अ‍ॅप',
  'ide.tests.workspace.api': 'एपीआय',
  'ide.tests.workspace.root': 'प्रकल्प',
  'ide.tests.e2eHint': 'हे लाइव्ह प्रिव्ह्यूच्या विरुद्ध चालतात, त्यामुळे प्रिव्ह्यू उघडा ठेवा.',
  'ide.tests.showOutput': 'आउटपुट दाखवा',
  'ide.tests.hideOutput': 'आउटपुट लपवा',
  ...
  'ide.tests.cancelled': 'धाव थांबली.',
  'ide.tests.listError': 'या प्रकल्पाच्या चाचण्यांची यादी करता आली नाही.',
