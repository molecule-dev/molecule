...
export const ja: Partial<IdeTranslations> = {
  ...
  'ide.chat.modelSet': 'チャットモデルは次のように設定されています{{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}}コミットされていないファイル',
  ...
  'ide.contextMenu.deleteCount': '消去{{count}}商品',
  ...
  'ide.preview.retryCount': '再試行{{count}}',
  ...
  'ide.chat.voiceAccuracyBest': '最高精度',
  'ide.chat.voiceAccuracyGood': '良好な精度',
  'ide.chat.voiceAccuracyBasic': '基本精度',
  'ide.chat.voiceEngineNative': 'ブラウザ内蔵',
  'ide.chat.voiceEngineOnDevice': 'オンデバイス',
  'ide.chat.voiceEngineNoBrowserSupport': 'このブラウザでは利用できません',
  'ide.chat.voiceEngineNoLanguageSupport': 'お使いの言語では利用できません',
  'ide.chat.voiceEngineCurrent': '現在',
  'ide.chat.voiceLangsAll': 'すべての言語',
  'ide.chat.voiceLangOnly': '{{language}}のみ',
  'ide.chat.voiceLangsCount': '{{count}}言語',
  'ide.chat.model.region.us': '米国',
  'ide.chat.model.region.cn': '中国',
  'ide.chat.model.regionHint': '処理場所: {{region}} — クリックして変更',
  'ide.chat.model.regionOnlyHint': 'ホスト場所: {{region}} のみ',
  'ide.chat.model.regionMenuLabel': '処理リージョン',
  'ide.chat.models.colRegion': 'リージョン',
  'ide.chat.modelInUseRegion': '現在 {{model}}（{{region}}）を使用中',
  ...
  'ide.toolCall.linesAdded': '+ {{count}}線',
  'ide.toolCall.linesRemoved': '− {{count}}線',
  'ide.toolCall.changesApplied': '{{count}}変更が適用されました',
  'ide.tabs.close': '近い{{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} テスト',
  'ide.tests.run': '実行',
  'ide.tests.runAll': 'すべて実行',
  'ide.tests.runE2e': 'e2eを実行する',
  'ide.tests.runUnit': 'ユニットを実行する',
  'ide.tests.runGroup': 'ランニンググループ',
  'ide.tests.stop': '停止',
  'ide.tests.running': '走っている……',
  'ide.tests.passedCount': '{{count}} 合格した',
  'ide.tests.failedCount': '{{count}} 失敗した',
  'ide.tests.statusPassed': '合格',
  'ide.tests.statusFailed': '失敗しました',
  'ide.tests.statusSkipped': 'スキップしました',
  'ide.tests.kind.e2e': 'エンド・ツー・エンド',
  'ide.tests.kind.unit': '単位',
  ...
  'ide.tests.cancelled': '実行が停止しました。',
  'ide.tests.listError': 'このプロジェクトのテストを一覧表示できませんでした。',
