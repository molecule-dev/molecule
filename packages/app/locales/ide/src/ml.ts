...
export const ml: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'ഫയൽ വളരെ വലുതാണ്. പരമാവധി വലുപ്പം {{maxSize}} എം.ബി.',
  'ide.chat.modelSet': 'ചാറ്റ് മോഡൽ ഇതിലേക്ക് സജ്ജീകരിച്ചു {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} പ്രതിബദ്ധതയില്ലാത്ത ഫയലുകൾ',
  ...
  'ide.contextMenu.deleteCount': 'ഇല്ലാതാക്കുക {{count}} ഇനങ്ങൾ',
  ...
  'ide.preview.retryCount': 'വീണ്ടും ശ്രമിക്കൽ ശ്രമം {{count}}',
  ...
  'ide.toolCall.newFileLines': 'പുതിയ ഫയൽ, {{count}} ലൈനുകൾ',
  ...
  'ide.toolCall.andMore': '… കൂടാതെ {{count}} കൂടുതൽ',
  ...
  'ide.toolCall.matchCount': '{{count}} മത്സരങ്ങൾ',
  ...
  'ide.chat.loopLimitReached': 'പരമാവധിയിലെത്തി {{max}} ഉപകരണ ആവർത്തനങ്ങൾ.',
  'ide.chat.maxLoopsSet': 'പരമാവധി ടൂൾ ആവർത്തനങ്ങൾ {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'മികച്ച കൃത്യത',
  'ide.chat.voiceAccuracyGood': 'നല്ല കൃത്യത',
  'ide.chat.voiceAccuracyBasic': 'അടിസ്ഥാന കൃത്യത',
  'ide.chat.voiceEngineNative': 'ബ്രൗസർ അന്തർനിർമ്മിതം',
  'ide.chat.voiceEngineOnDevice': 'ഉപകരണത്തിൽ',
  'ide.chat.voiceEngineNoBrowserSupport': 'ഈ ബ്രൗസറിൽ ലഭ്യമല്ല',
  'ide.chat.voiceEngineNoLanguageSupport': 'നിങ്ങളുടെ ഭാഷയ്ക്ക് ലഭ്യമല്ല',
  'ide.chat.voiceEngineCurrent': 'നിലവിലുള്ളത്',
  'ide.chat.voiceLangsAll': 'എല്ലാ ഭാഷകളും',
  'ide.chat.voiceLangOnly': '{{language}} മാത്രം',
  'ide.chat.voiceLangsCount': '{{count}} ഭാഷകൾ',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'പ്രോസസ്സ് ചെയ്യുന്നത്: {{region}} — മാറ്റാൻ ക്ലിക്ക് ചെയ്യുക',
  'ide.chat.model.regionOnlyHint': '{{region}}-ൽ മാത്രം ഹോസ്റ്റ് ചെയ്തിരിക്കുന്നു',
  'ide.chat.model.regionMenuLabel': 'പ്രോസസ്സിംഗ് മേഖല',
  'ide.chat.models.colRegion': 'മേഖല',
  'ide.chat.modelInUseRegion': 'ഇപ്പോൾ {{model}} ({{region}}) ഉപയോഗിക്കുന്നു',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} ലൈനുകൾ',
  'ide.toolCall.linesRemoved': '− {{count}} ലൈനുകൾ',
  'ide.toolCall.changesApplied': '{{count}} മാറ്റങ്ങൾ പ്രയോഗിച്ചു',
  'ide.toolCall.applied': 'പ്രയോഗിച്ചു',
  'ide.tabs.close': 'അടയ്ക്കുക {{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} പരിശോധനകൾ',
  'ide.tests.run': 'ഓടുക',
  'ide.tests.runAll': 'എല്ലാം പ്രവർത്തിപ്പിക്കുക',
  'ide.tests.runE2e': 'e2e പ്രവർത്തിപ്പിക്കുക',
  'ide.tests.runUnit': 'യൂണിറ്റ് പ്രവർത്തിപ്പിക്കുക',
  'ide.tests.runGroup': 'ഗ്രൂപ്പ് പ്രവർത്തിപ്പിക്കുക',
  'ide.tests.stop': 'നിർത്തുക',
  'ide.tests.running': 'ഓടുന്നു...',
  'ide.tests.passedCount': '{{count}} പാസ്സായി',
  'ide.tests.failedCount': '{{count}} പരാജയപ്പെട്ടു',
  'ide.tests.statusPassed': 'പാസ്സായി',
  'ide.tests.statusFailed': 'പരാജയപ്പെട്ടു',
  'ide.tests.statusSkipped': 'ഒഴിവാക്കി',
  'ide.tests.kind.e2e': 'അവസാനം മുതൽ അവസാനം വരെ',
  'ide.tests.kind.unit': 'യൂണിറ്റ്',
