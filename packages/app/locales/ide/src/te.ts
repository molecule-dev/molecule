...
export const te: Partial<IdeTranslations> = {
  ...
  'ide.chat.modelSet': 'చాట్ మోడల్ సెట్ చేయబడింది {{name}}',
  ...
  'ide.contextMenu.deleteCount': 'తొలగించు {{count}} వస్తువులు',
  ...
  'ide.preview.retryCount': 'మళ్ళీ ప్రయత్నించే ప్రయత్నం {{count}}',
  ...
  'ide.toolCall.newFileLines': 'కొత్త ఫైల్, {{count}} పంక్తులు',
  ...
  'ide.toolCall.andMore': '… మరియు {{count}} మరింత',
  ...
  'ide.chat.loopLimitReached': 'గరిష్ట స్థాయికి చేరుకుంది {{max}} టూల్ పునరావృత్తులు.',
  'ide.chat.maxLoopsSet': 'గరిష్ట టూల్ పునరావృతాలు సెట్ చేయబడ్డాయి {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'ఉత్తమ ఖచ్చితత్వం',
  'ide.chat.voiceAccuracyGood': 'మంచి ఖచ్చితత్వం',
  'ide.chat.voiceAccuracyBasic': 'ప్రాథమిక ఖచ్చితత్వం',
  'ide.chat.voiceEngineNative': 'బ్రౌజర్ అంతర్నిర్మిత',
  'ide.chat.voiceEngineOnDevice': 'పరికరంలో',
  'ide.chat.voiceEngineNoBrowserSupport': 'ఈ బ్రౌజర్‌లో అందుబాటులో లేదు',
  'ide.chat.voiceEngineNoLanguageSupport': 'మీ భాషకు అందుబాటులో లేదు',
  'ide.chat.voiceEngineCurrent': 'ప్రస్తుత',
  'ide.chat.voiceLangsAll': 'అన్ని భాషలు',
  'ide.chat.voiceLangOnly': '{{language}} మాత్రమే',
  'ide.chat.voiceLangsCount': '{{count}} భాషలు',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'ప్రాసెస్ అవుతుంది: {{region}} — మార్చడానికి క్లిక్ చేయండి',
  'ide.chat.model.regionOnlyHint': '{{region}}లో మాత్రమే హోస్ట్ చేయబడింది',
  'ide.chat.model.regionMenuLabel': 'ప్రాసెసింగ్ ప్రాంతం',
  'ide.chat.models.colRegion': 'ప్రాంతం',
  'ide.chat.modelInUseRegion': 'ఇప్పుడు {{model}} ({{region}}) వాడుకలో ఉంది',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} పంక్తులు',
  'ide.toolCall.linesRemoved': '− {{count}} పంక్తులు',
  'ide.toolCall.changesApplied': '{{count}} మార్పులు వర్తింపజేయబడ్డాయి',
  'ide.toolCall.applied': 'దరఖాస్తు చేయబడింది',
  'ide.tabs.close': 'మూసివేయండి {{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} పరీక్షలు',
  'ide.tests.run': 'పరుగెత్తు',
  'ide.tests.runAll': 'అన్నింటినీ అమలు చేయండి',
  'ide.tests.runE2e': 'e2eని అమలు చేయండి',
  'ide.tests.runUnit': 'రన్ యూనిట్',
  'ide.tests.runGroup': 'రన్ గ్రూప్',
  'ide.tests.stop': 'ఆపండి',
  'ide.tests.running': 'పరుగెత్తడం…',
  'ide.tests.passedCount': '{{count}} ఉత్తీర్ణత సాధించారు',
  'ide.tests.failedCount': '{{count}} విఫలమయ్యాడు',
  'ide.tests.statusPassed': 'ఉత్తీర్ణత సాధించారు',
  'ide.tests.statusFailed': 'విఫలమైంది',
  'ide.tests.statusSkipped': 'దాటవేయబడింది',
  'ide.tests.kind.e2e': 'మొదటి నుండి చివరి వరకు',
  'ide.tests.kind.unit': 'యూనిట్',
  ...
  'ide.tests.cancelled': 'పరుగు ఆగిపోయింది.',
  'ide.tests.listError': 'ఈ ప్రాజెక్ట్ యొక్క పరీక్షలను జాబితా చేయలేకపోయాము.',
