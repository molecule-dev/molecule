...
export const mn: Partial<IdeTranslations> = {
  ...
  'ide.chat.queuedCount': '{{count}} дараалалд',
  ...
  'ide.chat.fileTooLarge': 'Файл хэт том байна. Хамгийн дээд хэмжээ нь {{maxSize}} МБ.',
  'ide.chat.modelSet': 'Чатын загварыг дараахаар тохируулсан {{name}}',
  ...
  'ide.contextMenu.deleteCount': 'Устгах {{count}} Зүйлс',
  ...
  'ide.preview.retryCount': 'Дахин оролдох {{count}}',
  ...
  'ide.toolCall.newFileLines': 'шинэ файл, {{count}} шугамууд',
  ...
  'ide.toolCall.andMore': '... ба {{count}} илүү их',
  ...
  'ide.chat.loopLimitReached': 'Хамгийн дээд хэмжээнд хүрсэн {{max}} хэрэгслийн давталтууд.',
  'ide.chat.maxLoopsSet': 'Багажны дээд давталтуудыг тохируулсан {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'хамгийн сайн нарийвчлал',
  'ide.chat.voiceAccuracyGood': 'сайн нарийвчлал',
  'ide.chat.voiceAccuracyBasic': 'үндсэн нарийвчлал',
  'ide.chat.voiceEngineNative': 'хөтчид суулгасан',
  'ide.chat.voiceEngineOnDevice': 'төхөөрөмж дээр',
  'ide.chat.voiceEngineNoBrowserSupport': 'энэ хөтчид боломжгүй',
  'ide.chat.voiceEngineNoLanguageSupport': 'таны хэлэнд боломжгүй',
  'ide.chat.voiceEngineCurrent': 'одоогийн',
  'ide.chat.voiceLangsAll': 'бүх хэл',
  'ide.chat.voiceLangOnly': 'зөвхөн {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} хэл',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Боловсруулах байршил: {{region}} — өөрчлөхийн тулд дарна уу',
  'ide.chat.model.regionOnlyHint': 'Зөвхөн {{region}}-д байрладаг',
  'ide.chat.model.regionMenuLabel': 'Боловсруулах бүс',
  'ide.chat.models.colRegion': 'Бүс',
  'ide.chat.modelInUseRegion': 'Одоо {{model}} ({{region}}) ашиглаж байна',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} шугамууд',
  'ide.toolCall.linesRemoved': '− {{count}} шугамууд',
  'ide.toolCall.changesApplied': '{{count}} өөрчлөлтүүдийг хэрэгжүүлсэн',
  'ide.toolCall.applied': 'Хэрэглэсэн',
  'ide.tabs.close': 'Хаах {{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} шинжилгээнүүд',
  'ide.tests.run': 'Гүйх',
  'ide.tests.runAll': 'Бүгдийг нь ажиллуулах',
  'ide.tests.runE2e': 'e2e-г ажиллуул',
  'ide.tests.runUnit': 'Ажиллуулах нэгж',
  'ide.tests.runGroup': 'Бүлгийг ажиллуулах',
  'ide.tests.stop': 'Зогсоох',
  'ide.tests.running': 'Гүйж байна...',
  'ide.tests.passedCount': '{{count}} тэнцсэн',
  'ide.tests.failedCount': '{{count}} бүтэлгүйтсэн',
  'ide.tests.statusPassed': 'Тэнцсэн',
  'ide.tests.statusFailed': 'Амжилтгүй болсон',
  'ide.tests.statusSkipped': 'Алгассан',
  'ide.tests.kind.e2e': 'Эцсээс төгсгөл хүртэл',
  'ide.tests.kind.unit': 'Нэгж',
  ...
  'ide.tests.cancelled': 'Гүйлт зогссон.',
  'ide.tests.listError': 'Энэ төслийн туршилтуудыг жагсааж чадсангүй.',
