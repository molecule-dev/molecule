...
export const ca: Partial<IdeTranslations> = {
  ...
  'ide.chat.modelSet': 'Model de xat definit a {{name}}',
  ...
  'ide.contextMenu.deleteCount': 'Suprimeix {{count}} Articles',
  ...
  'ide.preview.retryCount': 'Intent de reintent {{count}}',
  ...
  'ide.chat.loopLimitReached': "Ha arribat al màxim de {{max}} iteracions de l'eina.",
  'ide.chat.maxLoopsSet': "Iteracions màximes de l'eina definides a {{n}}",
  ...
  'ide.chat.voiceEngineTitle': 'Motor de dictat',
  'ide.chat.voiceEnginePrivacy':
    'Cada opció funciona al teu dispositiu — l’àudio mai no surt del navegador.',
  'ide.chat.voiceEngineNoDownload': 'sense baixada',
  'ide.chat.voiceEngineDownload': 'baixada de ~{{mb}} MB, després en memòria cau',
  'ide.chat.voiceEngineDownloadRange': 'baixada de ~{{min}}–{{max}} MB, després en memòria cau',
  'ide.chat.voiceAccuracyBest': 'màxima precisió',
  'ide.chat.voiceAccuracyGood': 'bona precisió',
  'ide.chat.voiceAccuracyBasic': 'precisió bàsica',
  'ide.chat.voiceEngineNative': 'natiu del navegador',
  'ide.chat.voiceEngineOnDevice': 'al dispositiu',
  'ide.chat.voiceEngineNoBrowserSupport': 'no disponible en aquest navegador',
  'ide.chat.voiceEngineNoLanguageSupport': 'no disponible per al teu idioma',
  'ide.chat.voiceEngineCurrent': 'actual',
  'ide.chat.voiceLangsAll': 'tots els idiomes',
  'ide.chat.voiceLangOnly': 'només {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} idiomes',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Es processa a: {{region}} — feu clic per canviar',
  'ide.chat.model.regionOnlyHint': 'Només allotjat a: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Regió de processament',
  'ide.chat.models.colRegion': 'Regió',
  'ide.chat.modelInUseRegion': "Ara s'utilitza {{model}} ({{region}})",
  ...
  'ide.chat.share.notAllowed':
    'Per gestionar els enllaços de compartició cal un rol d’administrador en aquest projecte.',
  ...
  'ide.chat.fastModeOn': 'Mode ràpid activat: respostes més ràpides a una velocitat més alta',
  'ide.chat.fastModeOff': 'Mode ràpid desactivat',
  'ide.chat.fastModeEnable':
    'Mode ràpid: sortida fins a 2,5 vegades més ràpida a una velocitat de token més alta',
  'ide.chat.fastModeDisable': 'Desactiva el mode ràpid',
  'ide.chat.scripts.runWithOptions': 'Executa…',
  ...
  'ide.chat.settings.effort.label': 'Esforç de raonament',
  'ide.chat.timestampsShown': 'Marques de temps visibles.',
  'ide.chat.timestampsHidden': 'Marques de temps amagades.',
  'ide.chat.timestampsUsage': 'Usage: /timestamps [on | off]',
  'ide.tests.testCount': '{{count}} proves',
  'ide.tests.run': 'Corre',
  'ide.tests.runAll': 'Executa-ho tot',
  'ide.tests.runE2e': 'Executa e2e',
  'ide.tests.runUnit': "Unitat d'execució",
  'ide.tests.runGroup': "Grup d'execució",
  'ide.tests.stop': 'Atura',
  'ide.tests.running': 'Corrent…',
  'ide.tests.passedCount': '{{count}} passat',
  'ide.tests.failedCount': '{{count}} fallat',
  'ide.tests.statusPassed': 'Aprovat',
  'ide.tests.statusFailed': 'Fallat',
  'ide.tests.statusSkipped': 'Omès',
  'ide.tests.kind.e2e': 'De punta a punta',
  'ide.tests.kind.unit': 'Unitat',
  'ide.tests.workspace.app': 'Aplicació',
  'ide.tests.workspace.api': 'API',
  'ide.tests.workspace.root': 'Projecte',
  'ide.tests.e2eHint':
    "Aquests s'executen contra la previsualització en directe, així que mantingueu la previsualització oberta.",
  'ide.tests.showOutput': 'Mostra la sortida',
  'ide.tests.hideOutput': 'Amaga la sortida',
  ...
  'ide.tests.cancelled': "La cursa s'ha aturat.",
  'ide.tests.listError': "No s'han pogut llistar les proves d'aquest projecte.",
