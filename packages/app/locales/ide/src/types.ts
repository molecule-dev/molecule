...
export type IdeTranslationKey =
  ...
  | 'ide.chat.askUserMultiHint'
  | 'ide.chat.askUserSelectedCount'
  | 'ide.chat.askUserMultiConfirm'
  | 'ide.chat.askUserPreview'
  | 'ide.chat.taskListTitle'
  | 'ide.chat.taskListProgress'
  | 'ide.chat.planReview.badge'
  | 'ide.chat.planReview.fallbackTitle'
  | 'ide.chat.planReview.steps'
  | 'ide.chat.planReview.openPlan'
  | 'ide.chat.planReview.more'
  | 'ide.chat.backgroundRunning'
  | 'ide.chat.backgroundFailed'
  | 'ide.chat.backgroundDone'
  | 'ide.chat.backgroundElapsed'
  | 'ide.chat.backgroundExit'
  | 'ide.chat.backgroundOk'
  ...
  | 'ide.toolCall.sentTo'
  | 'ide.chat.subagent.judge'
  | 'ide.chat.subagent.explore'
  | 'ide.chat.subagent.working'
  | 'ide.chat.subagent.verdictPass'
  | 'ide.chat.subagent.verdictFail'
  | 'ide.chat.subagent.showReport'
  | 'ide.chat.subagent.hideReport'
  ...
  | 'ide.chat.soundEventDesc.message'
  ...
  | 'ide.chat.voiceTranscribeFailed'
  | 'ide.chat.voiceEngineTitle'
  | 'ide.chat.voiceEnginePrivacy'
  | 'ide.chat.voiceEngineNoDownload'
  | 'ide.chat.voiceEngineDownload'
  | 'ide.chat.voiceEngineDownloadRange'
  | 'ide.chat.voiceAccuracyBest'
  | 'ide.chat.voiceAccuracyGood'
  | 'ide.chat.voiceAccuracyBasic'
  | 'ide.chat.voiceEngineNative'
  | 'ide.chat.voiceEngineOnDevice'
  | 'ide.chat.voiceEngineNoBrowserSupport'
  | 'ide.chat.voiceEngineNoLanguageSupport'
  | 'ide.chat.voiceEngineCurrent'
  | 'ide.chat.voiceLangsAll'
  ...
  | 'ide.chat.fastModeOn'
  | 'ide.chat.fastModeOff'
  | 'ide.chat.fastModeEnable'
  | 'ide.chat.fastModeDisable'
  ...
  | 'ide.chat.selectCommitModel'
  | 'ide.chat.selectCompactModel'
  ...
  | 'ide.chat.freeInPlan'
  | 'ide.chat.freeInExecute'
  | 'ide.chat.freeInCommit'
  | 'ide.chat.modeOnlyPlan'
  | 'ide.chat.modeOnlyExecute'
  ...
  | 'ide.chat.resetSoon'
  | 'ide.chat.resetUnderHour'
  | 'ide.chat.resetTomorrow'
  ...
  | 'ide.chat.scripts.runWithOptions'
  | 'ide.chat.scripts.required'
  | 'ide.chat.scripts.cancelRun'
  ...
  | 'ide.chat.share.loading'
  | 'ide.chat.share.none'
  | 'ide.chat.share.copyHint'
  | 'ide.chat.share.revoke'
  ...
  | 'ide.testsBar.notRun_one'
  | 'ide.testsBar.notRun_other'
  | 'ide.testsBar.counts'
  | 'ide.testsBar.running'
  | 'ide.testsBar.runningLast'
  | 'ide.testsBar.passing'
  | 'ide.testsBar.passingWithSkips'
  | 'ide.testsBar.failing'
  | 'ide.testsBar.stopped'
  | 'ide.testsBar.error'
  | 'ide.testsBar.passedLabel'
  | 'ide.testsBar.failedLabel'
  | 'ide.testsBar.skippedLabel'
  | 'ide.testsBar.remainingLabel'
  | 'ide.testsBar.currentFile'
  | 'ide.testsBar.open'
  | 'ide.testsBar.stop'
  | 'ide.chat.testsBarShown'
  | 'ide.chat.testsBarHidden'
  | 'ide.tests.cancelled'
  | 'ide.tests.listError'
  | 'ide.tests.runError'
