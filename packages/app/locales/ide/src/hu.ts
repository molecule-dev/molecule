...
export const hu: Partial<IdeTranslations> = {
  ...
  'ide.chat.queuedCount': '{{count}} sorban',
  ...
  'ide.chat.modelSet': 'Csevegési modell beállítva erre: {{name}}',
  ...
  'ide.contextMenu.deleteCount': 'Töröl {{count}} Tételek',
  ...
  'ide.preview.retryCount': 'Újrapróbálkozás {{count}}',
  ...
  'ide.chat.loopLimitReached': 'Elérte a maximumot {{max}} eszköz iterációk.',
  'ide.chat.maxLoopsSet': 'A szerszámok maximális száma beállítva erre: {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'legjobb pontosság',
  'ide.chat.voiceAccuracyGood': 'jó pontosság',
  'ide.chat.voiceAccuracyBasic': 'alap pontosság',
  'ide.chat.voiceEngineNative': 'böngészőbe épített',
  'ide.chat.voiceEngineOnDevice': 'az eszközön',
  'ide.chat.voiceEngineNoBrowserSupport': 'ebben a böngészőben nem érhető el',
  'ide.chat.voiceEngineNoLanguageSupport': 'a nyelvedhez nem érhető el',
  'ide.chat.voiceEngineCurrent': 'jelenlegi',
  'ide.chat.voiceLangsAll': 'minden nyelv',
  'ide.chat.voiceLangOnly': 'csak {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} nyelv',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Feldolgozás helye: {{region}} — kattintson a módosításhoz',
  'ide.chat.model.regionOnlyHint': 'Csak itt üzemel: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Feldolgozási régió',
  'ide.chat.models.colRegion': 'Régió',
  'ide.chat.modelInUseRegion': 'Most a következőt használja: {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} vonalak',
  'ide.toolCall.linesRemoved': '− {{count}} vonalak',
  'ide.toolCall.changesApplied': '{{count}} alkalmazott változtatások',
  'ide.tabs.close': 'Közeli {{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} tesztek',
  'ide.tests.run': 'Futtatás',
  'ide.tests.runAll': 'Minden futtatása',
  'ide.tests.runE2e': 'Az e2e futtatása',
  'ide.tests.runUnit': 'Egység futtatása',
  'ide.tests.runGroup': 'Futócsoport',
  'ide.tests.stop': 'Állj!',
  'ide.tests.running': 'Futás…',
  'ide.tests.passedCount': '{{count}} elfogadva',
  'ide.tests.failedCount': '{{count}} sikertelen',
  'ide.tests.statusPassed': 'Elfogadva',
  'ide.tests.statusFailed': 'Sikertelen',
  'ide.tests.statusSkipped': 'Kihagyva',
  'ide.tests.kind.e2e': 'Végpontok közötti',
  'ide.tests.kind.unit': 'Egység',
  ...
  'ide.tests.cancelled': 'A futás leállt.',
  'ide.tests.listError': 'Nem sikerült felsorolni a projekt tesztjeit.',
