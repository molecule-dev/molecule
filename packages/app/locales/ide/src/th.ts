...
export const th: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'ไฟล์มีขนาดใหญ่เกินไป ขนาดสูงสุดคือ {{maxSize}} เอ็มบี.',
  'ide.chat.modelSet': 'ตั้งค่าโมเดลแชทเป็น {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} ไฟล์ที่ยังไม่ได้บันทึก',
  ...
  'ide.contextMenu.deleteCount': 'ลบ {{count}} รายการ',
  ...
  'ide.preview.retryCount': 'ลองใหม่อีกครั้ง {{count}}',
  ...
  'ide.toolCall.newFileLines': 'ไฟล์ใหม่ {{count}} เส้น',
  ...
  'ide.toolCall.andMore': '… และ {{count}} มากกว่า',
  ...
  'ide.toolCall.matchCount': '{{count}} การแข่งขัน',
  ...
  'ide.chat.loopLimitReached': 'ถึงระดับสูงสุดแล้ว {{max}} การปรับปรุงเครื่องมือ',
  'ide.chat.maxLoopsSet': 'จำนวนการวนซ้ำของเครื่องมือสูงสุดถูกตั้งค่าเป็น {{n}}',
  ...
  'ide.chat.voiceEngineTitle': 'เอนจินป้อนตามคำบอก',
  'ide.chat.voiceEnginePrivacy': 'ทุกตัวเลือกทำงานบนอุปกรณ์ของคุณ — เสียงไม่เคยออกจากเบราว์เซอร์',
  'ide.chat.voiceEngineNoDownload': 'ไม่ต้องดาวน์โหลด',
  'ide.chat.voiceEngineDownload': 'ดาวน์โหลด ~{{mb}} MB จากนั้นแคชไว้',
  'ide.chat.voiceEngineDownloadRange': 'ดาวน์โหลด ~{{min}}–{{max}} MB จากนั้นแคชไว้',
  'ide.chat.voiceAccuracyBest': 'ความแม่นยำสูงสุด',
  'ide.chat.voiceAccuracyGood': 'ความแม่นยำดี',
  'ide.chat.voiceAccuracyBasic': 'ความแม่นยำพื้นฐาน',
  'ide.chat.voiceEngineNative': 'ในตัวเบราว์เซอร์',
  'ide.chat.voiceEngineOnDevice': 'บนอุปกรณ์',
  'ide.chat.voiceEngineNoBrowserSupport': 'ใช้ไม่ได้ในเบราว์เซอร์นี้',
  'ide.chat.voiceEngineNoLanguageSupport': 'ใช้ไม่ได้กับภาษาของคุณ',
  'ide.chat.voiceEngineCurrent': 'ปัจจุบัน',
  'ide.chat.voiceLangsAll': 'ทุกภาษา',
  'ide.chat.voiceLangOnly': '{{language}} เท่านั้น',
  'ide.chat.voiceLangsCount': '{{count}} ภาษา',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'ประมวลผลใน: {{region}} — คลิกเพื่อเปลี่ยน',
  'ide.chat.model.regionOnlyHint': 'โฮสต์เฉพาะใน: {{region}}',
  'ide.chat.model.regionMenuLabel': 'ภูมิภาคการประมวลผล',
  'ide.chat.models.colRegion': 'ภูมิภาค',
  'ide.chat.modelInUseRegion': 'ตอนนี้ใช้ {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} เส้น',
  'ide.toolCall.linesRemoved': '− {{count}} เส้น',
  'ide.toolCall.changesApplied': '{{count}} การเปลี่ยนแปลงที่นำมาใช้',
  ...
  'ide.tests.testCount': '{{count}} การทดสอบ',
  'ide.tests.run': 'วิ่ง',
  'ide.tests.runAll': 'เรียกใช้งานทั้งหมด',
  'ide.tests.runE2e': 'รัน e2e',
  'ide.tests.runUnit': 'หน่วยการทำงาน',
  'ide.tests.runGroup': 'กลุ่มวิ่ง',
  'ide.tests.stop': 'หยุด',
  'ide.tests.running': 'วิ่ง…',
  'ide.tests.passedCount': '{{count}} ผ่าน',
  'ide.tests.failedCount': '{{count}} ล้มเหลว',
  'ide.tests.statusPassed': 'ผ่านแล้ว',
  'ide.tests.statusFailed': 'ล้มเหลว',
  'ide.tests.statusSkipped': 'ข้ามไป',
  'ide.tests.kind.e2e': 'ครบวงจร',
  'ide.tests.kind.unit': 'หน่วย',
  ...
  'ide.tests.cancelled': 'การวิ่งหยุดลงแล้ว',
  'ide.tests.listError': 'ไม่สามารถแสดงรายการการทดสอบของโครงการนี้ได้',
