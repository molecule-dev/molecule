...
export const bg: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileCount': '{{count}} файлове',
  'common.cancel': 'Отказ',
  ...
  'ide.chat.fileTooLarge': 'Файлът е твърде голям. Максималният размер е {{maxSize}} МБ.',
  'ide.chat.modelSet': 'Моделът на чата е зададен на {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} некоммитирани файлове',
  ...
  'ide.contextMenu.deleteCount': 'Изтриване {{count}} Елементи',
  ...
  'ide.preview.retryCount': 'Опит за повторен опит {{count}}',
  ...
  'ide.toolCall.newFileLines': 'нов файл, {{count}} линии',
  ...
  'ide.toolCall.andMore': '... и {{count}} повече',
  ...
  'ide.toolCall.matchCount': '{{count}} мачове',
  'ide.toolCall.fileCount': '{{count}} файлове',
  ...
  'ide.chat.you': 'Ти',
  'ide.chat.itemRenderError': 'Това съобщение не можа да бъде показано.',
  ...
  'ide.chat.loopLimitReached': 'Достигна максимума на {{max}} итерации на инструмента.',
  'ide.chat.maxLoopsSet': 'Максималният брой итерации на инструмента е зададен на {{n}}',
  ...
  'ide.chat.voice': 'Глас',
  'ide.chat.voiceUnavailable': 'Диктовката не е налична в този браузър.',
  'ide.chat.voiceMicBlocked': 'Достъпът до микрофона е блокиран.',
  ...
  'ide.chat.voiceAccuracyBest': 'най-добра точност',
  'ide.chat.voiceAccuracyGood': 'добра точност',
  'ide.chat.voiceAccuracyBasic': 'основна точност',
  'ide.chat.voiceEngineNative': 'вграден в браузъра',
  'ide.chat.voiceEngineOnDevice': 'на устройството',
  'ide.chat.voiceEngineNoBrowserSupport': 'недостъпно в този браузър',
  'ide.chat.voiceEngineNoLanguageSupport': 'недостъпно за вашия език',
  'ide.chat.voiceEngineCurrent': 'текущ',
  'ide.chat.voiceLangsAll': 'всички езици',
  'ide.chat.voiceLangOnly': 'само {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} езика',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Обработва се в: {{region}} — щракнете за промяна',
  'ide.chat.model.regionOnlyHint': 'Хоства се само в: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Регион на обработка',
  'ide.chat.models.colRegion': 'Регион',
  'ide.chat.modelInUseRegion': 'Сега се използва {{model}} ({{region}})',
  ...
  'ide.toolCall.changesApplied': '{{count}} приложени промени',
  ...
  'ide.tests.testCount': '{{count}} тестове',
  'ide.tests.run': 'Стартирай',
  'ide.tests.runAll': 'Изпълни всички',
  'ide.tests.runE2e': 'Изпълни e2e',
  'ide.tests.runUnit': 'Изпълни модул',
  'ide.tests.runGroup': 'Група за бягане',
  'ide.tests.stop': 'Спри',
  'ide.tests.running': 'Тичане…',
  'ide.tests.passedCount': '{{count}} приет',
  'ide.tests.failedCount': '{{count}} неуспешен',
  'ide.tests.statusPassed': 'Прието',
  'ide.tests.statusFailed': 'Неуспешно',
  'ide.tests.statusSkipped': 'Пропуснато',
  'ide.tests.kind.e2e': 'От начало до край',
  ...
  'ide.tests.cancelled': 'Изпълнението беше преустановено.',
  'ide.tests.listError': 'Не беше възможно да се изброят тестовете за този проект.',
