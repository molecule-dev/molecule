...
export const mk: Partial<IdeTranslations> = {
  ...
  'ide.chat.queuedCount': '{{count}} во ред',
  ...
  'ide.chat.fileTooLarge': 'Датотеката е преголема. Максималната големина е {{maxSize}} МБ.',
  'ide.chat.modelSet': 'Моделот за разговор е поставен на {{name}}',
  ...
  'ide.contextMenu.deleteCount': 'Избриши {{count}} Предмети',
  ...
  'ide.preview.retryCount': 'Обид за повторен обид {{count}}',
  ...
  'ide.toolCall.andMore': '… и {{count}} повеќе',
  ...
  'ide.chat.loopLimitReached': 'Достигна максимум од {{max}} итерации на алатки.',
  'ide.chat.maxLoopsSet': 'Максималниот број на итерации на алатката е поставен на {{n}}',
  ...
  'ide.chat.voice': 'Глас',
  'ide.chat.voiceUnavailable': 'Диктирањето не е достапно во овој прелистувач.',
  'ide.chat.voiceMicBlocked': 'Пристапот до микрофонот е блокиран.',
  ...
  'ide.chat.voiceAccuracyBest': 'најдобра точност',
  'ide.chat.voiceAccuracyGood': 'добра точност',
  'ide.chat.voiceAccuracyBasic': 'основна точност',
  'ide.chat.voiceEngineNative': 'вградено во прелистувачот',
  'ide.chat.voiceEngineOnDevice': 'на уредот',
  'ide.chat.voiceEngineNoBrowserSupport': 'недостапно во овој прелистувач',
  'ide.chat.voiceEngineNoLanguageSupport': 'недостапно за вашиот јазик',
  'ide.chat.voiceEngineCurrent': 'тековно',
  'ide.chat.voiceLangsAll': 'сите јазици',
  'ide.chat.voiceLangOnly': 'само {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} јазици',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Се обработува во: {{region}} — кликнете за промена',
  'ide.chat.model.regionOnlyHint': 'Хостирано само во: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Регион на обработка',
  'ide.chat.models.colRegion': 'Регион',
  'ide.chat.modelInUseRegion': 'Сега се користи {{model}} ({{region}})',
  ...
  'ide.tests.run': 'Стартувај',
  'ide.tests.runAll': 'Изврши ги сите',
  'ide.tests.runE2e': 'Стартувај e2e',
  'ide.tests.runUnit': 'Стартувај единица',
  'ide.tests.runGroup': 'Група за трчање',
  'ide.tests.stop': 'Стоп',
  'ide.tests.running': 'Трчање…',
  'ide.tests.passedCount': '{{count}} помина',
  'ide.tests.failedCount': '{{count}} неуспешен',
  'ide.tests.statusPassed': 'Поминато',
  'ide.tests.statusFailed': 'Неуспешно',
  'ide.tests.statusSkipped': 'Прескокнато',
  'ide.tests.kind.e2e': 'Крај до крај',
  'ide.tests.kind.unit': 'Единица',
  'ide.tests.workspace.app': 'Апликација',
  'ide.tests.workspace.api': 'АПИ',
  'ide.tests.workspace.root': 'Проект',
  'ide.tests.e2eHint': 'Овие се спротивни на прегледот во живо, затоа држете го прегледот отворен.',
  'ide.tests.showOutput': 'Прикажи излез',
  'ide.tests.hideOutput': 'Сокриј излез',
  ...
  'ide.tests.cancelled': 'Трчањето запре.',
  'ide.tests.listError': 'Не може да се наведат тестовите на овој проект.',
  'ide.tests.runError': 'Пробното извршување не можеше да започне.',
  'ide.tests.viewerCannotRun': 'Само уредниците можат да ги извршуваат тестовите на овој проект.',
  'ide.tests.needsSandbox': 'Стартувајте го проектот за да ги извршите неговите тестови.',
  'ide.tests.heading': 'Тестови',
  'ide.tests.searchPlaceholder': 'Тестови за филтрирање…',
  'ide.tests.loading': 'Се вчитуваат тестови…',
