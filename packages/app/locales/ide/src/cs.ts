...
export const cs: Partial<IdeTranslations> = {
  ...
  'ide.chat.queuedCount': '{{count}} ve frontě',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} nepotvrzené soubory',
  ...
  'ide.contextMenu.deleteCount': 'Vymazat {{count}} Položky',
  ...
  'ide.preview.retryCount': 'Opakovaný pokus {{count}}',
  ...
  'ide.toolCall.entryCount': '{{count}} záznamy',
  'ide.toolCall.matchCount': '{{count}} zápasy',
  ...
  'ide.chat.loopLimitReached': 'Dosáhl maxima {{max}} iterace nástrojů.',
  'ide.chat.maxLoopsSet': 'Maximální počet iterací nástroje nastaven na {{n}}',
  ...
  'ide.chat.voice': 'Hlas',
  'ide.chat.voiceUnavailable': 'Diktování není v tomto prohlížeči k dispozici.',
  'ide.chat.voiceMicBlocked': 'Přístup k mikrofonu je zablokován.',
  ...
  'ide.chat.voiceAccuracyBest': 'nejlepší přesnost',
  'ide.chat.voiceAccuracyGood': 'dobrá přesnost',
  'ide.chat.voiceAccuracyBasic': 'základní přesnost',
  'ide.chat.voiceEngineNative': 'vestavěné v prohlížeči',
  'ide.chat.voiceEngineOnDevice': 'na zařízení',
  'ide.chat.voiceEngineNoBrowserSupport': 'v tomto prohlížeči není k dispozici',
  'ide.chat.voiceEngineNoLanguageSupport': 'pro váš jazyk není k dispozici',
  'ide.chat.voiceEngineCurrent': 'aktuální',
  'ide.chat.voiceLangsAll': 'všechny jazyky',
  'ide.chat.voiceLangOnly': 'pouze {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} jazyků',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Zpracovává se v: {{region}} — kliknutím změníte',
  'ide.chat.model.regionOnlyHint': 'Hostováno pouze v: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Region zpracování',
  'ide.chat.models.colRegion': 'Region',
  'ide.chat.modelInUseRegion': 'Nyní se používá {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} čáry',
  'ide.toolCall.linesRemoved': '− {{count}} čáry',
  'ide.toolCall.changesApplied': '{{count}} použité změny',
  'ide.tabs.close': 'Blízko {{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} testy',
  'ide.tests.run': 'Spustit',
  'ide.tests.runAll': 'Spustit vše',
  'ide.tests.runE2e': 'Spustit e2e',
  'ide.tests.runUnit': 'Spustit jednotku',
  'ide.tests.runGroup': 'Běžecká skupina',
  'ide.tests.stop': 'Zastavit',
  'ide.tests.running': 'Běh…',
  'ide.tests.passedCount': '{{count}} schváleno',
  'ide.tests.failedCount': '{{count}} neúspěšný',
  'ide.tests.statusPassed': 'Splněno',
  'ide.tests.statusFailed': 'Neúspěšné',
  'ide.tests.statusSkipped': 'Přeskočeno',
  'ide.tests.kind.e2e': 'Od začátku do konce',
  'ide.tests.kind.unit': 'Jednotka',
  ...
  'ide.tests.cancelled': 'Běh byl zastaven.',
  'ide.tests.listError': 'Nepodařilo se vypsat testy tohoto projektu.',
