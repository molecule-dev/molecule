...
export const uz: Partial<IdeTranslations> = {
  ...
  'ide.chat.queuedCount': '{{count}} navbatda',
  ...
  'ide.chat.fileTooLarge': 'Fayl juda katta. Maksimal hajmi {{maxSize}} MB.',
  'ide.chat.modelSet': "Chat modeli o'rnatildi {{name}}",
  ...
  'ide.contextMenu.deleteCount': "O'chirish {{count}} Elementlar",
  ...
  'ide.preview.retryCount': 'Qayta urinish {{count}}',
  ...
  'ide.toolCall.newFileLines': 'yangi fayl, {{count}} chiziqlar',
  ...
  'ide.toolCall.andMore': "... va {{count}} Ko'proq",
  ...
  'ide.chat.loopLimitReached': 'Maksimal darajaga yetdi {{max}} vositalarning iteratsiyalari.',
  'ide.chat.maxLoopsSet': "Maksimal vosita iteratsiyalari o'rnatildi {{n}}",
  ...
  'ide.chat.voiceEngineTitle': 'Diktovka dvigateli',
  'ide.chat.voiceEnginePrivacy':
    'Har bir variant qurilmangizda ishlaydi — ovoz hech qachon brauzerdan chiqmaydi.',
  'ide.chat.voiceEngineNoDownload': 'yuklab olishsiz',
  'ide.chat.voiceEngineDownload': '~{{mb}} MB yuklab olish, keyin keshlanadi',
  'ide.chat.voiceEngineDownloadRange': '~{{min}}–{{max}} MB yuklab olish, keyin keshlanadi',
  'ide.chat.voiceAccuracyBest': 'eng yaxshi aniqlik',
  'ide.chat.voiceAccuracyGood': 'yaxshi aniqlik',
  'ide.chat.voiceAccuracyBasic': 'asosiy aniqlik',
  'ide.chat.voiceEngineNative': "brauzerga o'rnatilgan",
  'ide.chat.voiceEngineOnDevice': 'qurilmada',
  'ide.chat.voiceEngineNoBrowserSupport': 'bu brauzerda mavjud emas',
  'ide.chat.voiceEngineNoLanguageSupport': 'tilingiz uchun mavjud emas',
  'ide.chat.voiceEngineCurrent': 'joriy',
  'ide.chat.voiceLangsAll': 'barcha tillar',
  'ide.chat.voiceLangOnly': 'faqat {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} til',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': "Qayta ishlanadi: {{region}} — o'zgartirish uchun bosing",
  'ide.chat.model.regionOnlyHint': 'Faqat {{region}}da joylashtirilgan',
  'ide.chat.model.regionMenuLabel': 'Qayta ishlash hududi',
  'ide.chat.models.colRegion': 'Hudud',
  'ide.chat.modelInUseRegion': 'Hozir {{model}} ({{region}}) ishlatilmoqda',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} chiziqlar',
  'ide.toolCall.linesRemoved': '− {{count}} chiziqlar',
  'ide.toolCall.changesApplied': "{{count}} o'zgarishlar qo'llanildi",
  'ide.toolCall.applied': "Qo'llanilgan",
  'ide.tabs.close': 'Yopish {{fileName}}',
  ...
  'ide.chat.share.notAllowed':
    'Ulashish havolalarini boshqarish uchun bu loyihada admin roli kerak.',
  ...
  'ide.tests.testCount': '{{count}} sinovlar',
  'ide.tests.run': 'Yugurish',
  'ide.tests.runAll': 'Hammasini ishga tushiring',
  'ide.tests.runE2e': 'e2e ni ishga tushiring',
  'ide.tests.runUnit': 'Ishga tushirish bloki',
  'ide.tests.runGroup': 'Guruhni ishga tushirish',
  'ide.tests.stop': 'STOP',
  'ide.tests.running': 'Yugurmoqda…',
  'ide.tests.passedCount': "{{count}} o'tdi",
  'ide.tests.failedCount': '{{count}} muvaffaqiyatsiz',
  'ide.tests.statusPassed': "O'tdi",
  'ide.tests.statusFailed': 'Muvaffaqiyatsiz',
  'ide.tests.statusSkipped': "O'tkazib yuborildi",
  'ide.tests.kind.e2e': 'Boshidan oxirigacha',
  'ide.tests.kind.unit': 'Birlik',
  'ide.tests.workspace.app': 'Ilova',
  'ide.tests.workspace.api': 'API',
  'ide.tests.workspace.root': 'Loyiha',
  'ide.tests.e2eHint':
    "Bular jonli oldindan ko'rishga qarshi ishlaydi, shuning uchun oldindan ko'rishni ochiq qoldiring.",
  'ide.tests.showOutput': "Chiqishni ko'rsatish",
  'ide.tests.hideOutput': 'Chiqishni yashirish',
  ...
  'ide.tests.cancelled': "Yugurish to'xtatildi.",
  'ide.tests.listError': "Ushbu loyihaning sinovlarini sanab bo'lmadi.",
