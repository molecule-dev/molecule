...
export const sr: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileCount': '{{count}} датотеке',
  'common.cancel': 'Откажи',
  'common.save': 'Сачувај',
  'ide.chat.queued': 'У реду чекања',
  'ide.chat.queuedCount': '{{count}} у реду',
  ...
  'ide.chat.fileTooLarge': 'Датотека је превелика. Максимална величина је {{maxSize}} МБ.',
  'ide.chat.modelSet': 'Модел ћаскања подешен на {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} непотврђене датотеке',
  ...
  'ide.contextMenu.deleteCount': 'Обриши {{count}} Ставке',
  ...
  'ide.preview.retryCount': 'Поновни покушај {{count}}',
  ...
  'ide.toolCall.newFileLines': 'нова датотека, {{count}} линије',
  ...
  'ide.toolCall.andMore': '... и {{count}} више',
  ...
  'ide.toolCall.entryCount': '{{count}} уноси',
  'ide.toolCall.matchCount': '{{count}} утакмице',
  'ide.toolCall.fileCount': '{{count}} датотеке',
  ...
  'ide.chat.loopLimitReached': 'Достигнут је максимум од {{max}} итерације алата.',
  'ide.chat.maxLoopsSet': 'Максималан број итерација алата подешен на {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'најбоља тачност',
  'ide.chat.voiceAccuracyGood': 'добра тачност',
  'ide.chat.voiceAccuracyBasic': 'основна тачност',
  'ide.chat.voiceEngineNative': 'уграђено у прегледач',
  'ide.chat.voiceEngineOnDevice': 'на уређају',
  'ide.chat.voiceEngineNoBrowserSupport': 'није доступно у овом прегледачу',
  'ide.chat.voiceEngineNoLanguageSupport': 'није доступно за ваш језик',
  'ide.chat.voiceEngineCurrent': 'тренутно',
  'ide.chat.voiceLangsAll': 'сви језици',
  'ide.chat.voiceLangOnly': 'само {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} језика',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Обрађује се у: {{region}} — кликните да промените',
  'ide.chat.model.regionOnlyHint': 'Хостовано само у: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Регион обраде',
  'ide.chat.models.colRegion': 'Регион',
  'ide.chat.modelInUseRegion': 'Сада се користи {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} линије',
  'ide.toolCall.linesRemoved': '− {{count}} линије',
  'ide.toolCall.changesApplied': '{{count}} примењене промене',
  ...
  'ide.chat.fastModeOn': 'Брзи режим је укључен — бржи одговори већом брзином',
  'ide.chat.fastModeOff': 'Брзи режим је искључен',
  'ide.chat.fastModeEnable': 'Брзи режим — до 2,5× бржи излаз уз већу брзину токена',
  'ide.chat.fastModeDisable': 'Искључите брзи режим',
  ...
  'ide.tests.testCount': '{{count}} тестови',
  'ide.tests.run': 'Трчи',
  'ide.tests.runAll': 'Покрени све',
  'ide.tests.runE2e': 'Покрени е2е',
  'ide.tests.runUnit': 'Покрени јединицу',
  'ide.tests.runGroup': 'Група за трчање',
  'ide.tests.stop': 'Заустави',
  'ide.tests.running': 'Трчање…',
  'ide.tests.passedCount': '{{count}} прошао',
  'ide.tests.failedCount': '{{count}} неуспешно',
  'ide.tests.statusPassed': 'Прошао/ла',
  'ide.tests.statusFailed': 'Неуспешно',
  'ide.tests.statusSkipped': 'Прескочено',
  'ide.tests.kind.e2e': 'Од краја до краја',
  'ide.tests.kind.unit': 'Јединица',
  'ide.tests.workspace.app': 'Апликација',
  'ide.tests.workspace.api': 'API',
  'ide.tests.workspace.root': 'Пројекат',
  'ide.tests.e2eHint': 'Ови се покрећу против прегледа уживо, зато држите преглед отвореним.',
  'ide.tests.showOutput': 'Прикажи излаз',
  'ide.tests.hideOutput': 'Сакриј излаз',
  ...
  'ide.tests.cancelled': 'Трчање је заустављено.',
  'ide.tests.listError': 'Није могуће навести тестове овог пројекта.',
  'ide.tests.runError': 'Тестирање није могло да почне.',
  'ide.tests.viewerCannotRun': 'Само уредници могу да покрећу тестове овог пројекта.',
  'ide.tests.needsSandbox': 'Покрените пројекат да бисте покренули његове тестове.',
  'ide.tests.heading': 'Тестови',
  'ide.tests.searchPlaceholder': 'Тестови филтера…',
  'ide.tests.loading': 'Учитавање тестова…',
  ...
  'ide.chat.skipToolCall': 'Прескочи',
  'ide.chat.skippingToolCall': 'Прескакање…',
  'ide.chat.skipToolCallViewer': 'Само уредници могу ово прескочити.',
  'ide.toolCall.statusSkipped': 'Прескочено',
  'ide.tests.skip': 'Прескочи',
  'ide.tests.skipping': 'Прескакање…',
