...
export const ta: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'கோப்பு மிகவும் பெரியது. அதிகபட்ச அளவு {{maxSize}} MB.',
  'ide.chat.modelSet': 'அரட்டை மாதிரி அமைக்கப்பட்டது {{name}}',
  ...
  'ide.contextMenu.deleteCount': 'நீக்கு {{count}} பொருட்கள்',
  ...
  'ide.toolCall.newFileLines': 'புதிய கோப்பு, {{count}} கோடுகள்',
  ...
  'ide.chat.loopLimitReached': 'அதிகபட்சத்தை எட்டியது {{max}} கருவி மறுசெய்கைகள்.',
  'ide.chat.maxLoopsSet': 'அதிகபட்ச கருவி மறுசெயல்கள் அமைக்கப்பட்டுள்ளன {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'சிறந்த துல்லியம்',
  'ide.chat.voiceAccuracyGood': 'நல்ல துல்லியம்',
  'ide.chat.voiceAccuracyBasic': 'அடிப்படை துல்லியம்',
  'ide.chat.voiceEngineNative': 'உலாவியில் உள்ளமைந்த',
  'ide.chat.voiceEngineOnDevice': 'சாதனத்தில்',
  'ide.chat.voiceEngineNoBrowserSupport': 'இந்த உலாவியில் கிடைக்கவில்லை',
  'ide.chat.voiceEngineNoLanguageSupport': 'உங்கள் மொழிக்கு கிடைக்கவில்லை',
  'ide.chat.voiceEngineCurrent': 'தற்போதைய',
  'ide.chat.voiceLangsAll': 'அனைத்து மொழிகளும்',
  'ide.chat.voiceLangOnly': '{{language}} மட்டும்',
  'ide.chat.voiceLangsCount': '{{count}} மொழிகள்',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'செயலாக்கம்: {{region}} — மாற்ற கிளிக் செய்யவும்',
  'ide.chat.model.regionOnlyHint': '{{region}} இல் மட்டுமே ஹோஸ்ட் செய்யப்பட்டுள்ளது',
  'ide.chat.model.regionMenuLabel': 'செயலாக்கப் பகுதி',
  'ide.chat.models.colRegion': 'பகுதி',
  'ide.chat.modelInUseRegion': 'இப்போது {{model}} ({{region}}) பயன்பாட்டில் உள்ளது',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} கோடுகள்',
  'ide.toolCall.linesRemoved': '− {{count}} கோடுகள்',
  'ide.toolCall.changesApplied': '{{count}} மாற்றங்கள் பொருந்தும்',
  'ide.toolCall.applied': 'பயன்படுத்தப்பட்ட',
  'ide.tabs.close': 'அருகில் {{fileName}}',
  ...
  'ide.chat.fastModeOn': 'வேகப் பயன்முறை இயக்கத்தில் உள்ளது — அதிக வேகத்தில் பதில்கள் கிடைக்கும்',
  ...
  'ide.tests.testCount': '{{count}} சோதனைகள்',
  'ide.tests.run': 'ஓடு',
  'ide.tests.runAll': 'அனைத்தையும் இயக்கவும்',
  'ide.tests.runE2e': 'e2e-ஐ இயக்கவும்',
  'ide.tests.runUnit': 'இயக்க அலகு',
  'ide.tests.runGroup': 'ஓட்டக் குழு',
  'ide.tests.stop': 'நிறுத்து',
  'ide.tests.running': 'ஓடிக்கொண்டிருக்கிறது…',
  'ide.tests.passedCount': '{{count}} தேர்ச்சி பெற்றார்',
  'ide.tests.failedCount': '{{count}} தோல்வியுற்றது',
  'ide.tests.statusPassed': 'தேர்ச்சி பெற்றார்',
  'ide.tests.statusFailed': 'தோல்வியுற்றது',
  'ide.tests.statusSkipped': 'தவிர்க்கவும்',
  'ide.tests.kind.e2e': 'முழுமையான',
  'ide.tests.kind.unit': 'அலகு',
  ...
  'ide.tests.cancelled': 'ஓட்டம் நிறுத்தப்பட்டது.',
  'ide.tests.listError': 'இந்தத் திட்டத்தின் சோதனைகளைப் பட்டியலிட முடியவில்லை.',
