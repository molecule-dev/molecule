...
export const si: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'ගොනුව ඉතා විශාලයි. උපරිම ප්‍රමාණය {{maxSize}} එම්බී.',
  'ide.chat.modelSet': 'කතාබස් ආකෘතිය සකසා ඇත {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} කැප නොවූ ගොනු',
  ...
  'ide.contextMenu.deleteCount': 'මකන්න {{count}} අයිතම',
  ...
  'ide.preview.retryCount': 'නැවත උත්සාහ කිරීමේ උත්සාහය {{count}}',
  ...
  'ide.toolCall.newFileLines': 'නව ගොනුව, {{count}} රේඛා',
  ...
  'ide.toolCall.andMore': '… සහ {{count}} තව',
  ...
  'ide.toolCall.entryCount': '{{count}} ඇතුළත් කිරීම්',
  'ide.toolCall.matchCount': '{{count}} තරඟ',
  'ide.toolCall.fileCount': '{{count}} ගොනු',
  ...
  'ide.chat.loopLimitReached': 'උපරිමයට ළඟා විය {{max}} මෙවලම් පුනරාවර්තන.',
  'ide.chat.maxLoopsSet': 'උපරිම මෙවලම් පුනරාවර්තන සකසා ඇත {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'හොඳම නිරවද්‍යතාව',
  'ide.chat.voiceAccuracyGood': 'හොඳ නිරවද්‍යතාව',
  'ide.chat.voiceAccuracyBasic': 'මූලික නිරවද්‍යතාව',
  'ide.chat.voiceEngineNative': 'බ්‍රවුසර බිල්ට්',
  'ide.chat.voiceEngineOnDevice': 'උපාංගයේ',
  'ide.chat.voiceEngineNoBrowserSupport': 'මෙම බ්‍රවුසරයේ නොමැත',
  'ide.chat.voiceEngineNoLanguageSupport': 'ඔබේ භාෂාවට නොමැත',
  'ide.chat.voiceEngineCurrent': 'වත්මන්',
  'ide.chat.voiceLangsAll': 'සියලු භාෂා',
  'ide.chat.voiceLangOnly': '{{language}} පමණි',
  'ide.chat.voiceLangsCount': 'භාෂා {{count}}ක්',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'සැකසෙන්නේ: {{region}} — වෙනස් කිරීමට ක්ලික් කරන්න',
  'ide.chat.model.regionOnlyHint': '{{region}} හි පමණක් සත්කාරකත්වය දරයි',
  'ide.chat.model.regionMenuLabel': 'සැකසුම් කලාපය',
  'ide.chat.models.colRegion': 'කලාපය',
  'ide.chat.modelInUseRegion': 'දැන් {{model}} ({{region}}) භාවිතා වේ',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} රේඛා',
  'ide.toolCall.linesRemoved': '− {{count}} රේඛා',
  'ide.toolCall.changesApplied': '{{count}} වෙනස්කම් යොදන ලදී',
  'ide.toolCall.applied': 'අයදුම් කළා',
  'ide.tabs.close': 'වසන්න {{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} පරීක්ෂණ',
  'ide.tests.run': 'දුවන්න',
  'ide.tests.runAll': 'සියල්ල ධාවනය කරන්න',
  'ide.tests.runE2e': 'e2e ධාවනය කරන්න',
  'ide.tests.runUnit': 'ඒකකය ධාවනය කරන්න',
  'ide.tests.runGroup': 'කණ්ඩායම ධාවනය කරන්න',
  'ide.tests.stop': 'නවත්වන්න',
  'ide.tests.running': 'දුවමින්...',
  'ide.tests.passedCount': '{{count}} සමත් විය',
  'ide.tests.failedCount': '{{count}} අසාර්ථක විය',
  'ide.tests.statusPassed': 'සමත් විය',
  'ide.tests.statusFailed': 'අසාර්ථක විය',
  'ide.tests.statusSkipped': 'මඟ හැරුණි',
  'ide.tests.kind.e2e': 'අවසානයට අවසානය',
  'ide.tests.kind.unit': 'ඒකකය',
  'ide.tests.workspace.app': 'යෙදුම',
  'ide.tests.workspace.api': 'API',
  'ide.tests.workspace.root': 'ව්‍යාපෘතිය',
  'ide.tests.e2eHint': 'මේවා සජීවී පෙරදසුනට එරෙහිව ක්‍රියාත්මක වන බැවින්, පෙරදසුන විවෘතව තබන්න.',
  'ide.tests.showOutput': 'ප්‍රතිදානය පෙන්වන්න',
  'ide.tests.hideOutput': 'ප්‍රතිදානය සඟවන්න',
  ...
  'ide.tests.cancelled': 'ධාවනය නතර විය.',
  'ide.tests.listError': 'මෙම ව්‍යාපෘතියේ පරීක්ෂණ ලැයිස්තුගත කිරීමට නොහැකි විය.',
