...
export const mt: Partial<IdeTranslations> = {
  ...
  'ide.chat.modelSet': 'Mudell taċ-chat issettjat għal {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} fajls mhux impenjati',
  ...
  'ide.contextMenu.deleteCount': 'Ħassar {{count}} Oġġetti',
  ...
  'ide.preview.retryCount': 'Tentattiv mill-ġdid {{count}}',
  ...
  'ide.toolCall.andMore': '... u {{count}} aktar',
  ...
  'ide.toolCall.matchCount': '{{count}} logħbiet',
  ...
  'ide.chat.loopLimitReached': "Laħaq il-massimu ta' {{max}} iterazzjonijiet tal-għodda.",
  'ide.chat.maxLoopsSet': 'Iterazzjonijiet massimi tal-għodda ssettjati għal {{n}}',
  ...
  'ide.chat.voiceEngineTitle': 'Magna tad-dettatura',
  'ide.chat.voiceEnginePrivacy':
    'Kull għażla taħdem fuq it-tagħmir tiegħek — l-awdjo qatt ma jħalli l-browser.',
  'ide.chat.voiceEngineNoDownload': 'ebda tniżżil',
  'ide.chat.voiceEngineDownload': 'tniżżil ta’ ~{{mb}} MB, imbagħad fil-cache',
  'ide.chat.voiceEngineDownloadRange': 'tniżżil ta’ ~{{min}}–{{max}} MB, imbagħad fil-cache',
  'ide.chat.voiceAccuracyBest': 'l-aqwa preċiżjoni',
  'ide.chat.voiceAccuracyGood': 'preċiżjoni tajba',
  'ide.chat.voiceAccuracyBasic': 'preċiżjoni bażika',
  'ide.chat.voiceEngineNative': 'nattiv tal-browser',
  'ide.chat.voiceEngineOnDevice': 'fuq it-tagħmir',
  'ide.chat.voiceEngineNoBrowserSupport': 'mhux disponibbli f’dan il-browser',
  'ide.chat.voiceEngineNoLanguageSupport': 'mhux disponibbli għal-lingwa tiegħek',
  'ide.chat.voiceEngineCurrent': 'kurrenti',
  'ide.chat.voiceLangsAll': 'il-lingwi kollha',
  'ide.chat.voiceLangOnly': '{{language}} biss',
  'ide.chat.voiceLangsCount': '{{count}} lingwa',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Ipproċessat fi: {{region}} — ikklikkja biex tibdel',
  'ide.chat.model.regionOnlyHint': 'Ospitat biss fi: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Reġjun tal-ipproċessar',
  'ide.chat.models.colRegion': 'Reġjun',
  'ide.chat.modelInUseRegion': 'Issa qed juża {{model}} ({{region}})',
  ...
  'ide.chat.share.notAllowed':
    'Il-ġestjoni tal-links tal-qsim teħtieġ rwol ta’ amministratur f’dan il-proġett.',
  ...
  'ide.tests.testCount': '{{count}} testijiet',
  'ide.tests.run': 'Ġirja',
  'ide.tests.runAll': 'Mexxi kollox',
  'ide.tests.runE2e': 'Mexxi e2e',
  'ide.tests.runUnit': 'Unità tal-ġiri',
  'ide.tests.runGroup': "Grupp ta' tmexxija",
  'ide.tests.stop': 'Waqqaf',
  'ide.tests.running': 'Ġiri…',
  'ide.tests.passedCount': '{{count}} għadda',
  'ide.tests.failedCount': '{{count}} fallew',
  'ide.tests.statusPassed': 'Għadda',
  'ide.tests.statusFailed': 'Falla',
  'ide.tests.statusSkipped': 'Maqbuża',
  'ide.tests.kind.e2e': 'Minn tarf sa tarf',
  'ide.tests.kind.unit': 'Unità',
  'ide.tests.workspace.app': 'Applikazzjoni',
  'ide.tests.workspace.api': 'API',
  'ide.tests.workspace.root': 'Proġett',
  'ide.tests.e2eHint': 'Dawn jaħdmu kontra l-preview live, għalhekk żomm il-preview miftuħa.',
  'ide.tests.showOutput': 'Uri l-output',
  'ide.tests.hideOutput': 'Aħbi l-output',
  ...
  'ide.tests.cancelled': 'Il-ġirja waqfet.',
  'ide.tests.listError': "Ma setgħux jiġu elenkati t-testijiet ta' dan il-proġett.",
