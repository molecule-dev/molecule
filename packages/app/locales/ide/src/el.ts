...
export const el: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'Το αρχείο είναι πολύ μεγάλο. Το μέγιστο μέγεθος είναι {{maxSize}} ΜΒ.',
  'ide.chat.modelSet': 'Το μοντέλο συνομιλίας έχει οριστεί σε {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} μη δεσμευμένα αρχεία',
  ...
  'ide.contextMenu.deleteCount': 'Διαγράφω {{count}} Αντικείμενα',
  ...
  'ide.preview.retryCount': 'Επανάληψη προσπάθειας {{count}}',
  ...
  'ide.toolCall.andMore': '… και {{count}} περισσότερο',
  ...
  'ide.toolCall.entryCount': '{{count}} καταχωρήσεις',
  'ide.toolCall.matchCount': '{{count}} αγώνες',
  ...
  'ide.chat.loopLimitReached': 'Έφτασε στο μέγιστο των {{max}} επαναλήψεις εργαλείων.',
  'ide.chat.maxLoopsSet': 'Ο μέγιστος αριθμός επαναλήψεων εργαλείου έχει οριστεί σε {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'κορυφαία ακρίβεια',
  'ide.chat.voiceAccuracyGood': 'καλή ακρίβεια',
  'ide.chat.voiceAccuracyBasic': 'βασική ακρίβεια',
  'ide.chat.voiceEngineNative': 'εγγενές του browser',
  'ide.chat.voiceEngineOnDevice': 'στη συσκευή',
  'ide.chat.voiceEngineNoBrowserSupport': 'μη διαθέσιμο σε αυτό το πρόγραμμα περιήγησης',
  'ide.chat.voiceEngineNoLanguageSupport': 'μη διαθέσιμο για τη γλώσσα σας',
  'ide.chat.voiceEngineCurrent': 'τρέχον',
  'ide.chat.voiceLangsAll': 'όλες οι γλώσσες',
  'ide.chat.voiceLangOnly': 'μόνο {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} γλώσσες',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Επεξεργασία σε: {{region}} — κάντε κλικ για αλλαγή',
  'ide.chat.model.regionOnlyHint': 'Φιλοξενείται μόνο σε: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Περιοχή επεξεργασίας',
  'ide.chat.models.colRegion': 'Περιοχή',
  'ide.chat.modelInUseRegion': 'Τώρα χρησιμοποιείται το {{model}} ({{region}})',
  ...
  'ide.toolCall.changesApplied': '{{count}} εφαρμόστηκαν αλλαγές',
  'ide.tabs.close': 'Κοντά {{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} δοκιμές',
  'ide.tests.run': 'Εκτέλεση',
  'ide.tests.runAll': 'Εκτέλεση όλων',
  'ide.tests.runE2e': 'Εκτέλεση e2e',
  'ide.tests.runUnit': 'Εκτέλεση μονάδας',
  'ide.tests.runGroup': 'Ομάδα τρεξίματος',
  'ide.tests.stop': 'Σταμάτα',
  'ide.tests.running': 'Τρέξιμο…',
  'ide.tests.passedCount': '{{count}} εγκρίθηκε',
  'ide.tests.failedCount': '{{count}} απέτυχε',
  'ide.tests.statusPassed': 'Εγκρίθηκε',
  'ide.tests.statusFailed': 'Αποτυχία',
  'ide.tests.statusSkipped': 'Παραλείφθηκε',
  'ide.tests.kind.e2e': 'Από άκρο σε άκρο',
  'ide.tests.kind.unit': 'Μονάδα',
