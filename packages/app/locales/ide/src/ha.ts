...
export const ha: Partial<IdeTranslations> = {
  ...
  'ide.chat.voiceAccuracyBest': 'mafi kyawun daidaito',
  'ide.chat.voiceAccuracyGood': 'daidaito mai kyau',
  'ide.chat.voiceAccuracyBasic': 'daidaito na asali',
  'ide.chat.voiceEngineNative': 'na burauza',
  'ide.chat.voiceEngineOnDevice': 'a kan na’ura',
  'ide.chat.voiceEngineNoBrowserSupport': 'ba ya samuwa a wannan burauza',
  'ide.chat.voiceEngineNoLanguageSupport': 'ba ya samuwa ga harshenka',
  'ide.chat.voiceEngineCurrent': 'na yanzu',
  'ide.chat.voiceLangsAll': 'duk harsuna',
  'ide.chat.voiceLangOnly': '{{language}} kawai',
  'ide.chat.voiceLangsCount': 'harsuna {{count}}',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Ana sarrafawa a: {{region}} — danna don canzawa',
  'ide.chat.model.regionOnlyHint': 'Ana ɗaukar nauyi a {{region}} kawai',
  'ide.chat.model.regionMenuLabel': 'Yankin sarrafawa',
  'ide.chat.models.colRegion': 'Yanki',
  'ide.chat.modelInUseRegion': 'Yanzu ana amfani da {{model}} ({{region}})',
  ...
  'ide.tests.testCount': '{{count}} gwaje-gwaje',
  'ide.tests.run': 'Gudu',
  ...
  'ide.tests.passedCount': '{{count}} an wuce',
  'ide.tests.failedCount': '{{count}} ya gaza',
  'ide.tests.statusPassed': 'An wuce',
  'ide.tests.statusFailed': 'An kasa',
  'ide.tests.statusSkipped': 'An tsallake',
  'ide.tests.kind.e2e': 'Daga ƙarshe zuwa ƙarshe',
  'ide.tests.kind.unit': 'Naúrar',
  ...
  'ide.tests.cancelled': 'Gudu ya tsaya.',
  'ide.tests.listError': 'Ba zan iya lissafa gwaje-gwajen wannan aikin ba.',
