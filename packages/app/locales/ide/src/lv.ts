...
export const lv: Partial<IdeTranslations> = {
  ...
  'ide.chat.modelSet': 'Tērzēšanas modelis ir iestatīts uz {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} nesaistīti faili',
  ...
  'ide.contextMenu.deleteCount': 'Dzēst {{count}} Preces',
  ...
  'ide.preview.retryCount': 'Atkārtots mēģinājums {{count}}',
  ...
  'ide.toolCall.newFileLines': 'jauns fails, {{count}} līnijas',
  ...
  'ide.toolCall.andMore': '... un {{count}} vairāk',
  ...
  'ide.toolCall.matchCount': '{{count}} sērkociņi',
  ...
  'ide.chat.loopLimitReached': 'Sasniegts maksimums {{max}} rīku iterācijas.',
  'ide.chat.maxLoopsSet': 'Maksimālais rīku iterāciju skaits ir iestatīts uz {{n}}',
  ...
  'ide.chat.voiceEngineTitle': 'Diktēšanas dzinējs',
  'ide.chat.voiceEnginePrivacy': 'Katra opcija darbojas jūsu ierīcē — audio nekad nepamet pārlūku.',
  'ide.chat.voiceEngineNoDownload': 'bez lejupielādes',
  'ide.chat.voiceEngineDownload': '~{{mb}} MB lejupielāde, pēc tam kešatmiņā',
  'ide.chat.voiceEngineDownloadRange': '~{{min}}–{{max}} MB lejupielāde, pēc tam kešatmiņā',
  'ide.chat.voiceAccuracyBest': 'labākā precizitāte',
  'ide.chat.voiceAccuracyGood': 'laba precizitāte',
  'ide.chat.voiceAccuracyBasic': 'pamata precizitāte',
  'ide.chat.voiceEngineNative': 'pārlūkā iebūvēts',
  'ide.chat.voiceEngineOnDevice': 'ierīcē',
  'ide.chat.voiceEngineNoBrowserSupport': 'nav pieejams šajā pārlūkā',
  'ide.chat.voiceEngineNoLanguageSupport': 'nav pieejams jūsu valodai',
  'ide.chat.voiceEngineCurrent': 'pašreizējais',
  'ide.chat.voiceLangsAll': 'visas valodas',
  'ide.chat.voiceLangOnly': 'tikai {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} valodas',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Apstrādā: {{region}} — noklikšķiniet, lai mainītu',
  'ide.chat.model.regionOnlyHint': 'Mitināts tikai: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Apstrādes reģions',
  'ide.chat.models.colRegion': 'Reģions',
  'ide.chat.modelInUseRegion': 'Tagad tiek izmantots {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} līnijas',
  'ide.toolCall.linesRemoved': '− {{count}} līnijas',
  'ide.toolCall.changesApplied': '{{count}} izmaiņas lietotas',
  ...
  'ide.tests.testCount': '{{count}} testi',
  'ide.tests.run': 'Sākt',
  'ide.tests.runAll': 'Palaist visas',
  'ide.tests.runE2e': 'Palaist e2e',
  'ide.tests.runUnit': 'Palaist vienību',
  'ide.tests.runGroup': 'Skriešanas grupa',
  'ide.tests.stop': 'Apstāties',
  'ide.tests.running': 'Skrienot…',
  'ide.tests.passedCount': '{{count}} pieņemts',
  'ide.tests.failedCount': '{{count}} neizdevās',
  'ide.tests.statusPassed': 'Apstiprināts',
  'ide.tests.statusFailed': 'Neizdevās',
  'ide.tests.statusSkipped': 'Izlaists',
  'ide.tests.kind.e2e': 'No sākuma līdz galam',
  'ide.tests.kind.unit': 'Vienība',
  ...
  'ide.tests.cancelled': 'Skriešana ir pārtraukta.',
  'ide.tests.listError': 'Neizdevās uzskaitīt šī projekta testus.',
