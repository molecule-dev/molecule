...
export const id: Partial<IdeTranslations> = {
  ...
  'ide.chat.queuedCount': '{{count}} dalam antrean',
  ...
  'ide.chat.fileTooLarge': 'Ukuran file terlalu besar. Ukuran maksimum adalah {{maxSize}} MB.',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} berkas yang belum dikomit',
  ...
  'ide.contextMenu.deleteCount': 'Menghapus {{count}} Barang-barang',
  ...
  'ide.toolCall.newFileLines': 'berkas baru, {{count}} garis',
  ...
  'ide.chat.loopLimitReached': 'Mencapai nilai maksimum {{max}} iterasi alat.',
  'ide.chat.maxLoopsSet': 'Jumlah iterasi alat maksimum diatur ke {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'akurasi terbaik',
  'ide.chat.voiceAccuracyGood': 'akurasi baik',
  'ide.chat.voiceAccuracyBasic': 'akurasi dasar',
  'ide.chat.voiceEngineNative': 'bawaan browser',
  'ide.chat.voiceEngineOnDevice': 'di perangkat',
  'ide.chat.voiceEngineNoBrowserSupport': 'tidak tersedia di browser ini',
  'ide.chat.voiceEngineNoLanguageSupport': 'tidak tersedia untuk bahasa Anda',
  'ide.chat.voiceEngineCurrent': 'saat ini',
  'ide.chat.voiceLangsAll': 'semua bahasa',
  'ide.chat.voiceLangOnly': 'hanya {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} bahasa',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Diproses di: {{region}} — klik untuk mengubah',
  'ide.chat.model.regionOnlyHint': 'Hanya dihosting di: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Wilayah pemrosesan',
  'ide.chat.models.colRegion': 'Wilayah',
  'ide.chat.modelInUseRegion': 'Sekarang menggunakan {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} garis',
  'ide.toolCall.linesRemoved': '− {{count}} garis',
  'ide.toolCall.changesApplied': '{{count}} perubahan yang diterapkan',
  'ide.tabs.close': 'Menutup {{fileName}}',
  ...
  'ide.chat.streaming.thinking': 'Sedang berpikir...',
  'ide.chat.streaming.analyzing': 'Sedang menganalisis...',
  'ide.chat.streaming.reasoning': 'Berpikir...',
  'ide.chat.streaming.crafting': 'Sedang menyusun tanggapan...',
  'ide.chat.streaming.working': 'Sedang mengerjakannya...',
  'ide.chat.streaming.processing': 'Sedang diproses...',
  'ide.chat.streaming.connecting': 'Menghubungkan titik-titik...',
  'ide.chat.streaming.almostThere': 'Sudah hampir sampai...',
  'ide.chat.help.card.heading': 'Bantuan',
  'ide.chat.help.card.commandsTitle': 'Perintah',
  'ide.chat.help.card.modesTitle': 'Mode',
  ...
  'ide.tests.testCount': '{{count}} ujian',
  'ide.tests.run': 'Lari',
  'ide.tests.runAll': 'Jalankan semuanya',
  'ide.tests.runE2e': 'Jalankan e2e',
  'ide.tests.runUnit': 'Jalankan unit',
  'ide.tests.runGroup': 'Kelompok lari',
  'ide.tests.stop': 'Berhenti',
  'ide.tests.running': 'Berlari…',
  'ide.tests.passedCount': '{{count}} telah disahkan',
  'ide.tests.failedCount': '{{count}} gagal',
  'ide.tests.statusPassed': 'Lulus',
  'ide.tests.statusFailed': 'Gagal',
  'ide.tests.statusSkipped': 'Dilewati',
  'ide.tests.kind.e2e': 'Ujung ke ujung',
  'ide.tests.kind.unit': 'Unit',
  ...
  'ide.tests.cancelled': 'Lari dihentikan.',
  'ide.tests.listError': 'Tidak dapat menampilkan daftar pengujian proyek ini.',
