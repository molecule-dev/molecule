...
export const ky: Partial<IdeTranslations> = {
  ...
  'ide.chat.voiceAccuracyBest': 'эң мыкты тактык',
  'ide.chat.voiceAccuracyGood': 'жакшы тактык',
  'ide.chat.voiceAccuracyBasic': 'негизги тактык',
  'ide.chat.voiceEngineNative': 'браузерге орнотулган',
  'ide.chat.voiceEngineOnDevice': 'түзмөктө',
  'ide.chat.voiceEngineNoBrowserSupport': 'бул браузерде жеткиликтүү эмес',
  'ide.chat.voiceEngineNoLanguageSupport': 'тилиңиз үчүн жеткиликтүү эмес',
  'ide.chat.voiceEngineCurrent': 'учурдагы',
  'ide.chat.voiceLangsAll': 'бардык тилдер',
  'ide.chat.voiceLangOnly': 'жалгыз {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} тил',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Иштетилет: {{region}} — өзгөртүү үчүн басыңыз',
  'ide.chat.model.regionOnlyHint': 'Жайгашкан жери: {{region}} гана',
  'ide.chat.model.regionMenuLabel': 'Иштетүү аймагы',
  'ide.chat.models.colRegion': 'Аймак',
  'ide.chat.modelInUseRegion': 'Азыр {{model}} ({{region}}) колдонулууда',
  ...
  'ide.tests.running': 'Иштеп жатат…',
  'ide.tests.passedCount': '{{count}} өттү',
  'ide.tests.failedCount': '{{count}} ийгиликсиз болду',
  'ide.tests.statusPassed': 'Өтүп кетти',
  'ide.tests.statusFailed': 'Ийгиликсиз болду',
  'ide.tests.statusSkipped': 'Өткөрүп жиберилди',
  'ide.tests.kind.e2e': 'Башынан аягына чейин',
  'ide.tests.kind.unit': 'Бирдик',
  ...
  'ide.tests.cancelled': 'Чуркоо токтотулду.',
  'ide.tests.listError': 'Бул долбоордун сыноолорун тизмектеп чыгуу мүмкүн болгон жок.',
