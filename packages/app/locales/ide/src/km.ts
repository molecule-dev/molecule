...
export const km: Partial<IdeTranslations> = {
  ...
  'ide.chat.uncommittedFileCount': '{{count}} ឯកសារដែលមិនទាន់បានប្តេជ្ញាចិត្ត',
  ...
  'ide.contextMenu.deleteCount': 'លុប {{count}} វត្ថុ',
  ...
  'ide.preview.retryCount': 'ព្យាយាមម្តងទៀត {{count}}',
  ...
  'ide.toolCall.andMore': '... និង {{count}} ច្រើនទៀត',
  ...
  'ide.toolCall.entryCount': '{{count}} ធាតុចូល',
  'ide.toolCall.matchCount': '{{count}} ការប្រកួត',
  ...
  'ide.chat.loopLimitReached': 'បានឈានដល់កម្រិតអតិបរមា {{max}} ការធ្វើឡើងវិញនៃឧបករណ៍។',
  'ide.chat.maxLoopsSet': 'កំណត់ចំនួនឧបករណ៍អតិបរមាទៅ {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'ភាពត្រឹមត្រូវល្អបំផុត',
  'ide.chat.voiceAccuracyGood': 'ភាពត្រឹមត្រូវល្អ',
  'ide.chat.voiceAccuracyBasic': 'ភាពត្រឹមត្រូវមូលដ្ឋាន',
  'ide.chat.voiceEngineNative': 'ភ្ជាប់មកជាមួយកម្មវិធីរុករក',
  'ide.chat.voiceEngineOnDevice': 'នៅលើឧបករណ៍',
  'ide.chat.voiceEngineNoBrowserSupport': 'មិនអាចប្រើបានក្នុងកម្មវិធីរុករកនេះ',
  'ide.chat.voiceEngineNoLanguageSupport': 'មិនអាចប្រើបានសម្រាប់ភាសារបស់អ្នក',
  'ide.chat.voiceEngineCurrent': 'បច្ចុប្បន្ន',
  'ide.chat.voiceLangsAll': 'គ្រប់ភាសា',
  'ide.chat.voiceLangOnly': 'តែ {{language}} ប៉ុណ្ណោះ',
  'ide.chat.voiceLangsCount': '{{count}} ភាសា',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'ដំណើរការនៅ៖ {{region}} — ចុចដើម្បីផ្លាស់ប្តូរ',
  'ide.chat.model.regionOnlyHint': 'បង្ហោះតែនៅ៖ {{region}} ប៉ុណ្ណោះ',
  'ide.chat.model.regionMenuLabel': 'តំបន់ដំណើរការ',
  'ide.chat.models.colRegion': 'តំបន់',
  'ide.chat.modelInUseRegion': 'ឥឡូវកំពុងប្រើ {{model}} ({{region}})',
  ...
  'ide.tests.testCount': '{{count}} ការធ្វើតេស្ត',
  'ide.tests.run': 'រត់',
  'ide.tests.runAll': 'ដំណើរការទាំងអស់',
  'ide.tests.runE2e': 'ដំណើរការ e2e',
  'ide.tests.runUnit': 'ឯកតាដំណើរការ',
  'ide.tests.runGroup': 'ក្រុមរត់',
  'ide.tests.stop': 'ឈប់',
  'ide.tests.running': 'កំពុងរត់…',
  'ide.tests.passedCount': '{{count}} បានប្រឡងជាប់',
  'ide.tests.failedCount': '{{count}} បរាជ័យ',
  'ide.tests.statusPassed': 'បានប្រឡងជាប់',
  'ide.tests.statusFailed': 'បរាជ័យ',
  'ide.tests.statusSkipped': 'បានរំលង',
  'ide.tests.kind.e2e': 'ចាប់ពីដើមដល់ចប់',
  'ide.tests.kind.unit': 'ឯកតា',
  ...
  'ide.tests.cancelled': 'ការរត់បានឈប់។',
  'ide.tests.listError': 'មិនអាចរាយបញ្ជីការធ្វើតេស្តរបស់គម្រោងនេះបានទេ។',
