...
export const kk: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'Файл тым үлкен. Максималды өлшемі {{maxSize}} МБ.',
  'ide.chat.modelSet': 'Чат моделі орнатылған {{name}}',
  ...
  'ide.contextMenu.deleteCount': 'Жою {{count}} Заттар',
  ...
  'ide.preview.retryCount': 'Қайталап көру {{count}}',
  ...
  'ide.toolCall.newFileLines': 'жаңа файл, {{count}} сызықтар',
  ...
  'ide.toolCall.andMore': '... және {{count}} көбірек',
  ...
  'ide.chat.loopLimitReached': 'Ең жоғары шегіне жетті {{max}} құралдардың итерациялары.',
  'ide.chat.maxLoopsSet': 'Құралдың максималды итерациясы орнатылған {{n}}',
  ...
  'ide.chat.voiceAccuracyBest': 'ең жақсы дәлдік',
  'ide.chat.voiceAccuracyGood': 'жақсы дәлдік',
  'ide.chat.voiceAccuracyBasic': 'негізгі дәлдік',
  'ide.chat.voiceEngineNative': 'браузерге кірістірілген',
  'ide.chat.voiceEngineOnDevice': 'құрылғыда',
  'ide.chat.voiceEngineNoBrowserSupport': 'бұл браузерде қолжетімсіз',
  'ide.chat.voiceEngineNoLanguageSupport': 'тіліңіз үшін қолжетімсіз',
  'ide.chat.voiceEngineCurrent': 'ағымдағы',
  'ide.chat.voiceLangsAll': 'барлық тілдер',
  'ide.chat.voiceLangOnly': 'тек {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} тіл',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Өңделеді: {{region}} — өзгерту үшін басыңыз',
  'ide.chat.model.regionOnlyHint': 'Тек мына жерде орналасқан: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Өңдеу аймағы',
  'ide.chat.models.colRegion': 'Аймақ',
  'ide.chat.modelInUseRegion': 'Қазір {{model}} ({{region}}) қолданылуда',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} сызықтар',
  'ide.toolCall.linesRemoved': '− {{count}} сызықтар',
  'ide.toolCall.changesApplied': '{{count}} өзгерістер қолданылды',
  'ide.toolCall.applied': 'Қолданылған',
  'ide.tabs.close': 'Жабу {{fileName}}',
  ...
  'ide.tests.testCount': '{{count}} сынақтар',
  'ide.tests.run': 'Жүгіру',
  'ide.tests.runAll': 'Барлығын іске қосыңыз',
  'ide.tests.runE2e': 'e2e іске қосыңыз',
  'ide.tests.runUnit': 'Іске қосу блогы',
  'ide.tests.runGroup': 'Топты іске қосу',
  'ide.tests.stop': 'Тоқта',
  'ide.tests.running': 'Жүгіруде…',
  'ide.tests.passedCount': '{{count}} өтті',
  'ide.tests.failedCount': '{{count}} сәтсіз аяқталды',
  'ide.tests.statusPassed': 'Өтті',
  'ide.tests.statusFailed': 'Сәтсіз аяқталды',
  'ide.tests.statusSkipped': 'Өткізіп жіберілді',
  'ide.tests.kind.e2e': 'Бастан аяғына дейін',
  'ide.tests.kind.unit': 'Бірлік',
  ...
  'ide.tests.cancelled': 'Жүгіру тоқтатылды.',
  'ide.tests.listError': 'Бұл жобаның сынақтарын тізімдеу мүмкін болмады.',
  ...
  'ide.chat.skipToolCall': 'Өткізіп жіберу',
  'ide.chat.skippingToolCall': 'Өткізіп жіберу…',
  'ide.chat.skipToolCallViewer': 'Мұны тек редакторлар ғана өткізіп жібере алады.',
  'ide.toolCall.statusSkipped': 'Өткізіп жіберілді',
  'ide.tests.skip': 'Өткізіп жіберу',
  'ide.tests.skipping': 'Өткізіп жіберу…',
