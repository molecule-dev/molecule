...
export const sk: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileCount': '{{count}} súbory',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} nepotvrdené súbory',
  ...
  'ide.contextMenu.deleteCount': 'Odstrániť {{count}} Položky',
  ...
  'ide.preview.retryCount': 'Pokus o opakovanie {{count}}',
  ...
  'ide.toolCall.newFileLines': 'nový súbor, {{count}} čiary',
  ...
  'ide.toolCall.andMore': '... a {{count}} viac',
  ...
  'ide.toolCall.fileCount': '{{count}} súbory',
  ...
  'ide.chat.loopLimitReached': 'Dosiahol maximum {{max}} iterácie nástroja.',
  'ide.chat.maxLoopsSet': 'Maximálny počet iterácií nástroja nastavený na {{n}}',
  ...
  'ide.chat.voiceEngineNative': 'vstavané v prehliadači',
  'ide.chat.voiceEngineOnDevice': 'na zariadení',
  'ide.chat.voiceEngineNoBrowserSupport': 'v tomto prehliadači nie je k dispozícii',
  'ide.chat.voiceEngineNoLanguageSupport': 'pre váš jazyk nie je k dispozícii',
  'ide.chat.voiceEngineCurrent': 'aktuálny',
  'ide.chat.voiceLangsAll': 'všetky jazyky',
  'ide.chat.voiceLangOnly': 'iba {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} jazykov',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Spracováva sa v: {{region}} — kliknutím zmeníte',
  'ide.chat.model.regionOnlyHint': 'Hostované iba v: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Región spracovania',
  'ide.chat.models.colRegion': 'Región',
  'ide.chat.modelInUseRegion': 'Teraz sa používa {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} čiary',
  'ide.toolCall.linesRemoved': '− {{count}} čiary',
  'ide.toolCall.changesApplied': '{{count}} použité zmeny',
  'ide.toolCall.applied': 'Použité',
  'ide.tabs.close': 'Zatvoriť {{fileName}}',
  ...
  'ide.tests.run': 'Spustiť',
  'ide.tests.runAll': 'Spustiť všetko',
  'ide.tests.runE2e': 'Spustiť e2e',
  'ide.tests.runUnit': 'Spustiť jednotku',
  'ide.tests.runGroup': 'Bežecká skupina',
  'ide.tests.stop': 'Zastav',
  'ide.tests.running': 'Behám…',
  'ide.tests.passedCount': '{{count}} schválené',
  'ide.tests.failedCount': '{{count}} neúspešný',
  'ide.tests.statusPassed': 'Schválené',
  'ide.tests.statusFailed': 'Neúspešné',
  'ide.tests.statusSkipped': 'Preskočené',
  'ide.tests.kind.e2e': 'Od začiatku do konca',
  ...
  'ide.tests.cancelled': 'Beh sa zastavil.',
  'ide.tests.listError': 'Nepodarilo sa vygenerovať zoznam testov tohto projektu.',
