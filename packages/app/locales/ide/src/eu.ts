...
export const eu: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileCount': '{{count}} fitxategiak',
  'common.cancel': 'Utzi',
  'common.save': 'Gorde',
  ...
  'ide.chat.fileTooLarge': 'Fitxategia handiegia da. Gehienezko tamaina hau da: {{maxSize}} MB.',
  'ide.chat.modelSet': 'Txat eredua ezarrita {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} konprometitu gabeko fitxategiak',
  ...
  'ide.contextMenu.deleteCount': 'Ezabatu {{count}} Elementuak',
  ...
  'ide.preview.retryCount': 'Berriro saiatu {{count}}',
  ...
  'ide.toolCall.newFileLines': 'fitxategi berria, {{count}} lerroak',
  ...
  'ide.toolCall.entryCount': '{{count}} sarrerak',
  'ide.toolCall.matchCount': '{{count}} partidak',
  'ide.toolCall.fileCount': '{{count}} fitxategiak',
  ...
  'ide.chat.loopLimitReached': 'Gehienezkora iritsi da {{max}} tresnen iterazioak.',
  'ide.chat.maxLoopsSet': 'Tresna iterazio maximoak ezarrita {{n}}',
  ...
  'ide.chat.voiceEngineTitle': 'Diktaketa-motorra',
  'ide.chat.voiceEnginePrivacy':
    'Aukera bakoitza zure gailuan exekutatzen da — audioa ez da inoiz nabigatzailetik ateratzen.',
  'ide.chat.voiceEngineNoDownload': 'deskargarik ez',
  'ide.chat.voiceEngineDownload': '~{{mb}} MB-ko deskarga, gero cachean',
  'ide.chat.voiceEngineDownloadRange': '~{{min}}–{{max}} MB-ko deskarga, gero cachean',
  'ide.chat.voiceAccuracyBest': 'zehaztasun onena',
  'ide.chat.voiceAccuracyGood': 'zehaztasun ona',
  'ide.chat.voiceAccuracyBasic': 'oinarrizko zehaztasuna',
  'ide.chat.voiceEngineNative': 'nabigatzailearen berezkoa',
  'ide.chat.voiceEngineOnDevice': 'gailuan',
  'ide.chat.voiceEngineNoBrowserSupport': 'ez dago erabilgarri nabigatzaile honetan',
  'ide.chat.voiceEngineNoLanguageSupport': 'ez dago erabilgarri zure hizkuntzarako',
  'ide.chat.voiceEngineCurrent': 'unekoa',
  'ide.chat.voiceLangsAll': 'hizkuntza guztiak',
  'ide.chat.voiceLangOnly': '{{language}} soilik',
  'ide.chat.voiceLangsCount': '{{count}} hizkuntza',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Hemen prozesatzen da: {{region}} — egin klik aldatzeko',
  'ide.chat.model.regionOnlyHint': 'Hemen bakarrik ostatatua: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Prozesatze-eskualdea',
  'ide.chat.models.colRegion': 'Eskualdea',
  'ide.chat.modelInUseRegion': 'Orain {{model}} ({{region}}) erabiltzen ari da',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} lerroak',
  'ide.toolCall.linesRemoved': '− {{count}} lerroak',
  'ide.toolCall.changesApplied': '{{count}} aplikatutako aldaketak',
  ...
  'ide.chat.share.notAllowed':
    'Partekatzeko estekak kudeatzeko administratzaile-rola behar da proiektu honetan.',
  ...
  'ide.tests.testCount': '{{count}} probak',
  'ide.tests.run': 'Korrika egin',
  'ide.tests.runAll': 'Exekutatu guztiak',
  'ide.tests.runE2e': 'Exekutatu e2e',
  'ide.tests.runUnit': 'Exekutatu unitatea',
  'ide.tests.runGroup': 'Korrika taldea',
  'ide.tests.stop': 'Gelditu',
  'ide.tests.running': 'Korrika…',
  'ide.tests.passedCount': '{{count}} gainditu',
  'ide.tests.failedCount': '{{count}} huts egin du',
  'ide.tests.statusPassed': 'Gaindituta',
  'ide.tests.statusFailed': 'Huts egin du',
  'ide.tests.statusSkipped': 'Saltatua',
  'ide.tests.kind.e2e': 'Muturretik muturreraino',
  'ide.tests.kind.unit': 'Unitatea',
  'ide.tests.workspace.app': 'Aplikazioa',
  'ide.tests.workspace.api': 'APIa',
  'ide.tests.workspace.root': 'Proiektua',
  'ide.tests.e2eHint':
    'Hauek zuzeneko aurrebistaren aurka exekutatzen dira, beraz, mantendu aurrebista irekita.',
  'ide.tests.showOutput': 'Erakutsi irteera',
  'ide.tests.hideOutput': 'Ezkutatu irteera',
  ...
  'ide.tests.cancelled': 'Korrika gelditu da.',
  'ide.tests.listError': 'Ezin izan dira proiektu honen probak zerrendatu.',
