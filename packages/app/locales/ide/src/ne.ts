...
export const ne: Partial<IdeTranslations> = {
  ...
  'ide.chat.fileTooLarge': 'फाइल धेरै ठूलो छ। अधिकतम आकार यो हो {{maxSize}} एमबी।',
  'ide.chat.modelSet': 'च्याट मोडेल निम्नमा सेट गरियो {{name}}',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} प्रतिबद्ध नगरिएका फाइलहरू',
  ...
  'ide.contextMenu.deleteCount': 'मेटाउनुहोस् {{count}} वस्तुहरू',
  ...
  'ide.preview.retryCount': 'पुन: प्रयास गर्नुहोस् {{count}}',
  ...
  'ide.toolCall.newFileLines': 'नयाँ फाइल, {{count}} रेखाहरू',
  ...
  'ide.toolCall.matchCount': '{{count}} मिल्दोजुल्दो',
  ...
  'ide.chat.loopLimitReached': 'अधिकतम सीमा पुग्यो {{max}} उपकरण पुनरावृत्तिहरू।',
  'ide.chat.maxLoopsSet': 'अधिकतम उपकरण पुनरावृत्तिहरू यसमा सेट गरियो {{n}}',
  ...
  'ide.chat.voice': 'आवाज',
  'ide.chat.voiceUnavailable': 'यो ब्राउजरमा डिक्टेशन उपलब्ध छैन।',
  'ide.chat.voiceMicBlocked': 'माइक्रोफोन पहुँच अवरुद्ध छ।',
  ...
  'ide.chat.voiceAccuracyBest': 'उत्कृष्ट शुद्धता',
  'ide.chat.voiceAccuracyGood': 'राम्रो शुद्धता',
  'ide.chat.voiceAccuracyBasic': 'आधारभूत शुद्धता',
  'ide.chat.voiceEngineNative': 'ब्राउजरमै निर्मित',
  'ide.chat.voiceEngineOnDevice': 'डिभाइसमा',
  'ide.chat.voiceEngineNoBrowserSupport': 'यो ब्राउजरमा उपलब्ध छैन',
  'ide.chat.voiceEngineNoLanguageSupport': 'तपाईंको भाषाका लागि उपलब्ध छैन',
  'ide.chat.voiceEngineCurrent': 'हालको',
  'ide.chat.voiceLangsAll': 'सबै भाषाहरू',
  'ide.chat.voiceLangOnly': 'केवल {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} भाषाहरू',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'प्रशोधन हुन्छ: {{region}} — परिवर्तन गर्न क्लिक गर्नुहोस्',
  'ide.chat.model.regionOnlyHint': 'केवल {{region}}मा होस्ट गरिएको',
  'ide.chat.model.regionMenuLabel': 'प्रशोधन क्षेत्र',
  'ide.chat.models.colRegion': 'क्षेत्र',
  'ide.chat.modelInUseRegion': 'अहिले {{model}} ({{region}}) प्रयोगमा छ',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} रेखाहरू',
  'ide.toolCall.linesRemoved': '- {{count}} रेखाहरू',
  'ide.toolCall.changesApplied': '{{count}} परिवर्तनहरू लागू गरियो',
  'ide.toolCall.applied': 'लागू गरियो',
  'ide.tabs.close': 'बन्द गर्नुहोस् {{fileName}}',
  ...
  'ide.chat.fastModeOn': 'द्रुत मोड सक्रिय छ — उच्च दरमा छिटो प्रतिक्रियाहरू',
  ...
  'ide.tests.testCount': '{{count}} परीक्षणहरू',
  'ide.tests.run': 'दौडनुहोस्',
  'ide.tests.runAll': 'सबै चलाउनुहोस्',
  'ide.tests.runE2e': 'e2e चलाउनुहोस्',
  'ide.tests.runUnit': 'एकाइ चलाउनुहोस्',
  'ide.tests.runGroup': 'समूह चलाउनुहोस्',
  'ide.tests.stop': 'रोक्नुहोस्',
  'ide.tests.running': 'चलिरहेको छ…',
  'ide.tests.passedCount': '{{count}} उत्तीर्ण',
  'ide.tests.failedCount': '{{count}} असफल',
  'ide.tests.statusPassed': 'उत्तीर्ण',
  'ide.tests.statusFailed': 'असफल भयो',
  'ide.tests.statusSkipped': 'छोडियो',
  'ide.tests.kind.e2e': 'अन्त्य-देखि-अन्त',
  'ide.tests.kind.unit': 'एकाइ',
  ...
  'ide.tests.cancelled': 'दौड रोकियो।',
  'ide.tests.listError': 'यस परियोजनाको परीक्षणहरू सूचीबद्ध गर्न सकिएन।',
