...
export const zhTW: Partial<IdeTranslations> = {
  ...
  'ide.chat.openTab': '打開',
  'ide.chat.uncommittedFileCount': '{{count}}未提交的文件',
  ...
  'ide.contextMenu.deleteCount': '刪除{{count}}專案',
  ...
  'ide.preview.retryCount': '重試{{count}}',
  ...
  'ide.toolCall.entryCount': '{{count}}條目',
  'ide.toolCall.matchCount': '{{count}}比賽',
  'ide.toolCall.fileCount': '{{count}}文件',
  ...
  'ide.chat.loopLimitReached': '達到最大值{{max}}工具迭代。',
  ...
  'ide.chat.voiceEngineTitle': '語音輸入引擎',
  'ide.chat.voiceEnginePrivacy': '每個選項都在您的裝置上執行 — 音訊絕不會離開瀏覽器。',
  'ide.chat.voiceEngineNoDownload': '無需下載',
  'ide.chat.voiceEngineDownload': '下載約 {{mb}} MB，之後快取',
  'ide.chat.voiceEngineDownloadRange': '下載約 {{min}}–{{max}} MB，之後快取',
  'ide.chat.voiceAccuracyBest': '最佳準確度',
  'ide.chat.voiceAccuracyGood': '良好準確度',
  'ide.chat.voiceAccuracyBasic': '基本準確度',
  'ide.chat.voiceEngineNative': '瀏覽器內建',
  'ide.chat.voiceEngineOnDevice': '裝置端',
  'ide.chat.voiceEngineNoBrowserSupport': '此瀏覽器不可用',
  'ide.chat.voiceEngineNoLanguageSupport': '不支援您的語言',
  'ide.chat.voiceEngineCurrent': '目前',
  'ide.chat.voiceLangsAll': '所有語言',
  'ide.chat.voiceLangOnly': '僅{{language}}',
  'ide.chat.voiceLangsCount': '{{count}} 種語言',
  'ide.chat.model.region.us': '美國',
  'ide.chat.model.region.cn': '中國',
  'ide.chat.model.regionHint': '處理位置：{{region}} — 點擊變更',
  'ide.chat.model.regionOnlyHint': '僅託管於：{{region}}',
  'ide.chat.model.regionMenuLabel': '處理區域',
  'ide.chat.models.colRegion': '區域',
  'ide.chat.modelInUseRegion': '現在使用 {{model}}（{{region}}）',
  'ide.editor.title': '編輯',
  ...
  'ide.toolCall.linesAdded': '+ {{count}}線條',
  'ide.toolCall.linesRemoved': '− {{count}}線條',
  'ide.toolCall.changesApplied': '{{count}}應用的變更',
  ...
  'ide.chat.autoCommit.on': '啟用自動提交',
  'ide.chat.mention': 'Reference a file',
  'ide.chat.slashCommands': 'Slash commands',
  'ide.chat.skills.loadedPrefix': 'Loaded ',
  'ide.chat.skills.loadedSuffix': ' skill',
  'ide.chat.viewProfile': 'View profile',
  'ide.preview.loadFailed': '此處無法載入預覽',
  'ide.preview.loadFailedHint': '請嘗試重新載入頁面，或在新的分頁中開啟預覽。',
  ...
  'ide.chat.skills.defaultBadge': '預設',
  ...
  'ide.tests.testCount': '{{count}} 測試',
  'ide.tests.run': '執行',
  'ide.tests.runAll': '執行全部',
  'ide.tests.runE2e': '執行 e2e',
  'ide.tests.runUnit': '執行單元',
  'ide.tests.runGroup': '跑步團體',
  'ide.tests.stop': '停止',
  'ide.tests.running': '正在執行……',
  'ide.tests.passedCount': '{{count}} 通過',
  'ide.tests.failedCount': '{{count}} 失敗',
  'ide.tests.statusPassed': '通過',
  'ide.tests.statusFailed': '失敗',
  'ide.tests.statusSkipped': '跳過',
  'ide.tests.kind.e2e': '端到端',
  'ide.tests.kind.unit': '單位',
  'ide.tests.workspace.app': '應用程式',
  'ide.tests.workspace.api': 'API',
  'ide.tests.workspace.root': '專案',
  'ide.tests.e2eHint': '這些操作會影響即時預覽，因此請保持預覽視窗開啟。',
  'ide.tests.showOutput': '顯示輸出結果',
  'ide.tests.hideOutput': '隱藏輸出',
  ...
  'ide.tests.cancelled': '執行已停止。',
  'ide.tests.listError': '無法列出此專案的測試項目。',
