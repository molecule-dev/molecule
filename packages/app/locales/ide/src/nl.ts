...
export const nl: Partial<IdeTranslations> = {
  ...
  'ide.chat.queuedCount': '{{count}} in wachtrij',
  ...
  'ide.chat.fileTooLarge': 'Het bestand is te groot. De maximale grootte is {{maxSize}} MB.',
  ...
  'ide.chat.uncommittedFileCount': '{{count}} niet-opgeslagen bestanden',
  ...
  'ide.contextMenu.deleteCount': 'Verwijderen {{count}} Artikelen',
  ...
  'ide.toolCall.newFileLines': 'nieuw bestand, {{count}} lijnen',
  ...
  'ide.chat.loopLimitReached': 'Het maximum is bereikt {{max}} tool-iteraties.',
  'ide.chat.maxLoopsSet': 'Max. aantal tooliteraties ingesteld op {{n}}',
  ...
  'ide.chat.voice': 'Stem',
  'ide.chat.voiceUnavailable': 'Dicteren is niet beschikbaar in deze browser.',
  'ide.chat.voiceMicBlocked': 'Toegang tot de microfoon is geblokkeerd.',
  ...
  'ide.chat.voiceAccuracyBest': 'beste nauwkeurigheid',
  'ide.chat.voiceAccuracyGood': 'goede nauwkeurigheid',
  'ide.chat.voiceAccuracyBasic': 'basisnauwkeurigheid',
  'ide.chat.voiceEngineNative': 'ingebouwd in browser',
  'ide.chat.voiceEngineOnDevice': 'op het apparaat',
  'ide.chat.voiceEngineNoBrowserSupport': 'niet beschikbaar in deze browser',
  'ide.chat.voiceEngineNoLanguageSupport': 'niet beschikbaar voor je taal',
  'ide.chat.voiceEngineCurrent': 'huidig',
  'ide.chat.voiceLangsAll': 'alle talen',
  'ide.chat.voiceLangOnly': 'alleen {{language}}',
  'ide.chat.voiceLangsCount': '{{count}} talen',
  'ide.chat.model.region.us': 'US',
  'ide.chat.model.region.cn': 'CN',
  'ide.chat.model.regionHint': 'Verwerkt in: {{region}} — klik om te wijzigen',
  'ide.chat.model.regionOnlyHint': 'Alleen gehost in: {{region}}',
  'ide.chat.model.regionMenuLabel': 'Verwerkingsregio',
  'ide.chat.models.colRegion': 'Regio',
  'ide.chat.modelInUseRegion': 'Gebruikt nu {{model}} ({{region}})',
  ...
  'ide.toolCall.linesAdded': '+ {{count}} lijnen',
  'ide.toolCall.linesRemoved': '− {{count}} lijnen',
  'ide.toolCall.changesApplied': '{{count}} toegepaste wijzigingen',
  ...
  'ide.chat.streaming.thinking': 'Even nadenken...',
  'ide.chat.streaming.analyzing': 'Bezig met analyseren...',
  'ide.chat.streaming.reasoning': 'Redenering...',
  'ide.chat.streaming.crafting': 'Een antwoord opstellen...',
  'ide.chat.streaming.working': 'Ik ben ermee bezig...',
  'ide.chat.streaming.processing': 'Bezig met verwerken...',
  ...
  'ide.tests.run': 'Rennen',
  'ide.tests.runAll': 'Alles uitvoeren',
  'ide.tests.runE2e': 'e2e uitvoeren',
  'ide.tests.runUnit': 'Eenheid uitvoeren',
  'ide.tests.runGroup': 'Loopgroep',
  'ide.tests.stop': 'Stop',
  'ide.tests.running': 'Hardlopen…',
  'ide.tests.passedCount': '{{count}} aangenomen',
  'ide.tests.failedCount': '{{count}} mislukt',
  'ide.tests.statusPassed': 'Geslaagd',
  'ide.tests.statusFailed': 'Mislukt',
  'ide.tests.statusSkipped': 'Overgeslagen',
  'ide.tests.kind.e2e': 'Van begin tot eind',
  'ide.tests.kind.unit': 'Eenheid',
  ...
  'ide.tests.cancelled': 'De run is gestopt.',
  'ide.tests.listError': 'De tests van dit project konden niet worden weergegeven.',
