# @molecule/app-locales-splash-screen

Translations for @molecule/app-splash-screen in 79 languages

## Purpose

Provides translations for the `@molecule/app-splash-screen` package which has 2 translation keys.
...
import * as locales from '@molecule/app-locales-splash-screen'
...
- **Category:** i18n
- **Stack:** app
- **Translates:** `@molecule/app-splash-screen`
