...
Generated: 2026-09-24T08:01:41.184Z
-->
...
```typescript
const appLayout: 'min-h-screen px-[15px] pb-[55px]'
```
...
```typescript
const themeToggleButton: 'h-10 w-10 p-0 border-0 bg-transparent text-foreground-secondary hover:text-foreground cursor-pointer flex items-center justify-center'
```
